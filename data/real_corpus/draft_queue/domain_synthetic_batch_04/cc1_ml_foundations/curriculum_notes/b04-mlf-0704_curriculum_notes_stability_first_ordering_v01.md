...
# Stability-First Ordering for Ordering, Pacing, And Small-Corpus Curriculum Ideas (1)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0704 tracks stability-first ordering over three short checkpoints.
