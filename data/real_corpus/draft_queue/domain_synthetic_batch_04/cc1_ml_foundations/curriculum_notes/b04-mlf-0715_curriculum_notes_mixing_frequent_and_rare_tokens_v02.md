...
# Mixing Frequent And Rare Tokens for Ordering, Pacing, And Small-Corpus Curriculum Ideas (2)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0715 tracks mixing frequent and rare tokens over three short checkpoints.
- checkpoint A train loss: 3.1
- checkpoint B train loss: 2.95
