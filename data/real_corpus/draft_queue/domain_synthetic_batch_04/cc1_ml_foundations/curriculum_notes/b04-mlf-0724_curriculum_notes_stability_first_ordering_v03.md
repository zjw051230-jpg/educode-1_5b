...
# Stability-First Ordering for Ordering, Pacing, And Small-Corpus Curriculum Ideas (3)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0724 tracks stability-first ordering over three short checkpoints.
