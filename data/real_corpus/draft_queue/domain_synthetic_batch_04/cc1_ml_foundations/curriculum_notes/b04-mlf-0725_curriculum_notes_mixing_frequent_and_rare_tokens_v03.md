...
# Mixing Frequent And Rare Tokens for Ordering, Pacing, And Small-Corpus Curriculum Ideas (3)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0725 tracks mixing frequent and rare tokens over three short checkpoints.
- checkpoint A train loss: 3.23
- checkpoint B train loss: 3.07
