...
# Mixing Frequent And Rare Tokens for Ordering, Pacing, And Small-Corpus Curriculum Ideas (4)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0735 tracks mixing frequent and rare tokens over three short checkpoints.
- checkpoint A train loss: 3.36
- checkpoint B train loss: 3.19
- checkpoint C val loss: 3.38
