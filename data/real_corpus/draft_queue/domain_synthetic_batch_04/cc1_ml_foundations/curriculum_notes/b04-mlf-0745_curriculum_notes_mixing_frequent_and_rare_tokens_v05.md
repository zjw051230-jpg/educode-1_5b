...
# Mixing Frequent And Rare Tokens for Ordering, Pacing, And Small-Corpus Curriculum Ideas (5)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0745 tracks mixing frequent and rare tokens over three short checkpoints.
- checkpoint A train loss: 3.49
- checkpoint B train loss: 3.31
- checkpoint C val loss: 2.94
