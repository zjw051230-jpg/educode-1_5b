...
# Stability-First Ordering for Ordering, Pacing, And Small-Corpus Curriculum Ideas (6)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0754 tracks stability-first ordering over three short checkpoints.
