...
# Mixing Frequent And Rare Tokens for Ordering, Pacing, And Small-Corpus Curriculum Ideas (6)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0755 tracks mixing frequent and rare tokens over three short checkpoints.
- checkpoint A train loss: 2.45
- checkpoint B train loss: 2.35
- checkpoint C val loss: 3.27
