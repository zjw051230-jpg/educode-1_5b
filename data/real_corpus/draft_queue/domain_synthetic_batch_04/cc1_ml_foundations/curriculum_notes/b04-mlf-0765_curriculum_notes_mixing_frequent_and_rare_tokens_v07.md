...
# Mixing Frequent And Rare Tokens for Ordering, Pacing, And Small-Corpus Curriculum Ideas (7)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0765 tracks mixing frequent and rare tokens over three short checkpoints.
- checkpoint A train loss: 2.58
- checkpoint B train loss: 2.47
- checkpoint C val loss: 2.83
