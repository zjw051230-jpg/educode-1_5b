...
# Mixing Frequent And Rare Tokens for Ordering, Pacing, And Small-Corpus Curriculum Ideas (8)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0775 tracks mixing frequent and rare tokens over three short checkpoints.
- checkpoint A train loss: 2.71
- checkpoint B train loss: 2.59
- checkpoint C val loss: 3.16
