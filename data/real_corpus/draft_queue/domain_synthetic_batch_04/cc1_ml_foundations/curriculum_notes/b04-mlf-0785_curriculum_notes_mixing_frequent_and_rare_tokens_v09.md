...
# Mixing Frequent And Rare Tokens for Ordering, Pacing, And Small-Corpus Curriculum Ideas (9)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0785 tracks mixing frequent and rare tokens over three short checkpoints.
- checkpoint A train loss: 2.84
- checkpoint B train loss: 2.71
- checkpoint C val loss: 2.72
