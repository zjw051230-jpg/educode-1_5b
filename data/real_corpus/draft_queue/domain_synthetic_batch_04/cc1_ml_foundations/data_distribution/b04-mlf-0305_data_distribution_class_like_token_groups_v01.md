...
# Class-Like Token Groups for Token And Example Distribution Effects (1)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0305 tracks class-like token groups over three short checkpoints.
