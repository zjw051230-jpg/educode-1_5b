...
# Class-Like Token Groups for Token And Example Distribution Effects (2)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0315 tracks class-like token groups over three short checkpoints.
- checkpoint A train loss: 2.9
- checkpoint B train loss: 2.75
