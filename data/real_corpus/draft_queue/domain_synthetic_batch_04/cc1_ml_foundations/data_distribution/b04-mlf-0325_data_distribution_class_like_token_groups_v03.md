...
# Class-Like Token Groups for Token And Example Distribution Effects (3)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0325 tracks class-like token groups over three short checkpoints.
- checkpoint A train loss: 3.03
- checkpoint B train loss: 2.87
- checkpoint C val loss: 2.81
