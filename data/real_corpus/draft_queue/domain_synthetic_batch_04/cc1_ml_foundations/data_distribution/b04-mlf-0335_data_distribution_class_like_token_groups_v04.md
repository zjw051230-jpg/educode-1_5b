...
# Class-Like Token Groups for Token And Example Distribution Effects (4)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0335 tracks class-like token groups over three short checkpoints.
