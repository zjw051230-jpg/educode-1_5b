...
# Class-Like Token Groups for Token And Example Distribution Effects (5)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0345 tracks class-like token groups over three short checkpoints.
- checkpoint A train loss: 3.29
- checkpoint B train loss: 3.11
- checkpoint C val loss: 2.7
