...
# Class-Like Token Groups for Token And Example Distribution Effects (6)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0355 tracks class-like token groups over three short checkpoints.
- checkpoint A train loss: 2.25
- checkpoint B train loss: 2.15
- checkpoint C val loss: 3.03
