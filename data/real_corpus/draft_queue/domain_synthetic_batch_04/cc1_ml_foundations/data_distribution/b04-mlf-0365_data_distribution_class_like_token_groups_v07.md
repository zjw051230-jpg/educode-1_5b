...
# Class-Like Token Groups for Token And Example Distribution Effects (7)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0365 tracks class-like token groups over three short checkpoints.
- checkpoint A train loss: 2.38
- checkpoint B train loss: 2.27
- checkpoint C val loss: 2.59
