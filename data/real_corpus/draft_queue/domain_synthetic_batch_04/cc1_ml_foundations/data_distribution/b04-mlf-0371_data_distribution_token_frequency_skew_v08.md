...
# Token-Frequency Skew for Token And Example Distribution Effects (8)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0371 tracks token-frequency skew over three short checkpoints.
- checkpoint A train loss: 3.16
- checkpoint B train loss: 2.99
