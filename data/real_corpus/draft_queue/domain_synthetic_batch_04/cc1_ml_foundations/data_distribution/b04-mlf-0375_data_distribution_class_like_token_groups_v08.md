...
# Class-Like Token Groups for Token And Example Distribution Effects (8)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0375 tracks class-like token groups over three short checkpoints.
- checkpoint A train loss: 2.51
- checkpoint B train loss: 2.39
- checkpoint C val loss: 2.92
