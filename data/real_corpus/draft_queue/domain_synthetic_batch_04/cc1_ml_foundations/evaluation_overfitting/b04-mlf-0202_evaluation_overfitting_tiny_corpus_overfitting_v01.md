...
# Tiny-Corpus Overfitting for Train-Val Comparison And Overfitting Analysis (1)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0202 tracks tiny-corpus overfitting over three short checkpoints.
- checkpoint A train loss: 2.33
- checkpoint B train loss: 2.22
- checkpoint C val loss: 2.53
