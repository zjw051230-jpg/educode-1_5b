...
# Lower-Train-Loss Caveat for Train-Val Comparison And Overfitting Analysis (1)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0207 tracks lower-train-loss caveat over three short checkpoints.
