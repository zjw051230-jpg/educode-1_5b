...
# Tiny-Corpus Overfitting for Train-Val Comparison And Overfitting Analysis (2)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0212 tracks tiny-corpus overfitting over three short checkpoints.
- checkpoint A train loss: 2.46
- checkpoint B train loss: 2.34
- checkpoint C val loss: 2.86
