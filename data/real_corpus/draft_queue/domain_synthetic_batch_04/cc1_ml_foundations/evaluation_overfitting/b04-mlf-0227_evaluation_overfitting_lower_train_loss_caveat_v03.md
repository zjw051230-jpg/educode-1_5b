...
# Lower-Train-Loss Caveat for Train-Val Comparison And Overfitting Analysis (3)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0227 tracks lower-train-loss caveat over three short checkpoints.
- checkpoint A train loss: 3.24
- checkpoint B train loss: 3.06
