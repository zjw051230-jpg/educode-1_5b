...
# Lower-Train-Loss Caveat for Train-Val Comparison And Overfitting Analysis (4)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0237 tracks lower-train-loss caveat over three short checkpoints.
- checkpoint A train loss: 2.2
- checkpoint B train loss: 2.1
