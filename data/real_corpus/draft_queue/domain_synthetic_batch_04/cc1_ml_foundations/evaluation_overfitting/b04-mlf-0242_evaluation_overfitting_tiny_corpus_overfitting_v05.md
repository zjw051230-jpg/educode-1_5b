...
# Tiny-Corpus Overfitting for Train-Val Comparison And Overfitting Analysis (5)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0242 tracks tiny-corpus overfitting over three short checkpoints.
- checkpoint A train loss: 2.85
- checkpoint B train loss: 2.7
