...
# Tiny-Corpus Overfitting for Train-Val Comparison And Overfitting Analysis (6)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0252 tracks tiny-corpus overfitting over three short checkpoints.
- checkpoint A train loss: 2.98
- checkpoint B train loss: 2.82
- checkpoint C val loss: 2.64
