...
# Lower-Train-Loss Caveat for Train-Val Comparison And Overfitting Analysis (7)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0267 tracks lower-train-loss caveat over three short checkpoints.
- checkpoint A train loss: 2.59
- checkpoint B train loss: 2.46
- checkpoint C val loss: 2.75
