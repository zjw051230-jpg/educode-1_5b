...
# Lower-Train-Loss Caveat for Train-Val Comparison And Overfitting Analysis (8)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0277 tracks lower-train-loss caveat over three short checkpoints.
- checkpoint A train loss: 2.72
- checkpoint B train loss: 2.58
- checkpoint C val loss: 3.08
