...
# Finite Gradients for Gradient Scale And Clipping Diagnostics (1)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0601 tracks finite gradients over three short checkpoints.
