...
# Finite Gradients for Gradient Scale And Clipping Diagnostics (2)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0611 tracks finite gradients over three short checkpoints.
