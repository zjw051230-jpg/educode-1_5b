...
# Exploding Updates for Gradient Scale And Clipping Diagnostics (2)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0615 tracks exploding updates over three short checkpoints.
