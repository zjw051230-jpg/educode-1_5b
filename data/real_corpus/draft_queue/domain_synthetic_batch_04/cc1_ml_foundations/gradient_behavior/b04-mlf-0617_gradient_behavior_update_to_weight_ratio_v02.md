...
# Update-To-Weight Ratio for Gradient Scale And Clipping Diagnostics (2)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0617 tracks update-to-weight ratio over three short checkpoints.
- checkpoint A train loss: 3.31
- checkpoint B train loss: 3.14
- checkpoint C val loss: 2.88
