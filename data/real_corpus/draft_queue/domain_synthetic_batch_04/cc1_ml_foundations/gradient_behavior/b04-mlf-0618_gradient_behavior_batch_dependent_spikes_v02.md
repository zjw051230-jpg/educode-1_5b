...
# Batch-Dependent Spikes for Gradient Scale And Clipping Diagnostics (2)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0618 tracks batch-dependent spikes over three short checkpoints.
- checkpoint A train loss: 3.44
- checkpoint B train loss: 3.26
