...
# Finite Gradients for Gradient Scale And Clipping Diagnostics (3)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0621 tracks finite gradients over three short checkpoints.
