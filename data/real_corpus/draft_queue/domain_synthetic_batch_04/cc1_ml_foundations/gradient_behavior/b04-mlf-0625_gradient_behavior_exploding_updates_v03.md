...
# Exploding Updates for Gradient Scale And Clipping Diagnostics (3)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0625 tracks exploding updates over three short checkpoints.
