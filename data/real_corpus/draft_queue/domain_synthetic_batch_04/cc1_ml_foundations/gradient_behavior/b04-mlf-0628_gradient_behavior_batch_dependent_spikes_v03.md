...
# Batch-Dependent Spikes for Gradient Scale And Clipping Diagnostics (3)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0628 tracks batch-dependent spikes over three short checkpoints.
- checkpoint A train loss: 2.4
- checkpoint B train loss: 2.3
