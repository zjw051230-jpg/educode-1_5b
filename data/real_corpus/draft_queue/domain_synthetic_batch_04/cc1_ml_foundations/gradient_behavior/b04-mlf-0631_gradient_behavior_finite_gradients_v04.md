...
# Finite Gradients for Gradient Scale And Clipping Diagnostics (4)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0631 tracks finite gradients over three short checkpoints.
