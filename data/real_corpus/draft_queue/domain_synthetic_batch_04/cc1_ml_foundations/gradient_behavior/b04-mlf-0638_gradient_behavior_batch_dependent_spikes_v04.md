...
# Batch-Dependent Spikes for Gradient Scale And Clipping Diagnostics (4)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0638 tracks batch-dependent spikes over three short checkpoints.
- checkpoint A train loss: 2.53
- checkpoint B train loss: 2.42
