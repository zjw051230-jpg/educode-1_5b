...
# Finite Gradients for Gradient Scale And Clipping Diagnostics (6)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0651 tracks finite gradients over three short checkpoints.
