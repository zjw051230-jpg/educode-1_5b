...
# Update-To-Weight Ratio for Gradient Scale And Clipping Diagnostics (6)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0657 tracks update-to-weight ratio over three short checkpoints.
- checkpoint A train loss: 2.66
- checkpoint B train loss: 2.54
- checkpoint C val loss: 2.66
