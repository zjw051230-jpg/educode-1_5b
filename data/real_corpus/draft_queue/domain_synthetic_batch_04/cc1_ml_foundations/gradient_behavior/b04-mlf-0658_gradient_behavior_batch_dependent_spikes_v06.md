...
# Batch-Dependent Spikes for Gradient Scale And Clipping Diagnostics (6)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0658 tracks batch-dependent spikes over three short checkpoints.
- checkpoint A train loss: 2.79
- checkpoint B train loss: 2.66
- checkpoint C val loss: 2.77
