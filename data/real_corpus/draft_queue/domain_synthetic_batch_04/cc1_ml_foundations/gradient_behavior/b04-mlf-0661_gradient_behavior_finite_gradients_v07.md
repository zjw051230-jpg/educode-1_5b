...
# Finite Gradients for Gradient Scale And Clipping Diagnostics (7)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0661 tracks finite gradients over three short checkpoints.
