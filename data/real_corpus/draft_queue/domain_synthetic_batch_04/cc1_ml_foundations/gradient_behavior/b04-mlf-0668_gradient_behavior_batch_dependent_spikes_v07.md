...
# Batch-Dependent Spikes for Gradient Scale And Clipping Diagnostics (7)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0668 tracks batch-dependent spikes over three short checkpoints.
- checkpoint A train loss: 2.92
- checkpoint B train loss: 2.78
- checkpoint C val loss: 3.1
