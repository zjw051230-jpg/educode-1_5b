...
# Finite Gradients for Gradient Scale And Clipping Diagnostics (8)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0671 tracks finite gradients over three short checkpoints.
