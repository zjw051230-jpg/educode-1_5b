...
# Update-To-Weight Ratio for Gradient Scale And Clipping Diagnostics (8)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0677 tracks update-to-weight ratio over three short checkpoints.
- checkpoint A train loss: 2.92
- checkpoint B train loss: 2.78
