...
# Batch-Dependent Spikes for Gradient Scale And Clipping Diagnostics (8)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0678 tracks batch-dependent spikes over three short checkpoints.
- checkpoint A train loss: 3.05
- checkpoint B train loss: 2.9
