...
# Finite Gradients for Gradient Scale And Clipping Diagnostics (9)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0681 tracks finite gradients over three short checkpoints.
