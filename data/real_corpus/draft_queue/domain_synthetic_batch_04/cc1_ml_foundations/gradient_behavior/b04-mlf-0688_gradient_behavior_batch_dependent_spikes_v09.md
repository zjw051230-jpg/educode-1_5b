...
# Batch-Dependent Spikes for Gradient Scale And Clipping Diagnostics (9)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0688 tracks batch-dependent spikes over three short checkpoints.
- checkpoint A train loss: 3.18
- checkpoint B train loss: 3.02
- checkpoint C val loss: 2.99
