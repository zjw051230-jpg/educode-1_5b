...
# Curve Smoothing for Loss Curves And Learning Dynamics (1)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0401 tracks curve smoothing over three short checkpoints.
