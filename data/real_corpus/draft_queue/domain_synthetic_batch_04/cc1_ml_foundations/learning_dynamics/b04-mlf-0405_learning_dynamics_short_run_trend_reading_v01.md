...
# Short-Run Trend Reading for Loss Curves And Learning Dynamics (1)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0405 tracks short-run trend reading over three short checkpoints.
- checkpoint A train loss: 2.82
- checkpoint B train loss: 2.68
