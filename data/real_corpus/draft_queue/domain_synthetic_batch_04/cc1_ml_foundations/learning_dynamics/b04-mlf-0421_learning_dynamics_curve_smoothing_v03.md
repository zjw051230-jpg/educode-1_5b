...
# Curve Smoothing for Loss Curves And Learning Dynamics (3)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0421 tracks curve smoothing over three short checkpoints.
