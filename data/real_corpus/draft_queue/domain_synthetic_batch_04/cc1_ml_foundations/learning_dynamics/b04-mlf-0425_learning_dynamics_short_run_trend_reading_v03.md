...
# Short-Run Trend Reading for Loss Curves And Learning Dynamics (3)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0425 tracks short-run trend reading over three short checkpoints.
