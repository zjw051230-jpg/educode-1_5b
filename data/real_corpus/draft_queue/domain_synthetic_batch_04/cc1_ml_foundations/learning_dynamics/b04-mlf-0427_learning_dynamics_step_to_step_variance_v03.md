...
# Step-To-Step Variance for Loss Curves And Learning Dynamics (3)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0427 tracks step-to-step variance over three short checkpoints.
- checkpoint A train loss: 3.34
- checkpoint B train loss: 3.16
