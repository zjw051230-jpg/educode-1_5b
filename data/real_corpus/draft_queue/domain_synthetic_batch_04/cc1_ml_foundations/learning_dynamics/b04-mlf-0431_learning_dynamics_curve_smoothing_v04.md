...
# Curve Smoothing for Loss Curves And Learning Dynamics (4)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0431 tracks curve smoothing over three short checkpoints.
