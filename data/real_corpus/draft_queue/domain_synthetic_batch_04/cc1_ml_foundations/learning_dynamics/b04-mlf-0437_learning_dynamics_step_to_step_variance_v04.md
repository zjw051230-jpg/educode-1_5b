...
# Step-To-Step Variance for Loss Curves And Learning Dynamics (4)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0437 tracks step-to-step variance over three short checkpoints.
- checkpoint A train loss: 2.3
- checkpoint B train loss: 2.2
- checkpoint C val loss: 2.65
