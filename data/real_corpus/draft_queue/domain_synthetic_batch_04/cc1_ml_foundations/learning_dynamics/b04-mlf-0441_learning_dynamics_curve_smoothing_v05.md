...
# Curve Smoothing for Loss Curves And Learning Dynamics (5)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0441 tracks curve smoothing over three short checkpoints.
