...
# Curve Smoothing for Loss Curves And Learning Dynamics (6)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0451 tracks curve smoothing over three short checkpoints.
