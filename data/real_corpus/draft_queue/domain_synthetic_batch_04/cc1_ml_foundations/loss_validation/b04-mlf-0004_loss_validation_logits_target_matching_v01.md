...
# Logits-Target Matching for Next-Token Objective And Loss Interpretation (1)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0004 tracks logits-target matching over three short checkpoints.
