...
# Masked-Token Accounting for Next-Token Objective And Loss Interpretation (1)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0005 tracks masked-token accounting over three short checkpoints.
