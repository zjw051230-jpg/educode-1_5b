...
# Cross-Entropy Reading for Next-Token Objective And Loss Interpretation (2)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0012 tracks cross-entropy reading over three short checkpoints.
