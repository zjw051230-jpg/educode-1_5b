...
# Logits-Target Matching for Next-Token Objective And Loss Interpretation (2)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0014 tracks logits-target matching over three short checkpoints.
