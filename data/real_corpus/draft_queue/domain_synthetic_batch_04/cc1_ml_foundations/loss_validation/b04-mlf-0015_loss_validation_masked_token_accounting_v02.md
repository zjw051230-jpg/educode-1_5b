...
# Masked-Token Accounting for Next-Token Objective And Loss Interpretation (2)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0015 tracks masked-token accounting over three short checkpoints.
- checkpoint A train loss: 2.75
- checkpoint B train loss: 2.6
