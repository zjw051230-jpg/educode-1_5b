...
# Loss Scale Checks for Next-Token Objective And Loss Interpretation (2)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0017 tracks loss scale checks over three short checkpoints.
