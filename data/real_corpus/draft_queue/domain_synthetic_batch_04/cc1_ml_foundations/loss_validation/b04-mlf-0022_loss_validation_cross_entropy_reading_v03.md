...
# Cross-Entropy Reading for Next-Token Objective And Loss Interpretation (3)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0022 tracks cross-entropy reading over three short checkpoints.
