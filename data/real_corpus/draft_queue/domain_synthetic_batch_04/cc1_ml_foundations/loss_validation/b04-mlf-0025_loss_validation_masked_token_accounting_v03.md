...
# Masked-Token Accounting for Next-Token Objective And Loss Interpretation (3)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0025 tracks masked-token accounting over three short checkpoints.
- checkpoint A train loss: 2.88
- checkpoint B train loss: 2.72
