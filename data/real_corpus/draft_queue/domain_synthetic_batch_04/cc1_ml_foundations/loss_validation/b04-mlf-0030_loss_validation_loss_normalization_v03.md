...
# Loss Normalization for Next-Token Objective And Loss Interpretation (3)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0030 tracks loss normalization over three short checkpoints.
