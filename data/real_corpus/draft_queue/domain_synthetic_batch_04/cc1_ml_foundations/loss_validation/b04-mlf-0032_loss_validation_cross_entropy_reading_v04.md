...
# Cross-Entropy Reading for Next-Token Objective And Loss Interpretation (4)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0032 tracks cross-entropy reading over three short checkpoints.
