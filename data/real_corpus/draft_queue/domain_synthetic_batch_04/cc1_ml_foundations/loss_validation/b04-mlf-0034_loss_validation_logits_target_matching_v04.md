...
# Logits-Target Matching for Next-Token Objective And Loss Interpretation (4)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0034 tracks logits-target matching over three short checkpoints.
