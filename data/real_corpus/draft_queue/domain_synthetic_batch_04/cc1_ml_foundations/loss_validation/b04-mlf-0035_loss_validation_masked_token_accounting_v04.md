...
# Masked-Token Accounting for Next-Token Objective And Loss Interpretation (4)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0035 tracks masked-token accounting over three short checkpoints.
- checkpoint A train loss: 3.01
- checkpoint B train loss: 2.84
- checkpoint C val loss: 2.96
