...
# Next-Token Alignment for Next-Token Objective And Loss Interpretation (5)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0041 tracks next-token alignment over three short checkpoints.
