...
# Masked-Token Accounting for Next-Token Objective And Loss Interpretation (5)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0045 tracks masked-token accounting over three short checkpoints.
- checkpoint A train loss: 3.14
- checkpoint B train loss: 2.96
- checkpoint C val loss: 2.52
