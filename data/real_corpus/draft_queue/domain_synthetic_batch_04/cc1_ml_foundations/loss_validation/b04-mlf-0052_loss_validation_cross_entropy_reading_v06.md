...
# Cross-Entropy Reading for Next-Token Objective And Loss Interpretation (6)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0052 tracks cross-entropy reading over three short checkpoints.
