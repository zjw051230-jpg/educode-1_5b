...
# Masked-Token Accounting for Next-Token Objective And Loss Interpretation (6)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0055 tracks masked-token accounting over three short checkpoints.
- checkpoint A train loss: 2.1
- checkpoint B train loss: 2.0
- checkpoint C val loss: 2.85
