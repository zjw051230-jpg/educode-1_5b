...
# Next-Token Alignment for Next-Token Objective And Loss Interpretation (7)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0061 tracks next-token alignment over three short checkpoints.
