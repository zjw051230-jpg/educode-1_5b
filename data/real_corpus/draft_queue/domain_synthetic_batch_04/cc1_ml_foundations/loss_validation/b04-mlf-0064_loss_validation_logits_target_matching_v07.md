...
# Logits-Target Matching for Next-Token Objective And Loss Interpretation (7)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0064 tracks logits-target matching over three short checkpoints.
