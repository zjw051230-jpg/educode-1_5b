...
# Masked-Token Accounting for Next-Token Objective And Loss Interpretation (7)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0065 tracks masked-token accounting over three short checkpoints.
- checkpoint A train loss: 2.23
- checkpoint B train loss: 2.12
- checkpoint C val loss: 2.41
