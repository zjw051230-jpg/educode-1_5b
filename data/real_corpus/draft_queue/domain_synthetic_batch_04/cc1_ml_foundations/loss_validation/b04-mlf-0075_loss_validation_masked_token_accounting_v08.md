...
# Masked-Token Accounting for Next-Token Objective And Loss Interpretation (8)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0075 tracks masked-token accounting over three short checkpoints.
- checkpoint A train loss: 2.36
- checkpoint B train loss: 2.24
- checkpoint C val loss: 2.74
