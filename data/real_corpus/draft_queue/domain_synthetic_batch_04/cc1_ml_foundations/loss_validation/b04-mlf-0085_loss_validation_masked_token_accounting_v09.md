...
# Masked-Token Accounting for Next-Token Objective And Loss Interpretation (9)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0085 tracks masked-token accounting over three short checkpoints.
- checkpoint A train loss: 2.49
- checkpoint B train loss: 2.36
- checkpoint C val loss: 2.3
