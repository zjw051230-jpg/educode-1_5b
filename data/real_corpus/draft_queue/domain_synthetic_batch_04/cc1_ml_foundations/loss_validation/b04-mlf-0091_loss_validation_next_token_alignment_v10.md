...
# Next-Token Alignment for Next-Token Objective And Loss Interpretation (10)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0091 tracks next-token alignment over three short checkpoints.
