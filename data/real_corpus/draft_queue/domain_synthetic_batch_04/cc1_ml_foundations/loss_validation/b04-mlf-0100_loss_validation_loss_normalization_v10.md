...
# Loss Normalization for Next-Token Objective And Loss Interpretation (10)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0100 tracks loss normalization over three short checkpoints.
