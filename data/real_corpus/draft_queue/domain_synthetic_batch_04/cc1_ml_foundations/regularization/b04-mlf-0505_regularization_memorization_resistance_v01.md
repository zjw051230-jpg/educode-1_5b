...
# Memorization Resistance for Regularization Choices For Small Corpora (1)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0505 tracks memorization resistance over three short checkpoints.
