...
# Train-Val Tradeoffs for Regularization Choices For Small Corpora (1)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0507 tracks train-val tradeoffs over three short checkpoints.
