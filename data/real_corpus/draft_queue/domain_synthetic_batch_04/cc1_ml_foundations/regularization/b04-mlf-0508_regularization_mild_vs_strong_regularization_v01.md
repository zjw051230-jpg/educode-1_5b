...
# Mild-Vs-Strong Regularization for Regularization Choices For Small Corpora (1)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0508 tracks mild-vs-strong regularization over three short checkpoints.
- checkpoint A train loss: 3.26
- checkpoint B train loss: 3.09
- checkpoint C val loss: 2.6
