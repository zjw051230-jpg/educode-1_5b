...
# Capacity Control for Regularization Choices For Small Corpora (2)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0514 tracks capacity control over three short checkpoints.
