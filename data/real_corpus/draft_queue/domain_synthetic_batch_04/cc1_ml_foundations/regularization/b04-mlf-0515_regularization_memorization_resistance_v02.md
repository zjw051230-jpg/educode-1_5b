...
# Memorization Resistance for Regularization Choices For Small Corpora (2)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0515 tracks memorization resistance over three short checkpoints.
