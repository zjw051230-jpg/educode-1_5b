...
# Train-Val Tradeoffs for Regularization Choices For Small Corpora (2)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0517 tracks train-val tradeoffs over three short checkpoints.
