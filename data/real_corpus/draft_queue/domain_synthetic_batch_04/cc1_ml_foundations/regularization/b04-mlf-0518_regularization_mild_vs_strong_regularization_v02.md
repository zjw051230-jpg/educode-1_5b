...
# Mild-Vs-Strong Regularization for Regularization Choices For Small Corpora (2)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0518 tracks mild-vs-strong regularization over three short checkpoints.
- checkpoint A train loss: 3.39
- checkpoint B train loss: 3.21
- checkpoint C val loss: 2.93
