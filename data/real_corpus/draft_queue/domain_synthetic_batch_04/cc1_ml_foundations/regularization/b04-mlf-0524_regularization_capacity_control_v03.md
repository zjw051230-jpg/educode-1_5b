...
# Capacity Control for Regularization Choices For Small Corpora (3)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0524 tracks capacity control over three short checkpoints.
