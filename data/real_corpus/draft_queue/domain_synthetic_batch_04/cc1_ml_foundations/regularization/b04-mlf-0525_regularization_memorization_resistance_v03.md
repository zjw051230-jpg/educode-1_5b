...
# Memorization Resistance for Regularization Choices For Small Corpora (3)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0525 tracks memorization resistance over three short checkpoints.
