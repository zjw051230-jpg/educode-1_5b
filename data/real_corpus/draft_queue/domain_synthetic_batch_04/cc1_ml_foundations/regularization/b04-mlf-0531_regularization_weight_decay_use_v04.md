...
# Weight Decay Use for Regularization Choices For Small Corpora (4)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0531 tracks weight decay use over three short checkpoints.
