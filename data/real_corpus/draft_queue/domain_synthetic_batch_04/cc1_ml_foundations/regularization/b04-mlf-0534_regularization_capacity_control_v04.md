...
# Capacity Control for Regularization Choices For Small Corpora (4)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0534 tracks capacity control over three short checkpoints.
