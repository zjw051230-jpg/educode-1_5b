...
# Memorization Resistance for Regularization Choices For Small Corpora (4)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0535 tracks memorization resistance over three short checkpoints.
