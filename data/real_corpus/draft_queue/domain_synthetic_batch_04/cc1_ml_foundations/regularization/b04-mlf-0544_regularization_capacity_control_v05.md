...
# Capacity Control for Regularization Choices For Small Corpora (5)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0544 tracks capacity control over three short checkpoints.
