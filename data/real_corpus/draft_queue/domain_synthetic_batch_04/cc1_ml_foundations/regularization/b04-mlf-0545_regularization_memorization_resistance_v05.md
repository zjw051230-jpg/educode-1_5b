...
# Memorization Resistance for Regularization Choices For Small Corpora (5)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0545 tracks memorization resistance over three short checkpoints.
