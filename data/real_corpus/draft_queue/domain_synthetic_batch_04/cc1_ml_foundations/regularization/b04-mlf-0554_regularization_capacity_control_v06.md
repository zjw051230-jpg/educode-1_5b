...
# Capacity Control for Regularization Choices For Small Corpora (6)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0554 tracks capacity control over three short checkpoints.
