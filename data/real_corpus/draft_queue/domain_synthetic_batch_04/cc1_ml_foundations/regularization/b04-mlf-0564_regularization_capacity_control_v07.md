...
# Capacity Control for Regularization Choices For Small Corpora (7)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0564 tracks capacity control over three short checkpoints.
