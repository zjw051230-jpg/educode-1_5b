...
# Memorization Resistance for Regularization Choices For Small Corpora (7)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0565 tracks memorization resistance over three short checkpoints.
