...
# Capacity Control for Regularization Choices For Small Corpora (8)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0574 tracks capacity control over three short checkpoints.
