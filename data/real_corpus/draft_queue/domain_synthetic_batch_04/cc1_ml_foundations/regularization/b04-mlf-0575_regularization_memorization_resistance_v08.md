...
# Memorization Resistance for Regularization Choices For Small Corpora (8)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0575 tracks memorization resistance over three short checkpoints.
