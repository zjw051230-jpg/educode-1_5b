...
# Memorization Resistance for Regularization Choices For Small Corpora (9)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0585 tracks memorization resistance over three short checkpoints.
