...
# Pre-Run Checklist for Review Checklists For Draft Experiments (2)

## Concept
This draft focuses on pre-run checklist within the broader theme of review checklists for draft experiments.
The goal is to provide a synthetic educational explanation rather than a production recipe.

## Explanation
In small next-token experiments, pre-run checklist often appears as a local signal rather than a final verdict.
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0911 tracks pre-run checklist over three short checkpoints.
...
## Common Pitfalls
- Treating pre-run checklist as if it had the same meaning in every batch and every split.
...
## Review Notes
The teaching objective for this file is: Explain pre-run checklist through a synthetic educational example focused on review checklists for draft experiments.
