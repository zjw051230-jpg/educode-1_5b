...
# Train-Val Consistency Audit for Review Checklists For Draft Experiments (3)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0924 tracks train-val consistency audit over three short checkpoints.
