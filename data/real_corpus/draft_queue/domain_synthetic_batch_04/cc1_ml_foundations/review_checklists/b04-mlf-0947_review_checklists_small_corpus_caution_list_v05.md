...
# Small-Corpus Caution List for Review Checklists For Draft Experiments (5)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0947 tracks small-corpus caution list over three short checkpoints.
- checkpoint A train loss: 2.68
- checkpoint B train loss: 2.57
- checkpoint C val loss: 3.28
