...
# Small-Corpus Caution List for Review Checklists For Draft Experiments (6)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0957 tracks small-corpus caution list over three short checkpoints.
- checkpoint A train loss: 2.81
- checkpoint B train loss: 2.69
- checkpoint C val loss: 2.84
