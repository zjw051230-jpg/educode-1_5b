...
# Small-Corpus Caution List for Review Checklists For Draft Experiments (7)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0967 tracks small-corpus caution list over three short checkpoints.
- checkpoint A train loss: 2.94
- checkpoint B train loss: 2.81
- checkpoint C val loss: 3.17
