...
# Train-Val Consistency Audit for Review Checklists For Draft Experiments (8)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0974 tracks train-val consistency audit over three short checkpoints.
