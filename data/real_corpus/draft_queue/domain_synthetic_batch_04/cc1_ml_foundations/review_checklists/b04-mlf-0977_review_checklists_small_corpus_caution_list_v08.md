...
# Small-Corpus Caution List for Review Checklists For Draft Experiments (8)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0977 tracks small-corpus caution list over three short checkpoints.
- checkpoint A train loss: 3.07
- checkpoint B train loss: 2.93
- checkpoint C val loss: 3.5
