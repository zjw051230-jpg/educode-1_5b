...
# Small-Corpus Caution List for Review Checklists For Draft Experiments (9)
...
## Minimal Example
Imagine a synthetic run where topic B04-MLF-0987 tracks small-corpus caution list over three short checkpoints.
- checkpoint A train loss: 3.2
- checkpoint B train loss: 3.05
