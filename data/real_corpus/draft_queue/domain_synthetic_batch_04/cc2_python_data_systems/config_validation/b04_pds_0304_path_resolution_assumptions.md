...
---
# Config Validation: Path Resolution Assumptions with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining path resolution assumptions through a golden path walkthrough for config validation.
...
Its purpose is to give reviewers a single teaching target: explaining path resolution assumptions through a golden path walkthrough for config validation.
...
## Variation Note
Local example index: 4 within the config validation block.
