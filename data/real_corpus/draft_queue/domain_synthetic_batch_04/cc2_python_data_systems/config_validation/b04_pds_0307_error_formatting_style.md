...
---
# Config Validation: Error Formatting Style with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining error formatting style through a golden path walkthrough for config validation.
...
Its purpose is to give reviewers a single teaching target: explaining error formatting style through a golden path walkthrough for config validation.
...
## Variation Note
Local example index: 7 within the config validation block.
