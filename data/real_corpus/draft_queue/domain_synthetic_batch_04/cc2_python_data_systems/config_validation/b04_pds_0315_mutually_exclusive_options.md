...
---
# Config Validation: Mutually Exclusive Options with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining mutually exclusive options through a golden path walkthrough for config validation.
...
Its purpose is to give reviewers a single teaching target: explaining mutually exclusive options through a golden path walkthrough for config validation.
...
## Variation Note
Local example index: 15 within the config validation block.
