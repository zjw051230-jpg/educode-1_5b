...
---
# Config Validation: Mutually Exclusive Options with Edge Case Guardrail

## Teaching Objective
This draft teaches explaining mutually exclusive options through a edge case guardrail for config validation.
...
Its purpose is to give reviewers a single teaching target: explaining mutually exclusive options through a edge case guardrail for config validation.
...
## Variation Note
Local example index: 35 within the config validation block.
