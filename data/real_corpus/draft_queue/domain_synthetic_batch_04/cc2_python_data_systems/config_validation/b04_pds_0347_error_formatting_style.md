...
---
# Config Validation: Error Formatting Style with Review Checklist Framing

## Teaching Objective
This draft teaches explaining error formatting style through a review checklist framing for config validation.
...
Its purpose is to give reviewers a single teaching target: explaining error formatting style through a review checklist framing for config validation.
...
## Variation Note
Local example index: 47 within the config validation block.
