...
---
# Config Validation: Draft Config Provenance with Review Checklist Framing

## Teaching Objective
This draft teaches explaining draft config provenance through a review checklist framing for config validation.
...
Its purpose is to give reviewers a single teaching target: explaining draft config provenance through a review checklist framing for config validation.
...
## Variation Note
Local example index: 60 within the config validation block.
