...
---
# Config Validation: Nested Config Inspection with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining nested config inspection through a shape and field tracing for config validation.
...
Its purpose is to give reviewers a single teaching target: explaining nested config inspection through a shape and field tracing for config validation.
...
## Variation Note
Local example index: 66 within the config validation block.
