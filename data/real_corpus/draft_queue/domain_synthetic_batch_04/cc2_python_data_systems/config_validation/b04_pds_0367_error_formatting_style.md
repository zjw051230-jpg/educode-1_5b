...
---
# Config Validation: Error Formatting Style with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining error formatting style through a shape and field tracing for config validation.
...
Its purpose is to give reviewers a single teaching target: explaining error formatting style through a shape and field tracing for config validation.
...
## Variation Note
Local example index: 67 within the config validation block.
