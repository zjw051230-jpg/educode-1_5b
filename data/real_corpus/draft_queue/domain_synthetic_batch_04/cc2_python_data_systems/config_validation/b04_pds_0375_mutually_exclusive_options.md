...
---
# Config Validation: Mutually Exclusive Options with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining mutually exclusive options through a shape and field tracing for config validation.
...
Its purpose is to give reviewers a single teaching target: explaining mutually exclusive options through a shape and field tracing for config validation.
...
## Variation Note
Local example index: 75 within the config validation block.
