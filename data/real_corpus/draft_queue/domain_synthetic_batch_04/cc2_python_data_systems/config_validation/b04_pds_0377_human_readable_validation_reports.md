...
---
# Config Validation: Human Readable Validation Reports with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining human readable validation reports through a shape and field tracing for config validation.
...
Its purpose is to give reviewers a single teaching target: explaining human readable validation reports through a shape and field tracing for config validation.
...
## Variation Note
Local example index: 77 within the config validation block.
