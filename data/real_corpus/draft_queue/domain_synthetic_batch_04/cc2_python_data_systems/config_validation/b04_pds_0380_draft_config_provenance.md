...
---
# Config Validation: Draft Config Provenance with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining draft config provenance through a shape and field tracing for config validation.
...
Its purpose is to give reviewers a single teaching target: explaining draft config provenance through a shape and field tracing for config validation.
...
## Variation Note
Local example index: 80 within the config validation block.
