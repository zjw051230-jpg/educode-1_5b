...
---
# Config Validation: Default Value Documentation with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining default value documentation through a failure diagnosis pattern for config validation.
...
## Concept
The core idea is default value documentation.
...
## Minimal Example
```text
input: b04-pds-0385 sample row
focus: default value documentation
...
- Confirm the example describes default value documentation rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining default value documentation through a failure diagnosis pattern for config validation.
...
## Variation Note
Local example index: 85 within the config validation block.
