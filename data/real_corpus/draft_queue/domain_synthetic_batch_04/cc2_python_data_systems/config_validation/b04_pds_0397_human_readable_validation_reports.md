...
---
# Config Validation: Human Readable Validation Reports with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining human readable validation reports through a failure diagnosis pattern for config validation.
...
## Concept
The core idea is human readable validation reports.
...
## Minimal Example
```text
input: b04-pds-0397 sample row
focus: human readable validation reports
...
- Confirm the example describes human readable validation reports rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining human readable validation reports through a failure diagnosis pattern for config validation.
...
## Variation Note
Local example index: 97 within the config validation block.
