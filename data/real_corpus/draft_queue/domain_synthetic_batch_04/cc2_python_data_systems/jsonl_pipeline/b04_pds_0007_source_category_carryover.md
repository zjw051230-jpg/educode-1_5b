...
---
# JSONL Pipeline: Source Category Carryover with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining source category carryover through a golden path walkthrough for jsonl pipeline.
...
Its purpose is to give reviewers a single teaching target: explaining source category carryover through a golden path walkthrough for jsonl pipeline.
...
## Variation Note
Local example index: 7 within the jsonl pipeline block.
