...
def build_demo_rows() -> list[dict[str, object]]:
    return [
        {"topic_id": "B04-PDS-0053", "label": EXAMPLE_LABELS[0], "position": 0},
        {"topic_id": "B04-PDS-0053", "label": EXAMPLE_LABELS[1], "position": 1},
        {"topic_id": "B04-PDS-0053", "label": EXAMPLE_LABELS[2], "position": 2},
    ]
...
def summarize_streaming_read_memory_limits(rows: Iterable[dict[str, object]]) -> dict[str, object]:
    ...
    return {
        "topic_id": "B04-PDS-0053",
        "objective": "explaining streaming read memory limits through a review checklist framing for jsonl pipeline",
...
def render_demo_path(base: str | Path) -> Path:
    return Path(base) / "b04_pds_0053.jsonl"
