...
---
# JSONL Pipeline: Source Category Carryover with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining source category carryover through a failure diagnosis pattern for jsonl pipeline.
...
## Concept
The core idea is source category carryover.
...
## Minimal Example
```text
input: b04-pds-0087 sample row
focus: source category carryover
...
- Confirm the example describes source category carryover rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining source category carryover through a failure diagnosis pattern for jsonl pipeline.
...
## Variation Note
Local example index: 87 within the jsonl pipeline block.
