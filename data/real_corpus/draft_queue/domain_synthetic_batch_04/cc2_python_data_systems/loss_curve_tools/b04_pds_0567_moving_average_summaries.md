...
---
# Loss Curve Tools: Moving Average Summaries with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining moving average summaries through a shape and field tracing for loss curve tools.
...
Its purpose is to give reviewers a single teaching target: explaining moving average summaries through a shape and field tracing for loss curve tools.
...
## Variation Note
Local example index: 67 within the loss curve tools block.
