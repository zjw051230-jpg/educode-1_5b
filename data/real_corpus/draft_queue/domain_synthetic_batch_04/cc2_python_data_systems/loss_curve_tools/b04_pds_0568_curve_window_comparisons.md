...
---
# Loss Curve Tools: Curve Window Comparisons with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining curve window comparisons through a shape and field tracing for loss curve tools.
...
Its purpose is to give reviewers a single teaching target: explaining curve window comparisons through a shape and field tracing for loss curve tools.
...
## Variation Note
Local example index: 68 within the loss curve tools block.
