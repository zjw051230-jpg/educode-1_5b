...
---
# Loss Curve Tools: Loss Divergence Warnings with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining loss divergence warnings through a shape and field tracing for loss curve tools.
...
Its purpose is to give reviewers a single teaching target: explaining loss divergence warnings through a shape and field tracing for loss curve tools.
...
## Variation Note
Local example index: 70 within the loss curve tools block.
