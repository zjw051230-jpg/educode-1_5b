...
---
# Loss Curve Tools: Peak To Trough Distance with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining peak to trough distance through a shape and field tracing for loss curve tools.
...
Its purpose is to give reviewers a single teaching target: explaining peak to trough distance through a shape and field tracing for loss curve tools.
...
## Variation Note
Local example index: 75 within the loss curve tools block.
