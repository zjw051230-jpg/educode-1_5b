...
---
# Loss Curve Tools: Loss Delta Reporting with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining loss delta reporting through a shape and field tracing for loss curve tools.
...
Its purpose is to give reviewers a single teaching target: explaining loss delta reporting through a shape and field tracing for loss curve tools.
...
## Variation Note
Local example index: 78 within the loss curve tools block.
