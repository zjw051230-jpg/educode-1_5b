...
---
# Loss Curve Tools: Curve Data Export Summaries with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining curve data export summaries through a shape and field tracing for loss curve tools.
...
Its purpose is to give reviewers a single teaching target: explaining curve data export summaries through a shape and field tracing for loss curve tools.
...
## Variation Note
Local example index: 80 within the loss curve tools block.
