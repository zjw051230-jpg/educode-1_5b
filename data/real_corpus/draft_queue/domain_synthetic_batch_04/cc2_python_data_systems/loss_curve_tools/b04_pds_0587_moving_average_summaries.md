...
---
# Loss Curve Tools: Moving Average Summaries with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining moving average summaries through a failure diagnosis pattern for loss curve tools.
...
## Concept
The core idea is moving average summaries.
...
## Minimal Example
```text
input: b04-pds-0587 sample row
focus: moving average summaries
...
- Confirm the example describes moving average summaries rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining moving average summaries through a failure diagnosis pattern for loss curve tools.
...
## Variation Note
Local example index: 87 within the loss curve tools block.
