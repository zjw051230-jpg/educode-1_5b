...
---
# Loss Curve Tools: Final Window Summarizer with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining final window summarizer through a failure diagnosis pattern for loss curve tools.
...
## Concept
The core idea is final window summarizer.
...
## Minimal Example
```text
input: b04-pds-0594 sample row
focus: final window summarizer
...
- Confirm the example describes final window summarizer rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining final window summarizer through a failure diagnosis pattern for loss curve tools.
...
## Variation Note
Local example index: 94 within the loss curve tools block.
