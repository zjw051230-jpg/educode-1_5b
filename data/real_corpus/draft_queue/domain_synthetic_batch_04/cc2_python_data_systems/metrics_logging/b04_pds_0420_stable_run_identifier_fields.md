...
---
# Metrics Logging: Stable Run Identifier Fields with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining stable run identifier fields through a golden path walkthrough for metrics logging.
...
Its purpose is to give reviewers a single teaching target: explaining stable run identifier fields through a golden path walkthrough for metrics logging.
...
## Variation Note
Local example index: 20 within the metrics logging block.
