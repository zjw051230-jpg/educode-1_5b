...
---
# Metrics Logging: Timestamp Optionality with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining timestamp optionality through a shape and field tracing for metrics logging.
...
Its purpose is to give reviewers a single teaching target: explaining timestamp optionality through a shape and field tracing for metrics logging.
...
## Variation Note
Local example index: 67 within the metrics logging block.
