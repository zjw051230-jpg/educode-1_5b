...
def build_demo_rows() -> list[dict[str, object]]:
    return [
        {"topic_id": "B04-PDS-0471", "label": EXAMPLE_LABELS[0], "position": 0},
        {"topic_id": "B04-PDS-0471", "label": EXAMPLE_LABELS[1], "position": 1},
        {"topic_id": "B04-PDS-0471", "label": EXAMPLE_LABELS[2], "position": 2},
    ]
...
def summarize_missing_field_fallback_notes(rows: Iterable[dict[str, object]]) -> dict[str, object]:
    ...
    return {
        "topic_id": "B04-PDS-0471",
        "objective": "explaining missing field fallback notes through a shape and field tracing for metrics logging",
...
def render_demo_path(base: str | Path) -> Path:
    return Path(base) / "b04_pds_0471.jsonl"
