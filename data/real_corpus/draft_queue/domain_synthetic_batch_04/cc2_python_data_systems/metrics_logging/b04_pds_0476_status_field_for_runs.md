...
---
# Metrics Logging: Status Field For Runs with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining status field for runs through a shape and field tracing for metrics logging.
...
Its purpose is to give reviewers a single teaching target: explaining status field for runs through a shape and field tracing for metrics logging.
...
## Variation Note
Local example index: 76 within the metrics logging block.
