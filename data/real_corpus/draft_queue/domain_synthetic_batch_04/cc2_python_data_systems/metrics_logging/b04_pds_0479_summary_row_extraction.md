...
---
# Metrics Logging: Summary Row Extraction with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining summary row extraction through a shape and field tracing for metrics logging.
...
Its purpose is to give reviewers a single teaching target: explaining summary row extraction through a shape and field tracing for metrics logging.
...
## Variation Note
Local example index: 79 within the metrics logging block.
