...
---
# Metrics Logging: Stable Run Identifier Fields with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining stable run identifier fields through a shape and field tracing for metrics logging.
...
Its purpose is to give reviewers a single teaching target: explaining stable run identifier fields through a shape and field tracing for metrics logging.
...
## Variation Note
Local example index: 80 within the metrics logging block.
