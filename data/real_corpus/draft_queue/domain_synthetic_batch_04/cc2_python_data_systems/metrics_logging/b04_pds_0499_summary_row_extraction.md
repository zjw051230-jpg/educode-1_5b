...
---
# Metrics Logging: Summary Row Extraction with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining summary row extraction through a failure diagnosis pattern for metrics logging.
...
## Concept
The core idea is summary row extraction.
...
## Minimal Example
```text
input: b04-pds-0499 sample row
focus: summary row extraction
...
- Confirm the example describes summary row extraction rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining summary row extraction through a failure diagnosis pattern for metrics logging.
...
## Variation Note
Local example index: 99 within the metrics logging block.
