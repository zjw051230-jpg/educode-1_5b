...
---
# Provenance Metadata: Record Level Provenance with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining record level provenance through a golden path walkthrough for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining record level provenance through a golden path walkthrough for provenance metadata.
...
## Variation Note
Local example index: 5 within the provenance metadata block.
