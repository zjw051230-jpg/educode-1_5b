...
---
# Provenance Metadata: Document Parent Identifiers with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining document parent identifiers through a golden path walkthrough for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining document parent identifiers through a golden path walkthrough for provenance metadata.
...
## Variation Note
Local example index: 6 within the provenance metadata block.
