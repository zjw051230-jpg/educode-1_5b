...
---
# Provenance Metadata: Approval Flag Expectations with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining approval flag expectations through a golden path walkthrough for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining approval flag expectations through a golden path walkthrough for provenance metadata.
...
## Variation Note
Local example index: 8 within the provenance metadata block.
