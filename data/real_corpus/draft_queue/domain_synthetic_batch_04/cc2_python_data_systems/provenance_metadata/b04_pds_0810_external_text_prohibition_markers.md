...
---
# Provenance Metadata: External Text Prohibition Markers with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining external text prohibition markers through a golden path walkthrough for provenance metadata.
...
This draft highlights the narrower lens of golden path walkthrough so the reader sees one concrete decision boundary instead of a vague overview.
...
## Minimal Example
```text
input: b04-pds-0810 sample row
focus: external text prohibition markers
check: golden path walkthrough
...
Its purpose is to give reviewers a single teaching target: explaining external text prohibition markers through a golden path walkthrough for provenance metadata.
...
## Variation Note
Local example index: 10 within the provenance metadata block.
