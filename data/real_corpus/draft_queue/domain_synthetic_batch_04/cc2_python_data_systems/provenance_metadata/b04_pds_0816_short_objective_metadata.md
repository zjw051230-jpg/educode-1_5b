...
---
# Provenance Metadata: Short Objective Metadata with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining short objective metadata through a golden path walkthrough for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining short objective metadata through a golden path walkthrough for provenance metadata.
...
## Variation Note
Local example index: 16 within the provenance metadata block.
