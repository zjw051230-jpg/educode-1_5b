...
---
# Provenance Metadata: Origin Path Placeholders with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining origin path placeholders through a golden path walkthrough for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining origin path placeholders through a golden path walkthrough for provenance metadata.
...
## Variation Note
Local example index: 18 within the provenance metadata block.
