...
---
# Provenance Metadata: Manifest Alignment Checks with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining manifest alignment checks through a golden path walkthrough for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining manifest alignment checks through a golden path walkthrough for provenance metadata.
...
## Variation Note
Local example index: 20 within the provenance metadata block.
