...
---
# Provenance Metadata: Record Level Provenance with Review Checklist Framing

## Teaching Objective
This draft teaches explaining record level provenance through a review checklist framing for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining record level provenance through a review checklist framing for provenance metadata.
...
## Variation Note
Local example index: 45 within the provenance metadata block.
