...
---
# Provenance Metadata: External Text Prohibition Markers with Review Checklist Framing

## Teaching Objective
This draft teaches explaining external text prohibition markers through a review checklist framing for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining external text prohibition markers through a review checklist framing for provenance metadata.
...
## Variation Note
Local example index: 50 within the provenance metadata block.
