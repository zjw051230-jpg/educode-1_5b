...
---
# Provenance Metadata: Manifest Alignment Checks with Review Checklist Framing

## Teaching Objective
This draft teaches explaining manifest alignment checks through a review checklist framing for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining manifest alignment checks through a review checklist framing for provenance metadata.
...
## Variation Note
Local example index: 60 within the provenance metadata block.
