...
---
# Provenance Metadata: Topic Id Traceability with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining topic id traceability through a shape and field tracing for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining topic id traceability through a shape and field tracing for provenance metadata.
...
## Variation Note
Local example index: 64 within the provenance metadata block.
