...
---
# Provenance Metadata: Record Level Provenance with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining record level provenance through a shape and field tracing for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining record level provenance through a shape and field tracing for provenance metadata.
...
## Variation Note
Local example index: 65 within the provenance metadata block.
