...
---
# Provenance Metadata: Document Parent Identifiers with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining document parent identifiers through a shape and field tracing for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining document parent identifiers through a shape and field tracing for provenance metadata.
...
## Variation Note
Local example index: 66 within the provenance metadata block.
