...
---
# Provenance Metadata: Draft Status Meaning with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining draft status meaning through a shape and field tracing for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining draft status meaning through a shape and field tracing for provenance metadata.
...
## Variation Note
Local example index: 67 within the provenance metadata block.
