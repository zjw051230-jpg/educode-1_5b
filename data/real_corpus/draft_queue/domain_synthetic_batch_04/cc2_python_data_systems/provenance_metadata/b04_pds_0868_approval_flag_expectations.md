...
---
# Provenance Metadata: Approval Flag Expectations with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining approval flag expectations through a shape and field tracing for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining approval flag expectations through a shape and field tracing for provenance metadata.
...
## Variation Note
Local example index: 68 within the provenance metadata block.
