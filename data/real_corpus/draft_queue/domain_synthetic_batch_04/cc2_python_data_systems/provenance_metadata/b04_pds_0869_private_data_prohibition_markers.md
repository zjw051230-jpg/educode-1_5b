...
---
# Provenance Metadata: Private Data Prohibition Markers with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining private data prohibition markers through a shape and field tracing for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining private data prohibition markers through a shape and field tracing for provenance metadata.
...
## Variation Note
Local example index: 69 within the provenance metadata block.
