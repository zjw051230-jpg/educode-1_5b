...
---
# Provenance Metadata: External Text Prohibition Markers with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining external text prohibition markers through a shape and field tracing for provenance metadata.
...
This draft highlights the narrower lens of shape and field tracing so the reader sees one concrete decision boundary instead of a vague overview.
...
## Minimal Example
```text
input: b04-pds-0870 sample row
focus: external text prohibition markers
check: shape and field tracing
...
Its purpose is to give reviewers a single teaching target: explaining external text prohibition markers through a shape and field tracing for provenance metadata.
...
## Variation Note
Local example index: 70 within the provenance metadata block.
