...
---
# Provenance Metadata: Title Provenance Notes with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining title provenance notes through a shape and field tracing for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining title provenance notes through a shape and field tracing for provenance metadata.
...
## Variation Note
Local example index: 75 within the provenance metadata block.
