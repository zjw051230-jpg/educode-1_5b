...
---
# Provenance Metadata: Short Objective Metadata with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining short objective metadata through a shape and field tracing for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining short objective metadata through a shape and field tracing for provenance metadata.
...
## Variation Note
Local example index: 76 within the provenance metadata block.
