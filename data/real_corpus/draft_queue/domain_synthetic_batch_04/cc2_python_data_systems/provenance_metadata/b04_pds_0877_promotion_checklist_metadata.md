...
---
# Provenance Metadata: Promotion Checklist Metadata with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining promotion checklist metadata through a shape and field tracing for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining promotion checklist metadata through a shape and field tracing for provenance metadata.
...
## Variation Note
Local example index: 77 within the provenance metadata block.
