...
---
# Provenance Metadata: Origin Path Placeholders with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining origin path placeholders through a shape and field tracing for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining origin path placeholders through a shape and field tracing for provenance metadata.
...
## Variation Note
Local example index: 78 within the provenance metadata block.
