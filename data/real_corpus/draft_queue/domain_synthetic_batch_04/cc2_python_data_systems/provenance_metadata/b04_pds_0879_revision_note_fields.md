...
---
# Provenance Metadata: Revision Note Fields with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining revision note fields through a shape and field tracing for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining revision note fields through a shape and field tracing for provenance metadata.
...
## Variation Note
Local example index: 79 within the provenance metadata block.
