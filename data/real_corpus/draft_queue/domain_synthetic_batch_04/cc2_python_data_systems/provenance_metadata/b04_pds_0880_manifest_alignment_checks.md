...
---
# Provenance Metadata: Manifest Alignment Checks with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining manifest alignment checks through a shape and field tracing for provenance metadata.
...
Its purpose is to give reviewers a single teaching target: explaining manifest alignment checks through a shape and field tracing for provenance metadata.
...
## Variation Note
Local example index: 80 within the provenance metadata block.
