...
---
# Provenance Metadata: Record Level Provenance with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining record level provenance through a failure diagnosis pattern for provenance metadata.
...
## Concept
The core idea is record level provenance.
...
## Minimal Example
```text
input: b04-pds-0885 sample row
focus: record level provenance
...
- Confirm the example describes record level provenance rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining record level provenance through a failure diagnosis pattern for provenance metadata.
...
## Variation Note
Local example index: 85 within the provenance metadata block.
