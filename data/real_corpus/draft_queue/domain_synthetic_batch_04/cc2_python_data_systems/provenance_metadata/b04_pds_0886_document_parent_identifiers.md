...
---
# Provenance Metadata: Document Parent Identifiers with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining document parent identifiers through a failure diagnosis pattern for provenance metadata.
...
## Concept
The core idea is document parent identifiers.
...
## Minimal Example
```text
input: b04-pds-0886 sample row
focus: document parent identifiers
...
- Confirm the example describes document parent identifiers rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining document parent identifiers through a failure diagnosis pattern for provenance metadata.
...
## Variation Note
Local example index: 86 within the provenance metadata block.
