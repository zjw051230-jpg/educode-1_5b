...
---
# Provenance Metadata: Draft Status Meaning with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining draft status meaning through a failure diagnosis pattern for provenance metadata.
...
## Concept
The core idea is draft status meaning.
...
## Minimal Example
```text
input: b04-pds-0887 sample row
focus: draft status meaning
...
- Confirm the example describes draft status meaning rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining draft status meaning through a failure diagnosis pattern for provenance metadata.
...
## Variation Note
Local example index: 87 within the provenance metadata block.
