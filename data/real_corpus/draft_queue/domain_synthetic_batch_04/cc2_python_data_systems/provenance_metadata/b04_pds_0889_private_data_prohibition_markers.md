...
---
# Provenance Metadata: Private Data Prohibition Markers with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining private data prohibition markers through a failure diagnosis pattern for provenance metadata.
...
## Concept
The core idea is private data prohibition markers.
...
## Minimal Example
```text
input: b04-pds-0889 sample row
focus: private data prohibition markers
...
- Confirm the example describes private data prohibition markers rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining private data prohibition markers through a failure diagnosis pattern for provenance metadata.
...
## Variation Note
Local example index: 89 within the provenance metadata block.
