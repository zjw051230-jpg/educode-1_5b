...
def build_demo_rows() -> list[dict[str, object]]:
    return [
        {"topic_id": "B04-PDS-0891", "label": EXAMPLE_LABELS[0], "position": 0},
        {"topic_id": "B04-PDS-0891", "label": EXAMPLE_LABELS[1], "position": 1},
        {"topic_id": "B04-PDS-0891", "label": EXAMPLE_LABELS[2], "position": 2},
    ]
...
def summarize_generation_method_notes(rows: Iterable[dict[str, object]]) -> dict[str, object]:
    ...
    return {
        "topic_id": "B04-PDS-0891",
        "objective": "explaining generation method notes through a failure diagnosis pattern for provenance metadata",
...
def render_demo_path(base: str | Path) -> Path:
    return Path(base) / "b04_pds_0891.jsonl"
