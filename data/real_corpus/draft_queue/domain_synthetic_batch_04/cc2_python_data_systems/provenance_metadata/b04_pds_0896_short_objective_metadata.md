...
---
# Provenance Metadata: Short Objective Metadata with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining short objective metadata through a failure diagnosis pattern for provenance metadata.
...
## Concept
The core idea is short objective metadata.
...
## Minimal Example
```text
input: b04-pds-0896 sample row
focus: short objective metadata
...
- Confirm the example describes short objective metadata rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining short objective metadata through a failure diagnosis pattern for provenance metadata.
...
## Variation Note
Local example index: 96 within the provenance metadata block.
