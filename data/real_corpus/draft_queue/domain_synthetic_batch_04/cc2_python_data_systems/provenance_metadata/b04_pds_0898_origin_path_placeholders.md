...
---
# Provenance Metadata: Origin Path Placeholders with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining origin path placeholders through a failure diagnosis pattern for provenance metadata.
...
## Concept
The core idea is origin path placeholders.
...
## Minimal Example
```text
input: b04-pds-0898 sample row
focus: origin path placeholders
...
- Confirm the example describes origin path placeholders rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining origin path placeholders through a failure diagnosis pattern for provenance metadata.
...
## Variation Note
Local example index: 98 within the provenance metadata block.
