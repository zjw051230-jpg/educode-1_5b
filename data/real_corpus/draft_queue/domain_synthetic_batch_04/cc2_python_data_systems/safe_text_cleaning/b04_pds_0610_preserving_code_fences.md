...
---
# Safe Text Cleaning: Preserving Code Fences with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining preserving code fences through a golden path walkthrough for safe text cleaning.
...
Its purpose is to give reviewers a single teaching target: explaining preserving code fences through a golden path walkthrough for safe text cleaning.
...
## Variation Note
Local example index: 10 within the safe text cleaning block.
