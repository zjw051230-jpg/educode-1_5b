...
---
# Safe Text Cleaning: Preserving Code Fences with Edge Case Guardrail

## Teaching Objective
This draft teaches explaining preserving code fences through a edge case guardrail for safe text cleaning.
...
Its purpose is to give reviewers a single teaching target: explaining preserving code fences through a edge case guardrail for safe text cleaning.
...
## Variation Note
Local example index: 30 within the safe text cleaning block.
