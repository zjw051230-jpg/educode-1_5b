...
---
# Safe Text Cleaning: Blank Paragraph Collapse with Review Checklist Framing

## Teaching Objective
This draft teaches explaining blank paragraph collapse through a review checklist framing for safe text cleaning.
...
Its purpose is to give reviewers a single teaching target: explaining blank paragraph collapse through a review checklist framing for safe text cleaning.
...
## Variation Note
Local example index: 44 within the safe text cleaning block.
