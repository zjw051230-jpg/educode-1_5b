...
---
# Safe Text Cleaning: Preserving Code Fences with Review Checklist Framing

## Teaching Objective
This draft teaches explaining preserving code fences through a review checklist framing for safe text cleaning.
...
Its purpose is to give reviewers a single teaching target: explaining preserving code fences through a review checklist framing for safe text cleaning.
...
## Variation Note
Local example index: 50 within the safe text cleaning block.
