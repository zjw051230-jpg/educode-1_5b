...
---
# Safe Text Cleaning: Preserving Code Fences with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining preserving code fences through a shape and field tracing for safe text cleaning.
...
Its purpose is to give reviewers a single teaching target: explaining preserving code fences through a shape and field tracing for safe text cleaning.
...
## Variation Note
Local example index: 70 within the safe text cleaning block.
