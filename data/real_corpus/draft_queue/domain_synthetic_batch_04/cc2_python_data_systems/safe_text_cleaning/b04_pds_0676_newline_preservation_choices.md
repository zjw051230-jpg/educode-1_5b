...
---
# Safe Text Cleaning: Newline Preservation Choices with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining newline preservation choices through a shape and field tracing for safe text cleaning.
...
Its purpose is to give reviewers a single teaching target: explaining newline preservation choices through a shape and field tracing for safe text cleaning.
...
## Variation Note
Local example index: 76 within the safe text cleaning block.
