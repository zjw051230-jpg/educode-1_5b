...
---
# Safe Text Cleaning: Blank Paragraph Collapse with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining blank paragraph collapse through a failure diagnosis pattern for safe text cleaning.
...
## Concept
The core idea is blank paragraph collapse.
...
## Minimal Example
```text
input: b04-pds-0684 sample row
focus: blank paragraph collapse
...
- Confirm the example describes blank paragraph collapse rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining blank paragraph collapse through a failure diagnosis pattern for safe text cleaning.
...
## Variation Note
Local example index: 84 within the safe text cleaning block.
