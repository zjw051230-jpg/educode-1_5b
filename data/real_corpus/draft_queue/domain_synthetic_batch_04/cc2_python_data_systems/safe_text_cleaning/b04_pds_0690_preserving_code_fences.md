...
---
# Safe Text Cleaning: Preserving Code Fences with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining preserving code fences through a failure diagnosis pattern for safe text cleaning.
...
## Concept
The core idea is preserving code fences.
...
## Minimal Example
```text
input: b04-pds-0690 sample row
focus: preserving code fences
...
- Confirm the example describes preserving code fences rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining preserving code fences through a failure diagnosis pattern for safe text cleaning.
...
## Variation Note
Local example index: 90 within the safe text cleaning block.
