...
---
# Safe Text Cleaning: Markdown Bullet Cleanup with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining markdown bullet cleanup through a failure diagnosis pattern for safe text cleaning.
...
## Concept
The core idea is markdown bullet cleanup.
...
## Minimal Example
```text
input: b04-pds-0695 sample row
focus: markdown bullet cleanup
...
- Confirm the example describes markdown bullet cleanup rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining markdown bullet cleanup through a failure diagnosis pattern for safe text cleaning.
...
## Variation Note
Local example index: 95 within the safe text cleaning block.
