...
---
# Safe Text Cleaning: Newline Preservation Choices with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining newline preservation choices through a failure diagnosis pattern for safe text cleaning.
...
## Concept
The core idea is newline preservation choices.
...
## Minimal Example
```text
input: b04-pds-0696 sample row
focus: newline preservation choices
...
- Confirm the example describes newline preservation choices rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining newline preservation choices through a failure diagnosis pattern for safe text cleaning.
...
## Variation Note
Local example index: 96 within the safe text cleaning block.
