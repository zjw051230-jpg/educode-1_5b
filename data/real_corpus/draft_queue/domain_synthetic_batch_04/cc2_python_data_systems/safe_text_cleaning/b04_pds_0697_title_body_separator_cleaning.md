...
---
# Safe Text Cleaning: Title Body Separator Cleaning with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining title body separator cleaning through a failure diagnosis pattern for safe text cleaning.
It keeps the focus on safe text cleaning behavior instead of production scale concerns.
...
## Concept
The core idea is title body separator cleaning.
...
## Minimal Example
```text
input: b04-pds-0697 sample row
focus: title body separator cleaning
...
- Confirm the example describes title body separator cleaning rather than a different subtopic.
...
The third debugging question is whether the explanation still matches the directory theme of Safe Text Cleaning.

## Why This Draft Exists
This file is one of many small synthetic examples in domain_synthetic_batch_04.
Its purpose is to give reviewers a single teaching target: explaining title body separator cleaning through a failure diagnosis pattern for safe text cleaning.
...
## Variation Note
Local example index: 97 within the safe text cleaning block.
