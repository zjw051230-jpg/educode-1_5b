...
---
# Safe Text Cleaning: Repeated Separator Removal with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining repeated separator removal through a failure diagnosis pattern for safe text cleaning.
...
## Concept
The core idea is repeated separator removal.
...
## Minimal Example
```text
input: b04-pds-0698 sample row
focus: repeated separator removal
...
- Confirm the example describes repeated separator removal rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining repeated separator removal through a failure diagnosis pattern for safe text cleaning.
...
## Variation Note
Local example index: 98 within the safe text cleaning block.
