...
def build_demo_rows() -> list[dict[str, object]]:
    return [
        {"topic_id": "B04-PDS-0901", "label": EXAMPLE_LABELS[0], "position": 0},
        {"topic_id": "B04-PDS-0901", "label": EXAMPLE_LABELS[1], "position": 1},
        {"topic_id": "B04-PDS-0901", "label": EXAMPLE_LABELS[2], "position": 2},
    ]
...
def summarize_empty_file_detection(rows: Iterable[dict[str, object]]) -> dict[str, object]:
    ...
    return {
        "topic_id": "B04-PDS-0901",
        "objective": "explaining empty file detection through a golden path walkthrough for sanity checks",
...
def render_demo_path(base: str | Path) -> Path:
    return Path(base) / "b04_pds_0901.jsonl"
