...
---
# Sanity Checks: Metadata Header Presence with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining metadata header presence through a golden path walkthrough for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining metadata header presence through a golden path walkthrough for sanity checks.
...
## Variation Note
Local example index: 4 within the sanity checks block.
