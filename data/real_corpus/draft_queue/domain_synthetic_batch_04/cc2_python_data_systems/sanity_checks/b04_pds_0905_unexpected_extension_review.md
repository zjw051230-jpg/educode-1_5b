...
---
# Sanity Checks: Unexpected Extension Review with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining unexpected extension review through a golden path walkthrough for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining unexpected extension review through a golden path walkthrough for sanity checks.
...
## Variation Note
Local example index: 5 within the sanity checks block.
