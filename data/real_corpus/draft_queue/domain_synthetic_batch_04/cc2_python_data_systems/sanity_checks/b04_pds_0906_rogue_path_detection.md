...
---
# Sanity Checks: Rogue Path Detection with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining rogue path detection through a golden path walkthrough for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining rogue path detection through a golden path walkthrough for sanity checks.
...
## Variation Note
Local example index: 6 within the sanity checks block.
