...
---
# Sanity Checks: Row Count Sanity Checks with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining row count sanity checks through a golden path walkthrough for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining row count sanity checks through a golden path walkthrough for sanity checks.
...
## Variation Note
Local example index: 7 within the sanity checks block.
