...
---
# Sanity Checks: Manifest File Cross Checks with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining manifest file cross checks through a golden path walkthrough for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining manifest file cross checks through a golden path walkthrough for sanity checks.
...
## Variation Note
Local example index: 8 within the sanity checks block.
