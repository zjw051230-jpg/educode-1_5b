...
---
# Sanity Checks: Field Completeness Scan with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining field completeness scan through a golden path walkthrough for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining field completeness scan through a golden path walkthrough for sanity checks.
...
## Variation Note
Local example index: 9 within the sanity checks block.
