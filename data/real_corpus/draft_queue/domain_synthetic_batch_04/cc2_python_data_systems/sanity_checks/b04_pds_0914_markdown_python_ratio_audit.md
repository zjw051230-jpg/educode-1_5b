...
---
# Sanity Checks: Markdown Python Ratio Audit with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining markdown python ratio audit through a golden path walkthrough for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining markdown python ratio audit through a golden path walkthrough for sanity checks.
...
## Variation Note
Local example index: 14 within the sanity checks block.
