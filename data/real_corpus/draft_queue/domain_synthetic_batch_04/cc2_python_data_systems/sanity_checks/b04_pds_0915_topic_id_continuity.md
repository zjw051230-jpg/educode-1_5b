...
---
# Sanity Checks: Topic Id Continuity with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining topic id continuity through a golden path walkthrough for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining topic id continuity through a golden path walkthrough for sanity checks.
...
## Variation Note
Local example index: 15 within the sanity checks block.
