...
---
# Sanity Checks: Summary To Manifest Comparison with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining summary to manifest comparison through a golden path walkthrough for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining summary to manifest comparison through a golden path walkthrough for sanity checks.
...
## Variation Note
Local example index: 17 within the sanity checks block.
