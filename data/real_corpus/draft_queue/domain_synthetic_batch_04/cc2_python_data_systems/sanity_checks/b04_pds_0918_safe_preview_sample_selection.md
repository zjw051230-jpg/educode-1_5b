...
---
# Sanity Checks: Safe Preview Sample Selection with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining safe preview sample selection through a golden path walkthrough for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining safe preview sample selection through a golden path walkthrough for sanity checks.
...
## Variation Note
Local example index: 18 within the sanity checks block.
