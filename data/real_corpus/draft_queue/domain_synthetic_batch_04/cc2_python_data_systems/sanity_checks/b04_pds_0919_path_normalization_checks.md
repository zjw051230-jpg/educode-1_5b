...
---
# Sanity Checks: Path Normalization Checks with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining path normalization checks through a golden path walkthrough for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining path normalization checks through a golden path walkthrough for sanity checks.
...
## Variation Note
Local example index: 19 within the sanity checks block.
