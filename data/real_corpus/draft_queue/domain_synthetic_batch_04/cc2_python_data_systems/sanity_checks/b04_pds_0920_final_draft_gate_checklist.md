...
---
# Sanity Checks: Final Draft Gate Checklist with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining final draft gate checklist through a golden path walkthrough for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining final draft gate checklist through a golden path walkthrough for sanity checks.
...
## Variation Note
Local example index: 20 within the sanity checks block.
