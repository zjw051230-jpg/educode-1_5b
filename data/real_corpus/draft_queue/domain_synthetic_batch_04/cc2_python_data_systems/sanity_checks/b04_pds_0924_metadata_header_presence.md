...
---
# Sanity Checks: Metadata Header Presence with Edge Case Guardrail

## Teaching Objective
This draft teaches explaining metadata header presence through a edge case guardrail for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining metadata header presence through a edge case guardrail for sanity checks.
...
## Variation Note
Local example index: 24 within the sanity checks block.
