...
---
# Sanity Checks: Unexpected Extension Review with Edge Case Guardrail

## Teaching Objective
This draft teaches explaining unexpected extension review through a edge case guardrail for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining unexpected extension review through a edge case guardrail for sanity checks.
...
## Variation Note
Local example index: 25 within the sanity checks block.
