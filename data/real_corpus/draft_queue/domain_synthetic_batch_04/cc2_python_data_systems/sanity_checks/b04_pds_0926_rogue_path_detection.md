...
---
# Sanity Checks: Rogue Path Detection with Edge Case Guardrail

## Teaching Objective
This draft teaches explaining rogue path detection through a edge case guardrail for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining rogue path detection through a edge case guardrail for sanity checks.
...
## Variation Note
Local example index: 26 within the sanity checks block.
