...
---
# Sanity Checks: Row Count Sanity Checks with Edge Case Guardrail

## Teaching Objective
This draft teaches explaining row count sanity checks through a edge case guardrail for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining row count sanity checks through a edge case guardrail for sanity checks.
...
## Variation Note
Local example index: 27 within the sanity checks block.
