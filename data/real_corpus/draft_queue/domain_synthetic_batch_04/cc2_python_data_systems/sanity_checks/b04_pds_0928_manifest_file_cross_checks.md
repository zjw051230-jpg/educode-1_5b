...
---
# Sanity Checks: Manifest File Cross Checks with Edge Case Guardrail

## Teaching Objective
This draft teaches explaining manifest file cross checks through a edge case guardrail for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining manifest file cross checks through a edge case guardrail for sanity checks.
...
## Variation Note
Local example index: 28 within the sanity checks block.
