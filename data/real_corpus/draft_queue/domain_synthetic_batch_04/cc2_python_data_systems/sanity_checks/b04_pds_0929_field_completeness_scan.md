...
---
# Sanity Checks: Field Completeness Scan with Edge Case Guardrail

## Teaching Objective
This draft teaches explaining field completeness scan through a edge case guardrail for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining field completeness scan through a edge case guardrail for sanity checks.
...
## Variation Note
Local example index: 29 within the sanity checks block.
