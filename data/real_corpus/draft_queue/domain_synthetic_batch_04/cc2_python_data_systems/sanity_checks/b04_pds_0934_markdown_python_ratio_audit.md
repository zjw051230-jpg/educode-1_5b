...
---
# Sanity Checks: Markdown Python Ratio Audit with Edge Case Guardrail

## Teaching Objective
This draft teaches explaining markdown python ratio audit through a edge case guardrail for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining markdown python ratio audit through a edge case guardrail for sanity checks.
...
## Variation Note
Local example index: 34 within the sanity checks block.
