...
---
# Sanity Checks: Subdirectory Distribution Review with Edge Case Guardrail

## Teaching Objective
This draft teaches explaining subdirectory distribution review through a edge case guardrail for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining subdirectory distribution review through a edge case guardrail for sanity checks.
...
## Variation Note
Local example index: 36 within the sanity checks block.
