...
---
# Sanity Checks: Safe Preview Sample Selection with Edge Case Guardrail

## Teaching Objective
This draft teaches explaining safe preview sample selection through a edge case guardrail for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining safe preview sample selection through a edge case guardrail for sanity checks.
...
## Variation Note
Local example index: 38 within the sanity checks block.
