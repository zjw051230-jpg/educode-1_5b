...
---
# Sanity Checks: Path Normalization Checks with Edge Case Guardrail

## Teaching Objective
This draft teaches explaining path normalization checks through a edge case guardrail for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining path normalization checks through a edge case guardrail for sanity checks.
...
## Variation Note
Local example index: 39 within the sanity checks block.
