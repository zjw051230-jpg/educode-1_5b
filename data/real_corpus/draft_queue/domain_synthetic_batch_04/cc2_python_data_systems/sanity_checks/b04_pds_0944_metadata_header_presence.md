...
---
# Sanity Checks: Metadata Header Presence with Review Checklist Framing

## Teaching Objective
This draft teaches explaining metadata header presence through a review checklist framing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining metadata header presence through a review checklist framing for sanity checks.
...
## Variation Note
Local example index: 44 within the sanity checks block.
