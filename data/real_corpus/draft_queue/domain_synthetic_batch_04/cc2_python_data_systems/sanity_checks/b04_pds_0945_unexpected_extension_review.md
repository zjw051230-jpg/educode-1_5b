...
---
# Sanity Checks: Unexpected Extension Review with Review Checklist Framing

## Teaching Objective
This draft teaches explaining unexpected extension review through a review checklist framing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining unexpected extension review through a review checklist framing for sanity checks.
...
## Variation Note
Local example index: 45 within the sanity checks block.
