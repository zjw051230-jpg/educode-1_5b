...
---
# Sanity Checks: Rogue Path Detection with Review Checklist Framing

## Teaching Objective
This draft teaches explaining rogue path detection through a review checklist framing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining rogue path detection through a review checklist framing for sanity checks.
...
## Variation Note
Local example index: 46 within the sanity checks block.
