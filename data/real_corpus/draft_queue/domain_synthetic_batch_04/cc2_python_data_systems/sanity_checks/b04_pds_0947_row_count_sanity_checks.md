...
---
# Sanity Checks: Row Count Sanity Checks with Review Checklist Framing

## Teaching Objective
This draft teaches explaining row count sanity checks through a review checklist framing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining row count sanity checks through a review checklist framing for sanity checks.
...
## Variation Note
Local example index: 47 within the sanity checks block.
