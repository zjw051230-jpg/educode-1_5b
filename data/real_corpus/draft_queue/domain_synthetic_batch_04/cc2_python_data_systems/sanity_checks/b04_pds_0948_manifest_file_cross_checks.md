...
---
# Sanity Checks: Manifest File Cross Checks with Review Checklist Framing

## Teaching Objective
This draft teaches explaining manifest file cross checks through a review checklist framing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining manifest file cross checks through a review checklist framing for sanity checks.
...
## Variation Note
Local example index: 48 within the sanity checks block.
