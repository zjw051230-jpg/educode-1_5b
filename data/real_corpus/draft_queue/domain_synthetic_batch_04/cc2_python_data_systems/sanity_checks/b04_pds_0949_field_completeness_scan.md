...
---
# Sanity Checks: Field Completeness Scan with Review Checklist Framing

## Teaching Objective
This draft teaches explaining field completeness scan through a review checklist framing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining field completeness scan through a review checklist framing for sanity checks.
...
## Variation Note
Local example index: 49 within the sanity checks block.
