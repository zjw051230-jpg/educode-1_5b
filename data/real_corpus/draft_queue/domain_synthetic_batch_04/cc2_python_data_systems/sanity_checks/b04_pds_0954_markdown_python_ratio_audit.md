...
---
# Sanity Checks: Markdown Python Ratio Audit with Review Checklist Framing

## Teaching Objective
This draft teaches explaining markdown python ratio audit through a review checklist framing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining markdown python ratio audit through a review checklist framing for sanity checks.
...
## Variation Note
Local example index: 54 within the sanity checks block.
