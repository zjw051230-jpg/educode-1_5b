...
---
# Sanity Checks: Topic Id Continuity with Review Checklist Framing

## Teaching Objective
This draft teaches explaining topic id continuity through a review checklist framing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining topic id continuity through a review checklist framing for sanity checks.
...
## Variation Note
Local example index: 55 within the sanity checks block.
