...
---
# Sanity Checks: Summary To Manifest Comparison with Review Checklist Framing

## Teaching Objective
This draft teaches explaining summary to manifest comparison through a review checklist framing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining summary to manifest comparison through a review checklist framing for sanity checks.
...
## Variation Note
Local example index: 57 within the sanity checks block.
