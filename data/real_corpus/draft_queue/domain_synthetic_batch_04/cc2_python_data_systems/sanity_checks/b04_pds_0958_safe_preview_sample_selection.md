...
---
# Sanity Checks: Safe Preview Sample Selection with Review Checklist Framing

## Teaching Objective
This draft teaches explaining safe preview sample selection through a review checklist framing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining safe preview sample selection through a review checklist framing for sanity checks.
...
## Variation Note
Local example index: 58 within the sanity checks block.
