...
---
# Sanity Checks: Path Normalization Checks with Review Checklist Framing

## Teaching Objective
This draft teaches explaining path normalization checks through a review checklist framing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining path normalization checks through a review checklist framing for sanity checks.
...
## Variation Note
Local example index: 59 within the sanity checks block.
