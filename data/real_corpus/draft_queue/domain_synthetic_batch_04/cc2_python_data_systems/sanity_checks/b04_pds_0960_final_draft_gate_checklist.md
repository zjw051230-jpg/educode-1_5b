...
---
# Sanity Checks: Final Draft Gate Checklist with Review Checklist Framing

## Teaching Objective
This draft teaches explaining final draft gate checklist through a review checklist framing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining final draft gate checklist through a review checklist framing for sanity checks.
...
## Variation Note
Local example index: 60 within the sanity checks block.
