...
---
# Sanity Checks: Metadata Header Presence with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining metadata header presence through a shape and field tracing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining metadata header presence through a shape and field tracing for sanity checks.
...
## Variation Note
Local example index: 64 within the sanity checks block.
