...
---
# Sanity Checks: Unexpected Extension Review with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining unexpected extension review through a shape and field tracing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining unexpected extension review through a shape and field tracing for sanity checks.
...
## Variation Note
Local example index: 65 within the sanity checks block.
