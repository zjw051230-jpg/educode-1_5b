...
---
# Sanity Checks: Rogue Path Detection with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining rogue path detection through a shape and field tracing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining rogue path detection through a shape and field tracing for sanity checks.
...
## Variation Note
Local example index: 66 within the sanity checks block.
