...
---
# Sanity Checks: Row Count Sanity Checks with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining row count sanity checks through a shape and field tracing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining row count sanity checks through a shape and field tracing for sanity checks.
...
## Variation Note
Local example index: 67 within the sanity checks block.
