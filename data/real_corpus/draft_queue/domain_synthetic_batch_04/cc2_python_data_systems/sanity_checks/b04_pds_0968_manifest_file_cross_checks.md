...
---
# Sanity Checks: Manifest File Cross Checks with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining manifest file cross checks through a shape and field tracing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining manifest file cross checks through a shape and field tracing for sanity checks.
...
## Variation Note
Local example index: 68 within the sanity checks block.
