...
---
# Sanity Checks: Field Completeness Scan with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining field completeness scan through a shape and field tracing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining field completeness scan through a shape and field tracing for sanity checks.
...
## Variation Note
Local example index: 69 within the sanity checks block.
