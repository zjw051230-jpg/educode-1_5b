...
---
# Sanity Checks: Invalid Unicode Sentinel Checks with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining invalid unicode sentinel checks through a shape and field tracing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining invalid unicode sentinel checks through a shape and field tracing for sanity checks.
...
## Variation Note
Local example index: 70 within the sanity checks block.
