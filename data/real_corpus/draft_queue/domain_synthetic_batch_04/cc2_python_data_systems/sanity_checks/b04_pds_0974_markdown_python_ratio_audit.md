...
---
# Sanity Checks: Markdown Python Ratio Audit with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining markdown python ratio audit through a shape and field tracing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining markdown python ratio audit through a shape and field tracing for sanity checks.
...
## Variation Note
Local example index: 74 within the sanity checks block.
