...
---
# Sanity Checks: Topic Id Continuity with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining topic id continuity through a shape and field tracing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining topic id continuity through a shape and field tracing for sanity checks.
...
## Variation Note
Local example index: 75 within the sanity checks block.
