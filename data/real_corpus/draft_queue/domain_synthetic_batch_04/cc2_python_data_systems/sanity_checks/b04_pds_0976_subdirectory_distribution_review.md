...
---
# Sanity Checks: Subdirectory Distribution Review with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining subdirectory distribution review through a shape and field tracing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining subdirectory distribution review through a shape and field tracing for sanity checks.
...
## Variation Note
Local example index: 76 within the sanity checks block.
