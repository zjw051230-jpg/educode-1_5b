...
---
# Sanity Checks: Summary To Manifest Comparison with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining summary to manifest comparison through a shape and field tracing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining summary to manifest comparison through a shape and field tracing for sanity checks.
...
## Variation Note
Local example index: 77 within the sanity checks block.
