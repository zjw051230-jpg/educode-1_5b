...
---
# Sanity Checks: Safe Preview Sample Selection with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining safe preview sample selection through a shape and field tracing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining safe preview sample selection through a shape and field tracing for sanity checks.
...
## Variation Note
Local example index: 78 within the sanity checks block.
