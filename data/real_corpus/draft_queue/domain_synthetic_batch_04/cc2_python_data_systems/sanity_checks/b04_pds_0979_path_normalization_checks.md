...
---
# Sanity Checks: Path Normalization Checks with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining path normalization checks through a shape and field tracing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining path normalization checks through a shape and field tracing for sanity checks.
...
## Variation Note
Local example index: 79 within the sanity checks block.
