...
---
# Sanity Checks: Final Draft Gate Checklist with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining final draft gate checklist through a shape and field tracing for sanity checks.
...
Its purpose is to give reviewers a single teaching target: explaining final draft gate checklist through a shape and field tracing for sanity checks.
...
## Variation Note
Local example index: 80 within the sanity checks block.
