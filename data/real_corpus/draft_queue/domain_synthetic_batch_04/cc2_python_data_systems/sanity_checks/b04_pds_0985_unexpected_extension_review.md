...
---
# Sanity Checks: Unexpected Extension Review with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining unexpected extension review through a failure diagnosis pattern for sanity checks.
...
## Concept
The core idea is unexpected extension review.
...
## Minimal Example
```text
input: b04-pds-0985 sample row
focus: unexpected extension review
...
- Confirm the example describes unexpected extension review rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining unexpected extension review through a failure diagnosis pattern for sanity checks.
...
## Variation Note
Local example index: 85 within the sanity checks block.
