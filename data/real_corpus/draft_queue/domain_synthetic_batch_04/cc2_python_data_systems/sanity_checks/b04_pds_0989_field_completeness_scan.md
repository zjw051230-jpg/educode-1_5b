...
---
# Sanity Checks: Field Completeness Scan with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining field completeness scan through a failure diagnosis pattern for sanity checks.
...
## Concept
The core idea is field completeness scan.
...
## Minimal Example
```text
input: b04-pds-0989 sample row
focus: field completeness scan
...
- Confirm the example describes field completeness scan rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining field completeness scan through a failure diagnosis pattern for sanity checks.
...
## Variation Note
Local example index: 89 within the sanity checks block.
