...
---
# Sanity Checks: Markdown Python Ratio Audit with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining markdown python ratio audit through a failure diagnosis pattern for sanity checks.
...
## Concept
The core idea is markdown python ratio audit.
...
## Minimal Example
```text
input: b04-pds-0994 sample row
focus: markdown python ratio audit
...
- Confirm the example describes markdown python ratio audit rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining markdown python ratio audit through a failure diagnosis pattern for sanity checks.
...
## Variation Note
Local example index: 94 within the sanity checks block.
