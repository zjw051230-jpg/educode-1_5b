...
---
# Sanity Checks: Topic Id Continuity with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining topic id continuity through a failure diagnosis pattern for sanity checks.
...
## Concept
The core idea is topic id continuity.
...
## Minimal Example
```text
input: b04-pds-0995 sample row
focus: topic id continuity
...
- Confirm the example describes topic id continuity rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining topic id continuity through a failure diagnosis pattern for sanity checks.
...
## Variation Note
Local example index: 95 within the sanity checks block.
