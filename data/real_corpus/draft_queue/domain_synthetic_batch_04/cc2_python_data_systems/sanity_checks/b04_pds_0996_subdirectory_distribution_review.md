...
---
# Sanity Checks: Subdirectory Distribution Review with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining subdirectory distribution review through a failure diagnosis pattern for sanity checks.
It keeps the focus on sanity checks behavior instead of production scale concerns.
...
## Concept
The core idea is subdirectory distribution review.
...
## Minimal Example
```text
input: b04-pds-0996 sample row
focus: subdirectory distribution review
...
- Confirm the example describes subdirectory distribution review rather than a different subtopic.
...
The third debugging question is whether the explanation still matches the directory theme of Sanity Checks.

## Why This Draft Exists
This file is one of many small synthetic examples in domain_synthetic_batch_04.
Its purpose is to give reviewers a single teaching target: explaining subdirectory distribution review through a failure diagnosis pattern for sanity checks.
...
## Variation Note
Local example index: 96 within the sanity checks block.
