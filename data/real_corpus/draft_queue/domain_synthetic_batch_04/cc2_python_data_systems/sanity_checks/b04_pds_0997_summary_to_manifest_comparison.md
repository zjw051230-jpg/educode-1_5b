...
---
# Sanity Checks: Summary To Manifest Comparison with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining summary to manifest comparison through a failure diagnosis pattern for sanity checks.
...
## Concept
The core idea is summary to manifest comparison.
...
## Minimal Example
```text
input: b04-pds-0997 sample row
focus: summary to manifest comparison
...
- Confirm the example describes summary to manifest comparison rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining summary to manifest comparison through a failure diagnosis pattern for sanity checks.
...
## Variation Note
Local example index: 97 within the sanity checks block.
