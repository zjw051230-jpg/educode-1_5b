...
---
# Sequence Chunking: Document Boundary Preservation with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining document boundary preservation through a golden path walkthrough for sequence chunking.
...
Its purpose is to give reviewers a single teaching target: explaining document boundary preservation through a golden path walkthrough for sequence chunking.
...
## Variation Note
Local example index: 4 within the sequence chunking block.
