...
---
# Sequence Chunking: Chunk Ordering Stability with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining chunk ordering stability through a golden path walkthrough for sequence chunking.
...
Its purpose is to give reviewers a single teaching target: explaining chunk ordering stability through a golden path walkthrough for sequence chunking.
...
## Variation Note
Local example index: 19 within the sequence chunking block.
