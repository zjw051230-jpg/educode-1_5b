...
---
# Sequence Chunking: Chunk Ordering Stability with Review Checklist Framing

## Teaching Objective
This draft teaches explaining chunk ordering stability through a review checklist framing for sequence chunking.
...
Its purpose is to give reviewers a single teaching target: explaining chunk ordering stability through a review checklist framing for sequence chunking.
...
## Variation Note
Local example index: 59 within the sequence chunking block.
