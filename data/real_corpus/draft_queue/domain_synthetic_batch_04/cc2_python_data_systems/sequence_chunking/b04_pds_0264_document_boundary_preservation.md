...
---
# Sequence Chunking: Document Boundary Preservation with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining document boundary preservation through a shape and field tracing for sequence chunking.
...
Its purpose is to give reviewers a single teaching target: explaining document boundary preservation through a shape and field tracing for sequence chunking.
...
## Variation Note
Local example index: 64 within the sequence chunking block.
