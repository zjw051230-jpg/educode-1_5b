...
---
# Sequence Chunking: Chunk Index Metadata with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining chunk index metadata through a shape and field tracing for sequence chunking.
...
Its purpose is to give reviewers a single teaching target: explaining chunk index metadata through a shape and field tracing for sequence chunking.
...
## Variation Note
Local example index: 65 within the sequence chunking block.
