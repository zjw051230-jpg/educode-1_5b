...
---
# Sequence Chunking: Window Start Tracking with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining window start tracking through a shape and field tracing for sequence chunking.
...
Its purpose is to give reviewers a single teaching target: explaining window start tracking through a shape and field tracing for sequence chunking.
...
## Variation Note
Local example index: 69 within the sequence chunking block.
