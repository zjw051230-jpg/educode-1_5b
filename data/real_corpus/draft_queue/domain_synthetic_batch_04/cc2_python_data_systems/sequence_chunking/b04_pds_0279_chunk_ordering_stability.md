...
---
# Sequence Chunking: Chunk Ordering Stability with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining chunk ordering stability through a shape and field tracing for sequence chunking.
...
Its purpose is to give reviewers a single teaching target: explaining chunk ordering stability through a shape and field tracing for sequence chunking.
...
## Variation Note
Local example index: 79 within the sequence chunking block.
