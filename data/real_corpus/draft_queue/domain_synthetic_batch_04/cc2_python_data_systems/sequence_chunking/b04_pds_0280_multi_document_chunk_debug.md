...
---
# Sequence Chunking: Multi Document Chunk Debug with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining multi document chunk debug through a shape and field tracing for sequence chunking.
...
Its purpose is to give reviewers a single teaching target: explaining multi document chunk debug through a shape and field tracing for sequence chunking.
...
## Variation Note
Local example index: 80 within the sequence chunking block.
