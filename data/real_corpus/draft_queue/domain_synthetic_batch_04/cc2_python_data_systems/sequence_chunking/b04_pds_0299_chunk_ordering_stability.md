...
---
# Sequence Chunking: Chunk Ordering Stability with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining chunk ordering stability through a failure diagnosis pattern for sequence chunking.
...
## Concept
The core idea is chunk ordering stability.
...
## Minimal Example
```text
input: b04-pds-0299 sample row
focus: chunk ordering stability
...
- Confirm the example describes chunk ordering stability rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining chunk ordering stability through a failure diagnosis pattern for sequence chunking.
...
## Variation Note
Local example index: 99 within the sequence chunking block.
