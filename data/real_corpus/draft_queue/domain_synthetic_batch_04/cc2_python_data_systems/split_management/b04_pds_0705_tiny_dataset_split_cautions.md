...
---
# Split Management: Tiny Dataset Split Cautions with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining tiny dataset split cautions through a golden path walkthrough for split management.
...
Its purpose is to give reviewers a single teaching target: explaining tiny dataset split cautions through a golden path walkthrough for split management.
...
## Variation Note
Local example index: 5 within the split management block.
