...
---
# Split Management: Split Manifest Generation with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining split manifest generation through a golden path walkthrough for split management.
...
Its purpose is to give reviewers a single teaching target: explaining split manifest generation through a golden path walkthrough for split management.
...
## Variation Note
Local example index: 7 within the split management block.
