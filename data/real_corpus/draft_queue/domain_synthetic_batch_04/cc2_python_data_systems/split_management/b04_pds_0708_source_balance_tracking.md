...
---
# Split Management: Source Balance Tracking with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining source balance tracking through a golden path walkthrough for split management.
...
Its purpose is to give reviewers a single teaching target: explaining source balance tracking through a golden path walkthrough for split management.
...
## Variation Note
Local example index: 8 within the split management block.
