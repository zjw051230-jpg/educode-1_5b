...
---
# Split Management: Manual Override Records with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining manual override records through a golden path walkthrough for split management.
...
Its purpose is to give reviewers a single teaching target: explaining manual override records through a golden path walkthrough for split management.
...
## Variation Note
Local example index: 15 within the split management block.
