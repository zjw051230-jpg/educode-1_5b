...
---
# Split Management: Split Summary Tables with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining split summary tables through a golden path walkthrough for split management.
...
Its purpose is to give reviewers a single teaching target: explaining split summary tables through a golden path walkthrough for split management.
...
## Variation Note
Local example index: 16 within the split management block.
