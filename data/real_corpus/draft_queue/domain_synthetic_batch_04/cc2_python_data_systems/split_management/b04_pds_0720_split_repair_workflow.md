...
---
# Split Management: Split Repair Workflow with Golden Path Walkthrough

## Teaching Objective
This draft teaches explaining split repair workflow through a golden path walkthrough for split management.
...
Its purpose is to give reviewers a single teaching target: explaining split repair workflow through a golden path walkthrough for split management.
...
## Variation Note
Local example index: 20 within the split management block.
