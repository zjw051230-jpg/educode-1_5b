...
---
# Split Management: Source Balance Tracking with Edge Case Guardrail

## Teaching Objective
This draft teaches explaining source balance tracking through a edge case guardrail for split management.
...
Its purpose is to give reviewers a single teaching target: explaining source balance tracking through a edge case guardrail for split management.
...
## Variation Note
Local example index: 28 within the split management block.
