...
---
# Split Management: Manual Override Records with Edge Case Guardrail

## Teaching Objective
This draft teaches explaining manual override records through a edge case guardrail for split management.
...
Its purpose is to give reviewers a single teaching target: explaining manual override records through a edge case guardrail for split management.
...
## Variation Note
Local example index: 35 within the split management block.
