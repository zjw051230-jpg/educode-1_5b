...
---
# Split Management: Split Summary Tables with Edge Case Guardrail

## Teaching Objective
This draft teaches explaining split summary tables through a edge case guardrail for split management.
...
Its purpose is to give reviewers a single teaching target: explaining split summary tables through a edge case guardrail for split management.
...
## Variation Note
Local example index: 36 within the split management block.
