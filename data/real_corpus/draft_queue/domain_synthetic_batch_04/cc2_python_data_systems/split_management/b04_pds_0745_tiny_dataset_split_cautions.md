...
---
# Split Management: Tiny Dataset Split Cautions with Review Checklist Framing

## Teaching Objective
This draft teaches explaining tiny dataset split cautions through a review checklist framing for split management.
...
Its purpose is to give reviewers a single teaching target: explaining tiny dataset split cautions through a review checklist framing for split management.
...
## Variation Note
Local example index: 45 within the split management block.
