...
---
# Split Management: Split Manifest Generation with Review Checklist Framing

## Teaching Objective
This draft teaches explaining split manifest generation through a review checklist framing for split management.
...
Its purpose is to give reviewers a single teaching target: explaining split manifest generation through a review checklist framing for split management.
...
## Variation Note
Local example index: 47 within the split management block.
