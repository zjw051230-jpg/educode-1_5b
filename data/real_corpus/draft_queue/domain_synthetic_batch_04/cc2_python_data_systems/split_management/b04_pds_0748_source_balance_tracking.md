...
---
# Split Management: Source Balance Tracking with Review Checklist Framing

## Teaching Objective
This draft teaches explaining source balance tracking through a review checklist framing for split management.
...
Its purpose is to give reviewers a single teaching target: explaining source balance tracking through a review checklist framing for split management.
...
## Variation Note
Local example index: 48 within the split management block.
