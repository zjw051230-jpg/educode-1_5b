...
---
# Split Management: Split Summary Tables with Review Checklist Framing

## Teaching Objective
This draft teaches explaining split summary tables through a review checklist framing for split management.
...
Its purpose is to give reviewers a single teaching target: explaining split summary tables through a review checklist framing for split management.
...
## Variation Note
Local example index: 56 within the split management block.
