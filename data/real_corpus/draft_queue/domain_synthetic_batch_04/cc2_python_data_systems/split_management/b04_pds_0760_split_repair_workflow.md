...
---
# Split Management: Split Repair Workflow with Review Checklist Framing

## Teaching Objective
This draft teaches explaining split repair workflow through a review checklist framing for split management.
...
Its purpose is to give reviewers a single teaching target: explaining split repair workflow through a review checklist framing for split management.
...
## Variation Note
Local example index: 60 within the split management block.
