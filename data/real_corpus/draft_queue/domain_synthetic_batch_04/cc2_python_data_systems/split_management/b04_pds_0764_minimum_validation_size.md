...
---
# Split Management: Minimum Validation Size with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining minimum validation size through a shape and field tracing for split management.
...
Its purpose is to give reviewers a single teaching target: explaining minimum validation size through a shape and field tracing for split management.
...
## Variation Note
Local example index: 64 within the split management block.
