...
---
# Split Management: Tiny Dataset Split Cautions with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining tiny dataset split cautions through a shape and field tracing for split management.
...
Its purpose is to give reviewers a single teaching target: explaining tiny dataset split cautions through a shape and field tracing for split management.
...
## Variation Note
Local example index: 65 within the split management block.
