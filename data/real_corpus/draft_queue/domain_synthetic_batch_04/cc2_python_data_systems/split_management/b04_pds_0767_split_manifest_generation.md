...
---
# Split Management: Split Manifest Generation with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining split manifest generation through a shape and field tracing for split management.
...
Its purpose is to give reviewers a single teaching target: explaining split manifest generation through a shape and field tracing for split management.
...
## Variation Note
Local example index: 67 within the split management block.
