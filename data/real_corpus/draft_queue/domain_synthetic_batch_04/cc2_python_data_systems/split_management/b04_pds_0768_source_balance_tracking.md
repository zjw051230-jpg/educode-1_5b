...
---
# Split Management: Source Balance Tracking with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining source balance tracking through a shape and field tracing for split management.
...
Its purpose is to give reviewers a single teaching target: explaining source balance tracking through a shape and field tracing for split management.
...
## Variation Note
Local example index: 68 within the split management block.
