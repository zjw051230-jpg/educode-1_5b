...
---
# Split Management: Split Count Validation with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining split count validation through a shape and field tracing for split management.
...
Its purpose is to give reviewers a single teaching target: explaining split count validation through a shape and field tracing for split management.
...
## Variation Note
Local example index: 69 within the split management block.
