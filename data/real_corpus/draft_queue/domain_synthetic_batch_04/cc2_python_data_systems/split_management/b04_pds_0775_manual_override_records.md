...
---
# Split Management: Manual Override Records with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining manual override records through a shape and field tracing for split management.
...
Its purpose is to give reviewers a single teaching target: explaining manual override records through a shape and field tracing for split management.
...
## Variation Note
Local example index: 75 within the split management block.
