...
---
# Split Management: Split Summary Tables with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining split summary tables through a shape and field tracing for split management.
...
Its purpose is to give reviewers a single teaching target: explaining split summary tables through a shape and field tracing for split management.
...
## Variation Note
Local example index: 76 within the split management block.
