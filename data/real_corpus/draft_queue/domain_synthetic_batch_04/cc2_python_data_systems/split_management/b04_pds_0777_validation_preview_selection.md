...
---
# Split Management: Validation Preview Selection with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining validation preview selection through a shape and field tracing for split management.
...
Its purpose is to give reviewers a single teaching target: explaining validation preview selection through a shape and field tracing for split management.
...
## Variation Note
Local example index: 77 within the split management block.
