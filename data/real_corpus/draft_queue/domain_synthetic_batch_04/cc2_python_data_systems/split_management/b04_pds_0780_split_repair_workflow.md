...
---
# Split Management: Split Repair Workflow with Shape And Field Tracing

## Teaching Objective
This draft teaches explaining split repair workflow through a shape and field tracing for split management.
...
Its purpose is to give reviewers a single teaching target: explaining split repair workflow through a shape and field tracing for split management.
...
## Variation Note
Local example index: 80 within the split management block.
