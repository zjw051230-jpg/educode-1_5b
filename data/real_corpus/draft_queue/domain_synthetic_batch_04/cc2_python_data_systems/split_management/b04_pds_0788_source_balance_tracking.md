...
---
# Split Management: Source Balance Tracking with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining source balance tracking through a failure diagnosis pattern for split management.
...
## Concept
The core idea is source balance tracking.
...
## Minimal Example
```text
input: b04-pds-0788 sample row
focus: source balance tracking
...
- Confirm the example describes source balance tracking rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining source balance tracking through a failure diagnosis pattern for split management.
...
## Variation Note
Local example index: 88 within the split management block.
