...
---
# Split Management: Manual Override Records with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining manual override records through a failure diagnosis pattern for split management.
...
## Concept
The core idea is manual override records.
...
## Minimal Example
```text
input: b04-pds-0795 sample row
focus: manual override records
...
- Confirm the example describes manual override records rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining manual override records through a failure diagnosis pattern for split management.
...
## Variation Note
Local example index: 95 within the split management block.
