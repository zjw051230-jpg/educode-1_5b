...
---
# Split Management: Split Summary Tables with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining split summary tables through a failure diagnosis pattern for split management.
...
## Concept
The core idea is split summary tables.
...
## Minimal Example
```text
input: b04-pds-0796 sample row
focus: split summary tables
...
- Confirm the example describes split summary tables rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining split summary tables through a failure diagnosis pattern for split management.
...
## Variation Note
Local example index: 96 within the split management block.
