...
---
# Split Management: Validation Preview Selection with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining validation preview selection through a failure diagnosis pattern for split management.
...
## Concept
The core idea is validation preview selection.
...
## Minimal Example
```text
input: b04-pds-0797 sample row
focus: validation preview selection
...
- Confirm the example describes validation preview selection rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining validation preview selection through a failure diagnosis pattern for split management.
...
## Variation Note
Local example index: 97 within the split management block.
