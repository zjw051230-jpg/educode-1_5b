...
---
# Split Management: Split Repair Workflow with Failure Diagnosis Pattern

## Teaching Objective
This draft teaches explaining split repair workflow through a failure diagnosis pattern for split management.
...
## Concept
The core idea is split repair workflow.
...
## Minimal Example
```text
input: b04-pds-0800 sample row
focus: split repair workflow
...
- Confirm the example describes split repair workflow rather than a different subtopic.
...
Its purpose is to give reviewers a single teaching target: explaining split repair workflow through a failure diagnosis pattern for split management.
...
## Variation Note
Local example index: 100 within the split management block.
