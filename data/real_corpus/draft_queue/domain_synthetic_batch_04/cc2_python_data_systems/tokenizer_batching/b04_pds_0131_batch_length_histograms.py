...
def build_demo_rows() -> list[dict[str, object]]:
    return [
        {"topic_id": "B04-PDS-0131", "label": EXAMPLE_LABELS[0], "position": 0},
        {"topic_id": "B04-PDS-0131", "label": EXAMPLE_LABELS[1], "position": 1},
        {"topic_id": "B04-PDS-0131", "label": EXAMPLE_LABELS[2], "position": 2},
    ]
...
def summarize_batch_length_histograms(rows: Iterable[dict[str, object]]) -> dict[str, object]:
    ...
    return {
        "topic_id": "B04-PDS-0131",
        "objective": "explaining batch length histograms through a edge case guardrail for tokenizer batching",
...
def render_demo_path(base: str | Path) -> Path:
    return Path(base) / "b04_pds_0131.jsonl"
