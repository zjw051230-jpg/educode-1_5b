...
def build_demo_rows() -> list[dict[str, object]]:
    return [
        {"topic_id": "B04-PDS-0193", "label": EXAMPLE_LABELS[0], "position": 0},
        {"topic_id": "B04-PDS-0193", "label": EXAMPLE_LABELS[1], "position": 1},
        {"topic_id": "B04-PDS-0193", "label": EXAMPLE_LABELS[2], "position": 2},
    ]
...
def summarize_same_length_grouping(rows: Iterable[dict[str, object]]) -> dict[str, object]:
    ...
    return {
        "topic_id": "B04-PDS-0193",
        "objective": "explaining same length grouping through a failure diagnosis pattern for tokenizer batching",
...
def render_demo_path(base: str | Path) -> Path:
    return Path(base) / "b04_pds_0193.jsonl"
