...
"""Causal Mask - Mask Broadcasting Code Demo 75 in Attention Masking."""

def demo_attention_masking_config_check_75(batch_size=2, seq_len=6, d_model=12, num_heads=3, vocab_size=32):
    if num_heads <= 0:
    ...
    print("focus:", 'causal mask - mask broadcasting')
...
if __name__ == "__main__":
    demo_attention_masking_config_check_75()
