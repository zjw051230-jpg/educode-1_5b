...
"""Causal Mask - Lower-Triangular Structure Code Demo 81 in Attention Masking."""

def demo_attention_masking_config_check_81(batch_size=2, seq_len=6, d_model=12, num_heads=3, vocab_size=32):
    if num_heads <= 0:
    ...
    print("focus:", 'causal mask - lower-triangular structure')
...
if __name__ == "__main__":
    demo_attention_masking_config_check_81()
