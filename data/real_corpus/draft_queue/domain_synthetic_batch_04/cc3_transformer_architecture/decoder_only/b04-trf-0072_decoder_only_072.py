...
"""Decoder-Only Transformer - Label Shifting Intuition Code Demo 72 in Decoder Only."""

def demo_decoder_only_shape_trace_72(batch_size=2, seq_len=6, d_model=12, num_heads=3, vocab_size=32):
    if num_heads <= 0:
...
if __name__ == "__main__":
    demo_decoder_only_shape_trace_72()
