...
"""Decoder-Only Transformer - Next-Token Supervision Code Demo 77 in Decoder Only."""

def demo_decoder_only_dimension_assert_77(batch_size=2, seq_len=6, d_model=12, num_heads=3, vocab_size=32):
    if num_heads <= 0:
...
if __name__ == "__main__":
    demo_decoder_only_dimension_assert_77()
