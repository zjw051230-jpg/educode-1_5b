...
"""Decoder-Only Transformer - Prefix-Only Prediction Code Demo 91 in Decoder Only."""

def demo_decoder_only_config_check_91(batch_size=2, seq_len=6, d_model=12, num_heads=3, vocab_size=32):
    if num_heads <= 0:
    ...
    print("focus:", 'decoder-only transformer - prefix-only prediction')
...
if __name__ == "__main__":
    demo_decoder_only_config_check_91()
