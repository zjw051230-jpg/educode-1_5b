...
"""Token And Position Embeddings - Embedding Lookup Basics Code Demo 81 in Embeddings Positions."""

def demo_embeddings_positions_config_check_81(batch_size=2, seq_len=6, d_model=12, num_heads=3, vocab_size=32):
    if num_heads <= 0:
    ...
    print("focus:", 'token and position embeddings - embedding lookup basics')
...
if __name__ == "__main__":
    demo_embeddings_positions_config_check_81()
