...
"""Token And Position Embeddings - Learned Position Tables Code Demo 93 in Embeddings Positions."""

def demo_embeddings_positions_config_check_93(batch_size=2, seq_len=6, d_model=12, num_heads=3, vocab_size=32):
    if num_heads <= 0:
    ...
    print("focus:", 'token and position embeddings - learned position tables')
...
if __name__ == "__main__":
    demo_embeddings_positions_config_check_93()
