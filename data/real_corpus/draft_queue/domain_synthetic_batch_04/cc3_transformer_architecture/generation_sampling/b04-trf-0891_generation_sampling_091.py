...
"""Generation Sampling - Argmax Preview Code Demo 91 in Generation Sampling."""

def demo_generation_sampling_projection_demo_91(batch_size=2, seq_len=6, d_model=12, num_heads=3, vocab_size=32):
    if num_heads <= 0:
...
if __name__ == "__main__":
    demo_generation_sampling_projection_demo_91()
