...
"""Logits Projection - Output Pipeline Debug Notes Code Demo 100 in Logits Projection."""

def demo_logits_projection_mask_demo_100(batch_size=2, seq_len=6, d_model=12, num_heads=3, vocab_size=32):
    if num_heads <= 0:
...
if __name__ == "__main__":
    demo_logits_projection_mask_demo_100()
