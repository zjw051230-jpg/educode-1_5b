...
"""Multi-Head Attention - Merge-Back Projection Code Demo 73 in Multi Head Attention."""

def demo_multi_head_attention_config_check_73(batch_size=2, seq_len=6, d_model=12, num_heads=3, vocab_size=32):
    if num_heads <= 0:
    ...
    print("focus:", 'multi-head attention - merge-back projection')
...
if __name__ == "__main__":
    demo_multi_head_attention_config_check_73()
