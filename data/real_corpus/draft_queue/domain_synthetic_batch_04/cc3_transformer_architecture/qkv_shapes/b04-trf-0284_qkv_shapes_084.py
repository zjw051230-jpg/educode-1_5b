...
"""Q/K/V Projections - Value Shape Tracing Code Demo 84 in Qkv Shapes."""

def demo_qkv_shapes_mask_demo_84(batch_size=2, seq_len=6, d_model=12, num_heads=3, vocab_size=32):
    if num_heads <= 0:
