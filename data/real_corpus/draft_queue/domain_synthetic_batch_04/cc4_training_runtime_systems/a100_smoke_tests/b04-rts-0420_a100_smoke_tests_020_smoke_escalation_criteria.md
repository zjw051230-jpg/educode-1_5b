...
# Smoke Escalation Criteria Naming Notes

## Concept
Smoke escalation criteria is the main teaching target for this draft candidate.
...
## Explanation
Example index 420 uses a narrow lens: smoke escalation criteria.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0420.
The reviewer opens a a100_smoke_tests artifact and asks whether the primary signal for smoke escalation criteria is present.
...
## Review Notes
This file exists to teach one distinct review target: smoke escalation criteria.
