...
# Loss Finite Checks Failure Patterns

## Concept
Loss finite checks is the main teaching target for this draft candidate.
...
## Explanation
Example index 422 uses a narrow lens: loss finite checks.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0422.
The reviewer opens a a100_smoke_tests artifact and asks whether the primary signal for loss finite checks is present.
...
## Review Notes
This file exists to teach one distinct review target: loss finite checks.
