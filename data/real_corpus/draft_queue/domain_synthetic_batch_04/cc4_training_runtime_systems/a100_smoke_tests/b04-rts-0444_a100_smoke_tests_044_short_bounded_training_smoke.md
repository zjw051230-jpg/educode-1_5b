...
# Short Bounded Training Smoke Audit Cues

## Concept
Short bounded training smoke is the main teaching target for this draft candidate.
...
## Explanation
Example index 444 uses a narrow lens: short bounded training smoke.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0444.
The reviewer opens a a100_smoke_tests artifact and asks whether the primary signal for short bounded training smoke is present.
...
## Review Notes
This file exists to teach one distinct review target: short bounded training smoke.
