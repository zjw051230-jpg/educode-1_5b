...
# Single-Step Backward Smoke Comparison Notes

## Concept
Single-step backward smoke is the main teaching target for this draft candidate.
...
## Explanation
Example index 453 uses a narrow lens: single-step backward smoke.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0453.
The reviewer opens a a100_smoke_tests artifact and asks whether the primary signal for single-step backward smoke is present.
...
## Review Notes
This file exists to teach one distinct review target: single-step backward smoke.
