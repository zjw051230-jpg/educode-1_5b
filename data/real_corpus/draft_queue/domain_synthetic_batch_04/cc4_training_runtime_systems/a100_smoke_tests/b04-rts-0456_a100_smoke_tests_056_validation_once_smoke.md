...
# Validation-Once Smoke Minimal Review Flow

## Concept
Validation-once smoke is the main teaching target for this draft candidate.
...
## Explanation
Example index 456 uses a narrow lens: validation-once smoke.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0456.
The reviewer opens a a100_smoke_tests artifact and asks whether the primary signal for validation-once smoke is present.
...
## Review Notes
This file exists to teach one distinct review target: validation-once smoke.
