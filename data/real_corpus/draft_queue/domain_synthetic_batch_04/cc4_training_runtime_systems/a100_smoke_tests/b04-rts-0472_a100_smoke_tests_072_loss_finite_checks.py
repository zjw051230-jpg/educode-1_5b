...
def build_a100_smoke_tests_0472(rows):
    summary = {
        'topic_id': 'B04-RTS-0472',
        'focus': 'loss finite checks',
        'row_count': len(rows),
...
summary = build_a100_smoke_tests_0472(sample_rows)
flags = check_a100_smoke_tests_71(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates loss finite checks.
