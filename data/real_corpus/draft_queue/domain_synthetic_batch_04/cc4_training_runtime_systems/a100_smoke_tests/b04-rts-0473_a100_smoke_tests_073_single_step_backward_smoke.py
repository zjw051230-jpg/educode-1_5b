...
def build_a100_smoke_tests_0473(rows):
    summary = {
        'topic_id': 'B04-RTS-0473',
...
def check_a100_smoke_tests_72(summary):
    flags = {
...
sample_rows = [2.37, 2.62, 2.87, 3.12, 3.37]
summary = build_a100_smoke_tests_0473(sample_rows)
flags = check_a100_smoke_tests_72(summary)
print(summary)
print(flags)
