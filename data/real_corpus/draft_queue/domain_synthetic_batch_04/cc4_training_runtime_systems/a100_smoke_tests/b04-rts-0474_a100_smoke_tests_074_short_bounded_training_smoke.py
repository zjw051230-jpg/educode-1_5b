...
def build_a100_smoke_tests_0474(rows):
    summary = {
        'topic_id': 'B04-RTS-0474',
...
def check_a100_smoke_tests_73(summary):
    flags = {
...
sample_rows = [2.48, 2.73, 2.98, 3.23, 3.48]
summary = build_a100_smoke_tests_0474(sample_rows)
flags = check_a100_smoke_tests_73(summary)
print(summary)
print(flags)
