...
def build_a100_smoke_tests_0475(rows):
    summary = {
        'topic_id': 'B04-RTS-0475',
...
def check_a100_smoke_tests_74(summary):
    flags = {
...
sample_rows = [2.59, 2.84, 3.09, 3.34, 3.59]
summary = build_a100_smoke_tests_0475(sample_rows)
flags = check_a100_smoke_tests_74(summary)
print(summary)
print(flags)
