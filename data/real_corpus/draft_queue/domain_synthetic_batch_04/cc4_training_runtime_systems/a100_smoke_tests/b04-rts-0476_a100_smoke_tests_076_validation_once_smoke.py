...
def build_a100_smoke_tests_0476(rows):
    summary = {
        'topic_id': 'B04-RTS-0476',
...
def check_a100_smoke_tests_75(summary):
    flags = {
...
sample_rows = [1.0, 1.25, 1.5, 1.75, 2.0]
summary = build_a100_smoke_tests_0476(sample_rows)
flags = check_a100_smoke_tests_75(summary)
print(summary)
print(flags)
