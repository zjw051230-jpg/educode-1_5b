...
def build_a100_smoke_tests_0477(rows):
    summary = {
        'topic_id': 'B04-RTS-0477',
...
def check_a100_smoke_tests_76(summary):
    flags = {
...
summary = build_a100_smoke_tests_0477(sample_rows)
flags = check_a100_smoke_tests_76(summary)
print(summary)
print(flags)
