...
def build_a100_smoke_tests_0478(rows):
    summary = {
        'topic_id': 'B04-RTS-0478',
...
def check_a100_smoke_tests_77(summary):
    flags = {
...
sample_rows = [1.22, 1.47, 1.72, 1.97, 2.22]
summary = build_a100_smoke_tests_0478(sample_rows)
flags = check_a100_smoke_tests_77(summary)
print(summary)
print(flags)
