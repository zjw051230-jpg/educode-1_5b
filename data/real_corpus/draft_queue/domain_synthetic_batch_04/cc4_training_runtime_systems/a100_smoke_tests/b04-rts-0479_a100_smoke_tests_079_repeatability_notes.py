...
def build_a100_smoke_tests_0479(rows):
    summary = {
        'topic_id': 'B04-RTS-0479',
...
def check_a100_smoke_tests_78(summary):
    flags = {
...
summary = build_a100_smoke_tests_0479(sample_rows)
flags = check_a100_smoke_tests_78(summary)
print(summary)
print(flags)
