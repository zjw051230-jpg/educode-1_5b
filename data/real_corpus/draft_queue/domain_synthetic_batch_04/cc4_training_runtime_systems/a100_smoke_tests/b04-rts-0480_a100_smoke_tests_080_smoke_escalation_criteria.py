...
def build_a100_smoke_tests_0480(rows):
    summary = {
        'topic_id': 'B04-RTS-0480',
...
def check_a100_smoke_tests_79(summary):
    flags = {
...
summary = build_a100_smoke_tests_0480(sample_rows)
flags = check_a100_smoke_tests_79(summary)
print(summary)
print(flags)
