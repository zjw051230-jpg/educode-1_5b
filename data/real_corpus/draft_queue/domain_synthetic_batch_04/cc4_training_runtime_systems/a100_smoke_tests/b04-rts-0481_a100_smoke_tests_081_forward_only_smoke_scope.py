...
def build_a100_smoke_tests_0481(rows):
    summary = {
        'topic_id': 'B04-RTS-0481',
...
def check_a100_smoke_tests_80(summary):
    flags = {
...
summary = build_a100_smoke_tests_0481(sample_rows)
flags = check_a100_smoke_tests_80(summary)
print(summary)
print(flags)
