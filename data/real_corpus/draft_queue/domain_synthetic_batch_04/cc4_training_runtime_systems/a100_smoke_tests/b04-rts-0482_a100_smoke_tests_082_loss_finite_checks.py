...
def build_a100_smoke_tests_0482(rows):
    summary = {
        'topic_id': 'B04-RTS-0482',
...
def check_a100_smoke_tests_81(summary):
    flags = {
...
summary = build_a100_smoke_tests_0482(sample_rows)
flags = check_a100_smoke_tests_81(summary)
print(summary)
print(flags)
