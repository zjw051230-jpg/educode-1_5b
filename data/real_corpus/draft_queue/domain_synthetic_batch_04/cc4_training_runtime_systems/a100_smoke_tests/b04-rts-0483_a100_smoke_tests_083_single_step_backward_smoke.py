...
def build_a100_smoke_tests_0483(rows):
    summary = {
        'topic_id': 'B04-RTS-0483',
...
def check_a100_smoke_tests_82(summary):
    flags = {
...
summary = build_a100_smoke_tests_0483(sample_rows)
flags = check_a100_smoke_tests_82(summary)
print(summary)
print(flags)
