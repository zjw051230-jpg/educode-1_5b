...
def build_a100_smoke_tests_0485(rows):
    summary = {
        'topic_id': 'B04-RTS-0485',
        'focus': 'checkpoint smoke expectations',
        'row_count': len(rows),
...
def check_a100_smoke_tests_84(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'checkpoint smoke expectations',
    }
...
summary = build_a100_smoke_tests_0485(sample_rows)
flags = check_a100_smoke_tests_84(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates checkpoint smoke expectations.
