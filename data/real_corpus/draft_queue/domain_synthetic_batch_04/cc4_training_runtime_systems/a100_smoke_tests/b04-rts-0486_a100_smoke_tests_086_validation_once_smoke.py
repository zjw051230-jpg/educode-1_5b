...
def build_a100_smoke_tests_0486(rows):
    summary = {
        'topic_id': 'B04-RTS-0486',
        'focus': 'validation-once smoke',
        'row_count': len(rows),
...
def check_a100_smoke_tests_85(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'validation-once smoke',
    }
...
summary = build_a100_smoke_tests_0486(sample_rows)
flags = check_a100_smoke_tests_85(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates validation-once smoke.
