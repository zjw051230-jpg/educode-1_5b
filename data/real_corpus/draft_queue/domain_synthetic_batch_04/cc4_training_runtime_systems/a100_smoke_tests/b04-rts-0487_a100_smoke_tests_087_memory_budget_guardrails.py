...
def build_a100_smoke_tests_0487(rows):
    summary = {
        'topic_id': 'B04-RTS-0487',
...
def check_a100_smoke_tests_86(summary):
    flags = {
...
summary = build_a100_smoke_tests_0487(sample_rows)
flags = check_a100_smoke_tests_86(summary)
print(summary)
print(flags)
