...
def build_a100_smoke_tests_0488(rows):
    summary = {
        'topic_id': 'B04-RTS-0488',
...
def check_a100_smoke_tests_87(summary):
    flags = {
...
summary = build_a100_smoke_tests_0488(sample_rows)
flags = check_a100_smoke_tests_87(summary)
print(summary)
print(flags)
