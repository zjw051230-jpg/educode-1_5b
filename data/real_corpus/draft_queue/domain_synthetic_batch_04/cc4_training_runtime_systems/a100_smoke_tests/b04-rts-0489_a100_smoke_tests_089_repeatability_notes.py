...
def build_a100_smoke_tests_0489(rows):
    summary = {
        'topic_id': 'B04-RTS-0489',
...
def check_a100_smoke_tests_88(summary):
    flags = {
...
summary = build_a100_smoke_tests_0489(sample_rows)
flags = check_a100_smoke_tests_88(summary)
print(summary)
print(flags)
