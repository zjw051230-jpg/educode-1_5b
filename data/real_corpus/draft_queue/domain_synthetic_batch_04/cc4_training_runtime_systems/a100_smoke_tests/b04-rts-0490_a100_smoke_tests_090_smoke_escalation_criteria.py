...
def build_a100_smoke_tests_0490(rows):
    summary = {
        'topic_id': 'B04-RTS-0490',
        'focus': 'smoke escalation criteria',
        'row_count': len(rows),
...
def check_a100_smoke_tests_89(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'smoke escalation criteria',
    }
...
summary = build_a100_smoke_tests_0490(sample_rows)
flags = check_a100_smoke_tests_89(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates smoke escalation criteria.
