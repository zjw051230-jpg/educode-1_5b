...
def build_a100_smoke_tests_0491(rows):
    summary = {
        'topic_id': 'B04-RTS-0491',
...
def check_a100_smoke_tests_90(summary):
    flags = {
...
summary = build_a100_smoke_tests_0491(sample_rows)
flags = check_a100_smoke_tests_90(summary)
print(summary)
print(flags)
