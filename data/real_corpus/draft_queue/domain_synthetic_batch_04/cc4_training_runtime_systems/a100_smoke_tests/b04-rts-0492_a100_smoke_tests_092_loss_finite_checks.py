...
def build_a100_smoke_tests_0492(rows):
    summary = {
        'topic_id': 'B04-RTS-0492',
...
def check_a100_smoke_tests_91(summary):
    flags = {
...
sample_rows = [2.76, 3.01, 3.26, 3.51, 3.76]
summary = build_a100_smoke_tests_0492(sample_rows)
flags = check_a100_smoke_tests_91(summary)
print(summary)
print(flags)
