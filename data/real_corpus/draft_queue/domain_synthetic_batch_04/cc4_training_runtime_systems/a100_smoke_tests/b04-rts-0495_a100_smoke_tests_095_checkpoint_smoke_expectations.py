...
def build_a100_smoke_tests_0495(rows):
    summary = {
        'topic_id': 'B04-RTS-0495',
...
def check_a100_smoke_tests_94(summary):
    flags = {
...
summary = build_a100_smoke_tests_0495(sample_rows)
flags = check_a100_smoke_tests_94(summary)
print(summary)
print(flags)
