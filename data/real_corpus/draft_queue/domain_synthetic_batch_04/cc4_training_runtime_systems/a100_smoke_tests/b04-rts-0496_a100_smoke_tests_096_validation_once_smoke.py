...
def build_a100_smoke_tests_0496(rows):
    summary = {
        'topic_id': 'B04-RTS-0496',
...
def check_a100_smoke_tests_95(summary):
    flags = {
...
summary = build_a100_smoke_tests_0496(sample_rows)
flags = check_a100_smoke_tests_95(summary)
print(summary)
print(flags)
