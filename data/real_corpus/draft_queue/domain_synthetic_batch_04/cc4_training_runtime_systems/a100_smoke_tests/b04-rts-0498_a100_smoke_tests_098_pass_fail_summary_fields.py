...
def build_a100_smoke_tests_0498(rows):
    summary = {
        'topic_id': 'B04-RTS-0498',
        'focus': 'pass-fail summary fields',
        'row_count': len(rows),
...
def check_a100_smoke_tests_97(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'pass-fail summary fields',
    }
...
summary = build_a100_smoke_tests_0498(sample_rows)
flags = check_a100_smoke_tests_97(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates pass-fail summary fields.
