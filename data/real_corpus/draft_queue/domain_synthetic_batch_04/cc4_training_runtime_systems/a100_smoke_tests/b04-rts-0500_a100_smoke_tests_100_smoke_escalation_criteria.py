...
def build_a100_smoke_tests_0500(rows):
    summary = {
        'topic_id': 'B04-RTS-0500',
...
def check_a100_smoke_tests_99(summary):
    flags = {
...
summary = build_a100_smoke_tests_0500(sample_rows)
flags = check_a100_smoke_tests_99(summary)
print(summary)
print(flags)
