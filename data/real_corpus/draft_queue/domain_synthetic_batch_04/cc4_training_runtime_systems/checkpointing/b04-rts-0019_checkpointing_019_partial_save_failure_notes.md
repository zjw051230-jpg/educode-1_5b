...
# Partial Save Failure Notes Summary Design

## Concept
Partial save failure notes is the main teaching target for this draft candidate.
...
## Explanation
Example index 19 uses a narrow lens: partial save failure notes.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0019.
The reviewer opens a checkpointing artifact and asks whether the primary signal for partial save failure notes is present.
...
## Review Notes
This file exists to teach one distinct review target: partial save failure notes.
