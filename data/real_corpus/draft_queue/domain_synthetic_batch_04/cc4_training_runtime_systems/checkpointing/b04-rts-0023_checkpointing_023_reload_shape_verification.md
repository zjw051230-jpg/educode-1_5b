...
# Reload Shape Verification Comparison Notes

## Concept
Reload shape verification is the main teaching target for this draft candidate.
...
## Explanation
Example index 23 uses a narrow lens: reload shape verification.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0023.
The reviewer opens a checkpointing artifact and asks whether the primary signal for reload shape verification is present.
...
## Review Notes
This file exists to teach one distinct review target: reload shape verification.
