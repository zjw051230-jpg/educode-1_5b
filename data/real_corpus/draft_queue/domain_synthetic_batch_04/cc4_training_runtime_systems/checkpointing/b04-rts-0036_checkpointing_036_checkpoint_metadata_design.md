...
# Checkpoint Metadata Design Minimal Review Flow

## Concept
Checkpoint metadata design is the main teaching target for this draft candidate.
...
## Explanation
Example index 36 uses a narrow lens: checkpoint metadata design.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0036.
The reviewer opens a checkpointing artifact and asks whether the primary signal for checkpoint metadata design is present.
...
## Review Notes
This file exists to teach one distinct review target: checkpoint metadata design.
