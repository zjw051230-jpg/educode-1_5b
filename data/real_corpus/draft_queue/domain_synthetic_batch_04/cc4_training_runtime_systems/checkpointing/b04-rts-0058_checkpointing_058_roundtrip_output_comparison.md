...
# Roundtrip Output Comparison Pass Criteria

## Concept
Roundtrip output comparison is the main teaching target for this draft candidate.
...
## Explanation
Example index 58 uses a narrow lens: roundtrip output comparison.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0058.
The reviewer opens a checkpointing artifact and asks whether the primary signal for roundtrip output comparison is present.
...
## Review Notes
This file exists to teach one distinct review target: roundtrip output comparison.
