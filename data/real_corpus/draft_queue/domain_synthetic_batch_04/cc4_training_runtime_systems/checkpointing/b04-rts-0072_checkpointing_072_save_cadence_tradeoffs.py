...
def build_checkpointing_0072(rows):
    summary = {
        'topic_id': 'B04-RTS-0072',
...
def check_checkpointing_71(summary):
    flags = {
...
sample_rows = [1.36, 1.61, 1.86, 2.11, 2.36]
summary = build_checkpointing_0072(sample_rows)
flags = check_checkpointing_71(summary)
print(summary)
print(flags)
