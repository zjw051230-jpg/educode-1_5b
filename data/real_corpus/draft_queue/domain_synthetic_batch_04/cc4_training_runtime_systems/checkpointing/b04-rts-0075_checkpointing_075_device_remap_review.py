...
def build_checkpointing_0075(rows):
    summary = {
        'topic_id': 'B04-RTS-0075',
...
def check_checkpointing_74(summary):
    flags = {
...
sample_rows = [1.69, 1.94, 2.19, 2.44, 2.69]
summary = build_checkpointing_0075(sample_rows)
flags = check_checkpointing_74(summary)
print(summary)
print(flags)
