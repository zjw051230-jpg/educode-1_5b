...
def build_checkpointing_0076(rows):
    summary = {
        'topic_id': 'B04-RTS-0076',
...
def check_checkpointing_75(summary):
    flags = {
...
sample_rows = [1.8, 2.05, 2.3, 2.55, 2.8]
summary = build_checkpointing_0076(sample_rows)
flags = check_checkpointing_75(summary)
print(summary)
print(flags)
