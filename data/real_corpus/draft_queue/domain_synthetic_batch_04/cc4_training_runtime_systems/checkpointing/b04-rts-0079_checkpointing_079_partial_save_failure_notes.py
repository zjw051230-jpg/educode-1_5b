...
def build_checkpointing_0079(rows):
    summary = {
        'topic_id': 'B04-RTS-0079',
...
def check_checkpointing_78(summary):
    flags = {
...
sample_rows = [2.13, 2.38, 2.63, 2.88, 3.13]
summary = build_checkpointing_0079(sample_rows)
flags = check_checkpointing_78(summary)
print(summary)
print(flags)
