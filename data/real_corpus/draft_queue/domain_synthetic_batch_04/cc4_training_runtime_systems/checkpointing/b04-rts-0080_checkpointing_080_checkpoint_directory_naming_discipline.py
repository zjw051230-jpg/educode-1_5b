...
def build_checkpointing_0080(rows):
    summary = {
        'topic_id': 'B04-RTS-0080',
...
def check_checkpointing_79(summary):
    flags = {
...
sample_rows = [2.24, 2.49, 2.74, 2.99, 3.24]
summary = build_checkpointing_0080(sample_rows)
flags = check_checkpointing_79(summary)
print(summary)
print(flags)
