...
def build_checkpointing_0081(rows):
    summary = {
        'topic_id': 'B04-RTS-0081',
...
def check_checkpointing_80(summary):
    flags = {
...
sample_rows = [2.35, 2.6, 2.85, 3.1, 3.35]
summary = build_checkpointing_0081(sample_rows)
flags = check_checkpointing_80(summary)
print(summary)
print(flags)
