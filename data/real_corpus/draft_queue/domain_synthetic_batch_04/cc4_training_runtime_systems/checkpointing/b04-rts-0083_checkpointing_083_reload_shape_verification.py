...
def build_checkpointing_0083(rows):
    summary = {
        'topic_id': 'B04-RTS-0083',
...
def check_checkpointing_82(summary):
    flags = {
...
sample_rows = [2.57, 2.82, 3.07, 3.32, 3.57]
summary = build_checkpointing_0083(sample_rows)
flags = check_checkpointing_82(summary)
print(summary)
print(flags)
