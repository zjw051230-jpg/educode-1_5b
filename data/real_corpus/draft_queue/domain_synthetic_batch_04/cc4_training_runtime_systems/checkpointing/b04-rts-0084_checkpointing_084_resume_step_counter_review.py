...
def build_checkpointing_0084(rows):
    summary = {
        'topic_id': 'B04-RTS-0084',
...
def check_checkpointing_83(summary):
    flags = {
...
sample_rows = [2.68, 2.93, 3.18, 3.43, 3.68]
summary = build_checkpointing_0084(sample_rows)
flags = check_checkpointing_83(summary)
print(summary)
print(flags)
