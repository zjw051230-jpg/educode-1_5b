...
def build_checkpointing_0086(rows):
    summary = {
        'topic_id': 'B04-RTS-0086',
...
def check_checkpointing_85(summary):
    flags = {
...
summary = build_checkpointing_0086(sample_rows)
flags = check_checkpointing_85(summary)
print(summary)
print(flags)
