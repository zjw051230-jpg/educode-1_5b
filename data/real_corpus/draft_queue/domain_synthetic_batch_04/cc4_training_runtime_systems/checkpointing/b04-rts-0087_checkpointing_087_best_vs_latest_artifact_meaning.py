...
def build_checkpointing_0087(rows):
    summary = {
        'topic_id': 'B04-RTS-0087',
...
def check_checkpointing_86(summary):
    flags = {
...
sample_rows = [1.31, 1.56, 1.81, 2.06, 2.31]
summary = build_checkpointing_0087(sample_rows)
flags = check_checkpointing_86(summary)
print(summary)
print(flags)
