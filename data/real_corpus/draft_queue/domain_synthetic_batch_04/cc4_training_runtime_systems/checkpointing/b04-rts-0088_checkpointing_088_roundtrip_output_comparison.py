...
def build_checkpointing_0088(rows):
    summary = {
        'topic_id': 'B04-RTS-0088',
...
def check_checkpointing_87(summary):
    flags = {
...
sample_rows = [1.42, 1.67, 1.92, 2.17, 2.42]
summary = build_checkpointing_0088(sample_rows)
flags = check_checkpointing_87(summary)
print(summary)
print(flags)
