...
def build_checkpointing_0091(rows):
    summary = {
        'topic_id': 'B04-RTS-0091',
...
def check_checkpointing_90(summary):
    flags = {
...
sample_rows = [1.75, 2.0, 2.25, 2.5, 2.75]
summary = build_checkpointing_0091(sample_rows)
flags = check_checkpointing_90(summary)
print(summary)
print(flags)
