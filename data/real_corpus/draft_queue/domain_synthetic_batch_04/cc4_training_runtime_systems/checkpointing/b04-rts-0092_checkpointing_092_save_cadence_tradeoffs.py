...
def build_checkpointing_0092(rows):
    summary = {
        'topic_id': 'B04-RTS-0092',
...
def check_checkpointing_91(summary):
    flags = {
...
summary = build_checkpointing_0092(sample_rows)
flags = check_checkpointing_91(summary)
print(summary)
print(flags)
