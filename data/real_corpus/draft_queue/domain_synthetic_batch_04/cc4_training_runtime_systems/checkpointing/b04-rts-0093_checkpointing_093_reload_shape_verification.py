...
def build_checkpointing_0093(rows):
    summary = {
        'topic_id': 'B04-RTS-0093',
...
def check_checkpointing_92(summary):
    flags = {
...
summary = build_checkpointing_0093(sample_rows)
flags = check_checkpointing_92(summary)
print(summary)
print(flags)
