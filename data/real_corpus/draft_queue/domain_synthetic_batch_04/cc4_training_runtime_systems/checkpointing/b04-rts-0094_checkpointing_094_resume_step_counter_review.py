...
def build_checkpointing_0094(rows):
    summary = {
        'topic_id': 'B04-RTS-0094',
...
def check_checkpointing_93(summary):
    flags = {
...
summary = build_checkpointing_0094(sample_rows)
flags = check_checkpointing_93(summary)
print(summary)
print(flags)
