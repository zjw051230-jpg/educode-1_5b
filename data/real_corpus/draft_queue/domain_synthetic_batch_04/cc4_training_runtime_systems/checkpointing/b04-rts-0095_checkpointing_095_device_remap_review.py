...
def build_checkpointing_0095(rows):
    summary = {
        'topic_id': 'B04-RTS-0095',
...
def check_checkpointing_94(summary):
    flags = {
...
summary = build_checkpointing_0095(sample_rows)
flags = check_checkpointing_94(summary)
print(summary)
print(flags)
