...
def build_checkpointing_0097(rows):
    summary = {
        'topic_id': 'B04-RTS-0097',
...
def check_checkpointing_96(summary):
    flags = {
...
sample_rows = [2.41, 2.66, 2.91, 3.16, 3.41]
summary = build_checkpointing_0097(sample_rows)
flags = check_checkpointing_96(summary)
print(summary)
print(flags)
