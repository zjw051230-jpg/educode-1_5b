...
def build_checkpointing_0098(rows):
    summary = {
        'topic_id': 'B04-RTS-0098',
...
def check_checkpointing_97(summary):
    flags = {
...
sample_rows = [2.52, 2.77, 3.02, 3.27, 3.52]
summary = build_checkpointing_0098(sample_rows)
flags = check_checkpointing_97(summary)
print(summary)
print(flags)
