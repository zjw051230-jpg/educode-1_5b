...
def build_checkpointing_0099(rows):
    summary = {
        'topic_id': 'B04-RTS-0099',
...
def check_checkpointing_98(summary):
    flags = {
...
summary = build_checkpointing_0099(sample_rows)
flags = check_checkpointing_98(summary)
print(summary)
print(flags)
