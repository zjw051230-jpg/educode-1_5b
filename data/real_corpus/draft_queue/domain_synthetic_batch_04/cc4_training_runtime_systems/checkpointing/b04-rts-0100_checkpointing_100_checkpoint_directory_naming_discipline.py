...
def build_checkpointing_0100(rows):
    summary = {
        'topic_id': 'B04-RTS-0100',
...
def check_checkpointing_99(summary):
    flags = {
...
sample_rows = [2.74, 2.99, 3.24, 3.49, 3.74]
summary = build_checkpointing_0100(sample_rows)
flags = check_checkpointing_99(summary)
print(summary)
print(flags)
