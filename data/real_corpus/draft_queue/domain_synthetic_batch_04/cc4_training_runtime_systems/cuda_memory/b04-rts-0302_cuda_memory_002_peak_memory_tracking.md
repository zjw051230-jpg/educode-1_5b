...
# Peak Memory Tracking Failure Patterns

## Concept
Peak memory tracking is the main teaching target for this draft candidate.
...
## Explanation
Example index 302 uses a narrow lens: peak memory tracking.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0302.
The reviewer opens a cuda_memory artifact and asks whether the primary signal for peak memory tracking is present.
...
## Review Notes
This file exists to teach one distinct review target: peak memory tracking.
