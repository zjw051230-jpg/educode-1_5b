...
# Host-Device Transfer Caveats Pass Criteria

## Concept
Host-device transfer caveats is the main teaching target for this draft candidate.
...
## Explanation
Example index 348 uses a narrow lens: host-device transfer caveats.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0348.
The reviewer opens a cuda_memory artifact and asks whether the primary signal for host-device transfer caveats is present.
...
## Review Notes
This file exists to teach one distinct review target: host-device transfer caveats.
