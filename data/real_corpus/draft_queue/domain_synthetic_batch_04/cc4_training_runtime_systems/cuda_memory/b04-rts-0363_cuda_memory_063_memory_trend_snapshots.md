...
# Memory Trend Snapshots Comparison Notes

## Concept
Memory trend snapshots is the main teaching target for this draft candidate.
...
## Explanation
Example index 363 uses a narrow lens: memory trend snapshots.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0363.
The reviewer opens a cuda_memory artifact and asks whether the primary signal for memory trend snapshots is present.
...
## Review Notes
This file exists to teach one distinct review target: memory trend snapshots.
