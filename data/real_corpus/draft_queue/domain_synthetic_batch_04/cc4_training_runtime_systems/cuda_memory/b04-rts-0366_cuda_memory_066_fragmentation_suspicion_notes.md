...
# Fragmentation Suspicion Notes Minimal Review Flow

## Concept
Fragmentation suspicion notes is the main teaching target for this draft candidate.
...
## Explanation
Example index 366 uses a narrow lens: fragmentation suspicion notes.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0366.
The reviewer opens a cuda_memory artifact and asks whether the primary signal for fragmentation suspicion notes is present.
...
## Review Notes
This file exists to teach one distinct review target: fragmentation suspicion notes.
