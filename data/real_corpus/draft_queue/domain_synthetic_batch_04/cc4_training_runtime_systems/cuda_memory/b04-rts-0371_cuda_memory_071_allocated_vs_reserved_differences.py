...
def build_cuda_memory_0371(rows):
    summary = {
        'topic_id': 'B04-RTS-0371',
...
def check_cuda_memory_70(summary):
    flags = {
...
summary = build_cuda_memory_0371(sample_rows)
flags = check_cuda_memory_70(summary)
print(summary)
print(flags)
