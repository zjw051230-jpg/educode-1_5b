...
def build_cuda_memory_0372(rows):
    summary = {
        'topic_id': 'B04-RTS-0372',
...
def check_cuda_memory_71(summary):
    flags = {
...
summary = build_cuda_memory_0372(sample_rows)
flags = check_cuda_memory_71(summary)
print(summary)
print(flags)
