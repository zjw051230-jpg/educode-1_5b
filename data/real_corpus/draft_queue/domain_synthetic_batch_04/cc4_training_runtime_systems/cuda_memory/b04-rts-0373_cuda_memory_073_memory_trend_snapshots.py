...
def build_cuda_memory_0373(rows):
    summary = {
        'topic_id': 'B04-RTS-0373',
        'focus': 'memory trend snapshots',
        'row_count': len(rows),
...
summary = build_cuda_memory_0373(sample_rows)
flags = check_cuda_memory_72(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates memory trend snapshots.
