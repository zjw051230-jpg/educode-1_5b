...
def build_cuda_memory_0375(rows):
    summary = {
        'topic_id': 'B04-RTS-0375',
...
def check_cuda_memory_74(summary):
    flags = {
...
summary = build_cuda_memory_0375(sample_rows)
flags = check_cuda_memory_74(summary)
print(summary)
print(flags)
