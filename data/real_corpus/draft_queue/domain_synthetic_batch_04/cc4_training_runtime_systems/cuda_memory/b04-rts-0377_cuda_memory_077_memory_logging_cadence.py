...
def build_cuda_memory_0377(rows):
    summary = {
        'topic_id': 'B04-RTS-0377',
        'focus': 'memory logging cadence',
        'row_count': len(rows),
...
summary = build_cuda_memory_0377(sample_rows)
flags = check_cuda_memory_76(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates memory logging cadence.
