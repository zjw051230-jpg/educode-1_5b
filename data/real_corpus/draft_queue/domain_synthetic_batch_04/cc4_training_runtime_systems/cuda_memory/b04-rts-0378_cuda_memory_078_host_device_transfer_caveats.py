...
def build_cuda_memory_0378(rows):
    summary = {
        'topic_id': 'B04-RTS-0378',
...
def check_cuda_memory_77(summary):
    flags = {
...
summary = build_cuda_memory_0378(sample_rows)
flags = check_cuda_memory_77(summary)
print(summary)
print(flags)
