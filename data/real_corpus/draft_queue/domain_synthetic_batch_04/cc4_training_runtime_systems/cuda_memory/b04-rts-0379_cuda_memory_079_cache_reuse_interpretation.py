...
def build_cuda_memory_0379(rows):
    summary = {
        'topic_id': 'B04-RTS-0379',
...
def check_cuda_memory_78(summary):
    flags = {
...
summary = build_cuda_memory_0379(sample_rows)
flags = check_cuda_memory_78(summary)
print(summary)
print(flags)
