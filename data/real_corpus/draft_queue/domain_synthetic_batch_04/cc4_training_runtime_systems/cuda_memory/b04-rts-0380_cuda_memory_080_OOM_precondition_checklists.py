...
def build_cuda_memory_0380(rows):
    summary = {
        'topic_id': 'B04-RTS-0380',
...
def check_cuda_memory_79(summary):
    flags = {
...
summary = build_cuda_memory_0380(sample_rows)
flags = check_cuda_memory_79(summary)
print(summary)
print(flags)
