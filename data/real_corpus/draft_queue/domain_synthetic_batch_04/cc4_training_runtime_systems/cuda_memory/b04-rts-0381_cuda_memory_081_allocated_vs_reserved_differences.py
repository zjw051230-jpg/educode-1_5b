...
def build_cuda_memory_0381(rows):
    summary = {
        'topic_id': 'B04-RTS-0381',
...
def check_cuda_memory_80(summary):
    flags = {
...
summary = build_cuda_memory_0381(sample_rows)
flags = check_cuda_memory_80(summary)
print(summary)
print(flags)
