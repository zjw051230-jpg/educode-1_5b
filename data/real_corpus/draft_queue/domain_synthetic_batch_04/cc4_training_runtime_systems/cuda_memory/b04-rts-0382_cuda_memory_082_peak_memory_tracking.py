...
def build_cuda_memory_0382(rows):
    summary = {
        'topic_id': 'B04-RTS-0382',
        'focus': 'peak memory tracking',
        'row_count': len(rows),
...
summary = build_cuda_memory_0382(sample_rows)
flags = check_cuda_memory_81(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates peak memory tracking.
