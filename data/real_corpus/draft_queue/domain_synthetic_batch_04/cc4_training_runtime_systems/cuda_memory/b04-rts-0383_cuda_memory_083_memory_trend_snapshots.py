...
def build_cuda_memory_0383(rows):
    summary = {
        'topic_id': 'B04-RTS-0383',
...
def check_cuda_memory_82(summary):
    flags = {
...
summary = build_cuda_memory_0383(sample_rows)
flags = check_cuda_memory_82(summary)
print(summary)
print(flags)
