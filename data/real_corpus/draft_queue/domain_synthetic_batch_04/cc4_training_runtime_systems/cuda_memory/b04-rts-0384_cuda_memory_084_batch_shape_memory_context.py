...
def build_cuda_memory_0384(rows):
    summary = {
        'topic_id': 'B04-RTS-0384',
...
def check_cuda_memory_83(summary):
    flags = {
...
summary = build_cuda_memory_0384(sample_rows)
flags = check_cuda_memory_83(summary)
print(summary)
print(flags)
