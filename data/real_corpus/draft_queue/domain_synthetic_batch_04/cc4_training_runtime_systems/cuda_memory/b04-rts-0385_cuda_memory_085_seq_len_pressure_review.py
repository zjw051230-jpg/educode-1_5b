...
def build_cuda_memory_0385(rows):
    summary = {
        'topic_id': 'B04-RTS-0385',
...
def check_cuda_memory_84(summary):
    flags = {
...
summary = build_cuda_memory_0385(sample_rows)
flags = check_cuda_memory_84(summary)
print(summary)
print(flags)
