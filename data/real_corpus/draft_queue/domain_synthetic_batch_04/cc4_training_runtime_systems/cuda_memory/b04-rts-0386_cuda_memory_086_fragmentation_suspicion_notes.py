...
def build_cuda_memory_0386(rows):
    summary = {
        'topic_id': 'B04-RTS-0386',
...
def check_cuda_memory_85(summary):
    flags = {
...
summary = build_cuda_memory_0386(sample_rows)
flags = check_cuda_memory_85(summary)
print(summary)
print(flags)
