...
def build_cuda_memory_0387(rows):
    summary = {
        'topic_id': 'B04-RTS-0387',
...
def check_cuda_memory_86(summary):
    flags = {
...
summary = build_cuda_memory_0387(sample_rows)
flags = check_cuda_memory_86(summary)
print(summary)
print(flags)
