...
def build_cuda_memory_0388(rows):
    summary = {
        'topic_id': 'B04-RTS-0388',
...
def check_cuda_memory_87(summary):
    flags = {
...
summary = build_cuda_memory_0388(sample_rows)
flags = check_cuda_memory_87(summary)
print(summary)
print(flags)
