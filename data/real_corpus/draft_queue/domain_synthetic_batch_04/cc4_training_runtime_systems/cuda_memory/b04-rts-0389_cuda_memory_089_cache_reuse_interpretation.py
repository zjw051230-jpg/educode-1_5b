...
def build_cuda_memory_0389(rows):
    summary = {
        'topic_id': 'B04-RTS-0389',
        'focus': 'cache reuse interpretation',
        'row_count': len(rows),
...
def check_cuda_memory_88(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'cache reuse interpretation',
    }
...
summary = build_cuda_memory_0389(sample_rows)
flags = check_cuda_memory_88(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates cache reuse interpretation.
