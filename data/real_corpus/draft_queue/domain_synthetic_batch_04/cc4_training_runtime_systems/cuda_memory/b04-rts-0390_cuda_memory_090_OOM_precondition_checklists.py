...
def build_cuda_memory_0390(rows):
    summary = {
        'topic_id': 'B04-RTS-0390',
        'focus': 'OOM precondition checklists',
        'row_count': len(rows),
...
def check_cuda_memory_89(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'OOM precondition checklists',
    }
...
summary = build_cuda_memory_0390(sample_rows)
flags = check_cuda_memory_89(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates OOM precondition checklists.
