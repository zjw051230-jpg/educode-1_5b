...
def build_cuda_memory_0391(rows):
    summary = {
        'topic_id': 'B04-RTS-0391',
        'focus': 'allocated vs reserved differences',
        'row_count': len(rows),
...
def check_cuda_memory_90(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'allocated vs reserved differences',
    }
...
summary = build_cuda_memory_0391(sample_rows)
flags = check_cuda_memory_90(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates allocated vs reserved differences.
