...
def build_cuda_memory_0392(rows):
    summary = {
        'topic_id': 'B04-RTS-0392',
...
def check_cuda_memory_91(summary):
    flags = {
...
summary = build_cuda_memory_0392(sample_rows)
flags = check_cuda_memory_91(summary)
print(summary)
print(flags)
