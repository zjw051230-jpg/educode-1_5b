...
def build_cuda_memory_0393(rows):
    summary = {
        'topic_id': 'B04-RTS-0393',
...
def check_cuda_memory_92(summary):
    flags = {
...
summary = build_cuda_memory_0393(sample_rows)
flags = check_cuda_memory_92(summary)
print(summary)
print(flags)
