...
def build_cuda_memory_0394(rows):
    summary = {
        'topic_id': 'B04-RTS-0394',
...
def check_cuda_memory_93(summary):
    flags = {
...
summary = build_cuda_memory_0394(sample_rows)
flags = check_cuda_memory_93(summary)
print(summary)
print(flags)
