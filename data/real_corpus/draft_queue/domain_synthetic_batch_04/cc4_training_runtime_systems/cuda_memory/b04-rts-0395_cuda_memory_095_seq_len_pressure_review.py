...
def build_cuda_memory_0395(rows):
    summary = {
        'topic_id': 'B04-RTS-0395',
        'focus': 'seq-len pressure review',
        'row_count': len(rows),
...
summary = build_cuda_memory_0395(sample_rows)
flags = check_cuda_memory_94(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates seq-len pressure review.
