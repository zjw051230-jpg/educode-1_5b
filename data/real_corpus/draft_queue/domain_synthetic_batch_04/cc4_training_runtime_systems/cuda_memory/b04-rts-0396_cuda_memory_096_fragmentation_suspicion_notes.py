...
def build_cuda_memory_0396(rows):
    summary = {
        'topic_id': 'B04-RTS-0396',
...
def check_cuda_memory_95(summary):
    flags = {
...
summary = build_cuda_memory_0396(sample_rows)
flags = check_cuda_memory_95(summary)
print(summary)
print(flags)
