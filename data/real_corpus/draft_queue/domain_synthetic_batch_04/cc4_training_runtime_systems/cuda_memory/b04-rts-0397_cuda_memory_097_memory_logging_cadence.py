...
def build_cuda_memory_0397(rows):
    summary = {
        'topic_id': 'B04-RTS-0397',
...
def check_cuda_memory_96(summary):
    flags = {
...
summary = build_cuda_memory_0397(sample_rows)
flags = check_cuda_memory_96(summary)
print(summary)
print(flags)
