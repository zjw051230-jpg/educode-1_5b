...
def build_cuda_memory_0399(rows):
    summary = {
        'topic_id': 'B04-RTS-0399',
...
def check_cuda_memory_98(summary):
    flags = {
...
summary = build_cuda_memory_0399(sample_rows)
flags = check_cuda_memory_98(summary)
print(summary)
print(flags)
