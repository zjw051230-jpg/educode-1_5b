...
def build_cuda_memory_0400(rows):
    summary = {
        'topic_id': 'B04-RTS-0400',
...
def check_cuda_memory_99(summary):
    flags = {
...
summary = build_cuda_memory_0400(sample_rows)
flags = check_cuda_memory_99(summary)
print(summary)
print(flags)
