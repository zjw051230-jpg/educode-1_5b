...
# Summary.Json Field Selection Failure Patterns

## Concept
Summary.json field selection is the main teaching target for this draft candidate.
This note sits inside the experiment_logging runtime theme and focuses on one reviewable behavior rather than a whole training system.
...
## Explanation
Example index 502 uses a narrow lens: summary.json field selection.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0502.
The reviewer opens a experiment_logging artifact and asks whether the primary signal for summary.json field selection is present.
...
## Review Notes
This file exists to teach one distinct review target: summary.json field selection.
