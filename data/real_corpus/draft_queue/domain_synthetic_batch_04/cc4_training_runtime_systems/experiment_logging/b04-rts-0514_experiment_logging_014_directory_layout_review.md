...
# Directory Layout Review Audit Cues

## Concept
Directory layout review is the main teaching target for this draft candidate.
...
## Explanation
Example index 514 uses a narrow lens: directory layout review.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0514.
The reviewer opens a experiment_logging artifact and asks whether the primary signal for directory layout review is present.
...
## Review Notes
This file exists to teach one distinct review target: directory layout review.
