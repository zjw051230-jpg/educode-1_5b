...
# Artifact Naming Consistency Pass Criteria

## Concept
Artifact naming consistency is the main teaching target for this draft candidate.
...
## Explanation
Example index 528 uses a narrow lens: artifact naming consistency.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0528.
The reviewer opens a experiment_logging artifact and asks whether the primary signal for artifact naming consistency is present.
...
## Review Notes
This file exists to teach one distinct review target: artifact naming consistency.
