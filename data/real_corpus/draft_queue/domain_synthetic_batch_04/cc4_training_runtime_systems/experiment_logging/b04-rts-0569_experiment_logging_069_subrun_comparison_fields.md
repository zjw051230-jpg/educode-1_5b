...
# Subrun Comparison Fields Summary Design

## Concept
Subrun comparison fields is the main teaching target for this draft candidate.
...
## Explanation
Example index 569 uses a narrow lens: subrun comparison fields.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0569.
The reviewer opens a experiment_logging artifact and asks whether the primary signal for subrun comparison fields is present.
...
## Review Notes
This file exists to teach one distinct review target: subrun comparison fields.
