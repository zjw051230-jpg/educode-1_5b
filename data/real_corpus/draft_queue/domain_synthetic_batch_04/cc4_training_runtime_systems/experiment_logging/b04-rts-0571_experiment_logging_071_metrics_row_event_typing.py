...
def build_experiment_logging_0571(rows):
    summary = {
        'topic_id': 'B04-RTS-0571',
...
def check_experiment_logging_70(summary):
    flags = {
...
summary = build_experiment_logging_0571(sample_rows)
flags = check_experiment_logging_70(summary)
print(summary)
print(flags)
