...
def build_experiment_logging_0572(rows):
    summary = {
        'topic_id': 'B04-RTS-0572',
...
def check_experiment_logging_71(summary):
    flags = {
...
summary = build_experiment_logging_0572(sample_rows)
flags = check_experiment_logging_71(summary)
print(summary)
print(flags)
