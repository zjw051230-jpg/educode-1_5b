...
def build_experiment_logging_0573(rows):
    summary = {
        'topic_id': 'B04-RTS-0573',
        'focus': 'run_id structure',
        'row_count': len(rows),
...
summary = build_experiment_logging_0573(sample_rows)
flags = check_experiment_logging_72(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates run_id structure.
