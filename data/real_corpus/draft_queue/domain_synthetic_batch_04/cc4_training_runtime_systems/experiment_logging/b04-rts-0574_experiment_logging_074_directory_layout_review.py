...
def build_experiment_logging_0574(rows):
    summary = {
        'topic_id': 'B04-RTS-0574',
...
def check_experiment_logging_73(summary):
    flags = {
...
sample_rows = [2.28, 2.53, 2.78, 3.03, 3.28]
summary = build_experiment_logging_0574(sample_rows)
flags = check_experiment_logging_73(summary)
print(summary)
print(flags)
