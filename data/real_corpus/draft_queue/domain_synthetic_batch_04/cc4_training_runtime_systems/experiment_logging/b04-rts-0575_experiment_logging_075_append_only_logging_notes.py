...
def build_experiment_logging_0575(rows):
    summary = {
        'topic_id': 'B04-RTS-0575',
...
def check_experiment_logging_74(summary):
    flags = {
...
sample_rows = [2.39, 2.64, 2.89, 3.14, 3.39]
summary = build_experiment_logging_0575(sample_rows)
flags = check_experiment_logging_74(summary)
print(summary)
print(flags)
