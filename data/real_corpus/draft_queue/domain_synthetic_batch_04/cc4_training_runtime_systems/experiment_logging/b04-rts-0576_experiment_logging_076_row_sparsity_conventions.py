...
def build_experiment_logging_0576(rows):
    summary = {
        'topic_id': 'B04-RTS-0576',
        'focus': 'row sparsity conventions',
        'row_count': len(rows),
...
def check_experiment_logging_75(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'row sparsity conventions',
    }
...
summary = build_experiment_logging_0576(sample_rows)
flags = check_experiment_logging_75(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates row sparsity conventions.
