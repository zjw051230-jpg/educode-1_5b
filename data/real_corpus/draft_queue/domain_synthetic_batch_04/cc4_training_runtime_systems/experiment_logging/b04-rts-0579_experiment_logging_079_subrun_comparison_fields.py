...
def build_experiment_logging_0579(rows):
    summary = {
        'topic_id': 'B04-RTS-0579',
...
def check_experiment_logging_78(summary):
    flags = {
...
summary = build_experiment_logging_0579(sample_rows)
flags = check_experiment_logging_78(summary)
print(summary)
print(flags)
