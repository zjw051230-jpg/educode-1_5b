...
def build_experiment_logging_0580(rows):
    summary = {
        'topic_id': 'B04-RTS-0580',
        'focus': 'log review checklist',
        'row_count': len(rows),
...
def check_experiment_logging_79(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'log review checklist',
    }
...
summary = build_experiment_logging_0580(sample_rows)
flags = check_experiment_logging_79(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates log review checklist.
