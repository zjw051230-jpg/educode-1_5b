...
def build_experiment_logging_0581(rows):
    summary = {
        'topic_id': 'B04-RTS-0581',
...
def check_experiment_logging_80(summary):
    flags = {
...
summary = build_experiment_logging_0581(sample_rows)
flags = check_experiment_logging_80(summary)
print(summary)
print(flags)
