...
def build_experiment_logging_0582(rows):
    summary = {
        'topic_id': 'B04-RTS-0582',
...
def check_experiment_logging_81(summary):
    flags = {
...
summary = build_experiment_logging_0582(sample_rows)
flags = check_experiment_logging_81(summary)
print(summary)
print(flags)
