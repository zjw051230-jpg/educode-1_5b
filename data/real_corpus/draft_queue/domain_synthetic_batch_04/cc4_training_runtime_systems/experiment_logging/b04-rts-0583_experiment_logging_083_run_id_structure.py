...
def build_experiment_logging_0583(rows):
    summary = {
        'topic_id': 'B04-RTS-0583',
...
def check_experiment_logging_82(summary):
    flags = {
...
summary = build_experiment_logging_0583(sample_rows)
flags = check_experiment_logging_82(summary)
print(summary)
print(flags)
