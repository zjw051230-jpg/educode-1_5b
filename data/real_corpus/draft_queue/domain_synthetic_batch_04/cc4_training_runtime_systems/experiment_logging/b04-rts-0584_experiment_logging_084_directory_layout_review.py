...
def build_experiment_logging_0584(rows):
    summary = {
        'topic_id': 'B04-RTS-0584',
        'focus': 'directory layout review',
        'row_count': len(rows),
...
def check_experiment_logging_83(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'directory layout review',
    }
...
summary = build_experiment_logging_0584(sample_rows)
flags = check_experiment_logging_83(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates directory layout review.
