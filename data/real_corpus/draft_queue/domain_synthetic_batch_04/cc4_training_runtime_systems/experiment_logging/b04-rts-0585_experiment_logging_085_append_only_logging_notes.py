...
def build_experiment_logging_0585(rows):
    summary = {
        'topic_id': 'B04-RTS-0585',
...
def check_experiment_logging_84(summary):
    flags = {
...
summary = build_experiment_logging_0585(sample_rows)
flags = check_experiment_logging_84(summary)
print(summary)
print(flags)
