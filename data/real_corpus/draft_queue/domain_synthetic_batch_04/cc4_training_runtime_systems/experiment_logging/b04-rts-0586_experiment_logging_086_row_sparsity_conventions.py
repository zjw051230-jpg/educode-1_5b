...
def build_experiment_logging_0586(rows):
    summary = {
        'topic_id': 'B04-RTS-0586',
...
def check_experiment_logging_85(summary):
    flags = {
...
summary = build_experiment_logging_0586(sample_rows)
flags = check_experiment_logging_85(summary)
print(summary)
print(flags)
