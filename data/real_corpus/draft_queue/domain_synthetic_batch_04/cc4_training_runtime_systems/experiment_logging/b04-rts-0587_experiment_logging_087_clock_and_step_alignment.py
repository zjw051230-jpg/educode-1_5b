...
def build_experiment_logging_0587(rows):
    summary = {
        'topic_id': 'B04-RTS-0587',
...
def check_experiment_logging_86(summary):
    flags = {
...
summary = build_experiment_logging_0587(sample_rows)
flags = check_experiment_logging_86(summary)
print(summary)
print(flags)
