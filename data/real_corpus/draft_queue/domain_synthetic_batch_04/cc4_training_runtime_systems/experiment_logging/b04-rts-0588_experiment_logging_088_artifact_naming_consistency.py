...
def build_experiment_logging_0588(rows):
    summary = {
        'topic_id': 'B04-RTS-0588',
...
def check_experiment_logging_87(summary):
    flags = {
...
summary = build_experiment_logging_0588(sample_rows)
flags = check_experiment_logging_87(summary)
print(summary)
print(flags)
