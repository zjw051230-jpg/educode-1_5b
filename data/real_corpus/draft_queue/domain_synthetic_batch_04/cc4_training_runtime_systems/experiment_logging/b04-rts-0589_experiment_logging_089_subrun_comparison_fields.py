...
def build_experiment_logging_0589(rows):
    summary = {
        'topic_id': 'B04-RTS-0589',
        'focus': 'subrun comparison fields',
        'row_count': len(rows),
...
def check_experiment_logging_88(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'subrun comparison fields',
    }
...
summary = build_experiment_logging_0589(sample_rows)
flags = check_experiment_logging_88(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates subrun comparison fields.
