...
def build_experiment_logging_0590(rows):
    summary = {
        'topic_id': 'B04-RTS-0590',
...
def check_experiment_logging_89(summary):
    flags = {
...
summary = build_experiment_logging_0590(sample_rows)
flags = check_experiment_logging_89(summary)
print(summary)
print(flags)
