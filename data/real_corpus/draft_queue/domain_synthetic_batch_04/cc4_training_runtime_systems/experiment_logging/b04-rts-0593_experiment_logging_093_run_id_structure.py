...
def build_experiment_logging_0593(rows):
    summary = {
        'topic_id': 'B04-RTS-0593',
...
def check_experiment_logging_92(summary):
    flags = {
...
summary = build_experiment_logging_0593(sample_rows)
flags = check_experiment_logging_92(summary)
print(summary)
print(flags)
