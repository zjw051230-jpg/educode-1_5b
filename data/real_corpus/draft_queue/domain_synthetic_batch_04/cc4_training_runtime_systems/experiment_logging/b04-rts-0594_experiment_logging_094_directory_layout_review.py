...
def build_experiment_logging_0594(rows):
    summary = {
        'topic_id': 'B04-RTS-0594',
...
def check_experiment_logging_93(summary):
    flags = {
...
sample_rows = [2.78, 3.03, 3.28, 3.53, 3.78]
summary = build_experiment_logging_0594(sample_rows)
flags = check_experiment_logging_93(summary)
print(summary)
print(flags)
