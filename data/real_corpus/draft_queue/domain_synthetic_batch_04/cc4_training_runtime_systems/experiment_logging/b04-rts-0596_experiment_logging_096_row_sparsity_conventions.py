...
def build_experiment_logging_0596(rows):
    summary = {
        'topic_id': 'B04-RTS-0596',
...
def check_experiment_logging_95(summary):
    flags = {
...
sample_rows = [1.3, 1.55, 1.8, 2.05, 2.3]
summary = build_experiment_logging_0596(sample_rows)
flags = check_experiment_logging_95(summary)
print(summary)
print(flags)
