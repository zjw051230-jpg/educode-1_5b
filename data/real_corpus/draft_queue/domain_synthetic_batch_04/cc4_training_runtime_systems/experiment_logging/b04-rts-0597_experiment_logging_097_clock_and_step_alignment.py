...
def build_experiment_logging_0597(rows):
    summary = {
        'topic_id': 'B04-RTS-0597',
...
def check_experiment_logging_96(summary):
    flags = {
...
summary = build_experiment_logging_0597(sample_rows)
flags = check_experiment_logging_96(summary)
print(summary)
print(flags)
