...
def build_experiment_logging_0598(rows):
    summary = {
        'topic_id': 'B04-RTS-0598',
...
def check_experiment_logging_97(summary):
    flags = {
...
summary = build_experiment_logging_0598(sample_rows)
flags = check_experiment_logging_97(summary)
print(summary)
print(flags)
