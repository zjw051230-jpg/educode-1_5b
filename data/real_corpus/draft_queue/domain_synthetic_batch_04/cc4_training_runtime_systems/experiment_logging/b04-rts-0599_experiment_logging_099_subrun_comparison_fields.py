...
def build_experiment_logging_0599(rows):
    summary = {
        'topic_id': 'B04-RTS-0599',
...
def check_experiment_logging_98(summary):
    flags = {
...
summary = build_experiment_logging_0599(sample_rows)
flags = check_experiment_logging_98(summary)
print(summary)
print(flags)
