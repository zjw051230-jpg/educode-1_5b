...
def build_experiment_logging_0600(rows):
    summary = {
        'topic_id': 'B04-RTS-0600',
...
def check_experiment_logging_99(summary):
    flags = {
...
summary = build_experiment_logging_0600(sample_rows)
flags = check_experiment_logging_99(summary)
print(summary)
print(flags)
