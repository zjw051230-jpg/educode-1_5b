...
# Global Norm Interpretation Review Notes

## Concept
Global norm interpretation is the main teaching target for this draft candidate.
...
## Explanation
Example index 221 uses a narrow lens: global norm interpretation.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0221.
The reviewer opens a gradient_clipping artifact and asks whether the primary signal for global norm interpretation is present.
...
## Review Notes
This file exists to teach one distinct review target: global norm interpretation.
