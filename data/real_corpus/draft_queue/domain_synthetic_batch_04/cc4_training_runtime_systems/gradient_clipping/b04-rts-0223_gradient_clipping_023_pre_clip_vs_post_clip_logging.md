...
# Pre-Clip Vs Post-Clip Logging Comparison Notes

## Concept
Pre-clip vs post-clip logging is the main teaching target for this draft candidate.
...
## Explanation
Example index 223 uses a narrow lens: pre-clip vs post-clip logging.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0223.
The reviewer opens a gradient_clipping artifact and asks whether the primary signal for pre-clip vs post-clip logging is present.
...
## Review Notes
This file exists to teach one distinct review target: pre-clip vs post-clip logging.
