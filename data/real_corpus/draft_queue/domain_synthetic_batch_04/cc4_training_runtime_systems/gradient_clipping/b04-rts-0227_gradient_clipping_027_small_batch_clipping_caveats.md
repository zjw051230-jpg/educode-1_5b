...
# Small-Batch Clipping Caveats Status Flags

## Concept
Small-batch clipping caveats is the main teaching target for this draft candidate.
...
## Explanation
Example index 227 uses a narrow lens: small-batch clipping caveats.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0227.
The reviewer opens a gradient_clipping artifact and asks whether the primary signal for small-batch clipping caveats is present.
...
## Review Notes
This file exists to teach one distinct review target: small-batch clipping caveats.
