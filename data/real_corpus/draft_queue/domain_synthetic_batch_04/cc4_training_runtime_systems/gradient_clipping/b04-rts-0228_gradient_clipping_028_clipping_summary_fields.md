...
# Clipping Summary Fields Pass Criteria

## Concept
Clipping summary fields is the main teaching target for this draft candidate.
...
## Explanation
Example index 228 uses a narrow lens: clipping summary fields.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0228.
The reviewer opens a gradient_clipping artifact and asks whether the primary signal for clipping summary fields is present.
...
## Review Notes
This file exists to teach one distinct review target: clipping summary fields.
