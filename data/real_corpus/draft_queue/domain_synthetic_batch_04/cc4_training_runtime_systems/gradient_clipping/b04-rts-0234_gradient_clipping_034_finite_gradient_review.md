...
# Finite Gradient Review Audit Cues

## Concept
Finite gradient review is the main teaching target for this draft candidate.
...
## Explanation
Example index 234 uses a narrow lens: finite gradient review.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0234.
The reviewer opens a gradient_clipping artifact and asks whether the primary signal for finite gradient review is present.
...
## Review Notes
This file exists to teach one distinct review target: finite gradient review.
