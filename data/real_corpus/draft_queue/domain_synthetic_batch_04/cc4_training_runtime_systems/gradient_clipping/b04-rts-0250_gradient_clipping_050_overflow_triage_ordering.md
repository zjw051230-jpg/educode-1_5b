...
# Overflow Triage Ordering Naming Notes

## Concept
Overflow triage ordering is the main teaching target for this draft candidate.
...
## Explanation
Example index 250 uses a narrow lens: overflow triage ordering.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0250.
The reviewer opens a gradient_clipping artifact and asks whether the primary signal for overflow triage ordering is present.
...
## Review Notes
This file exists to teach one distinct review target: overflow triage ordering.
