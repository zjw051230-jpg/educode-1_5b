...
def build_gradient_clipping_0281(rows):
    summary = {
        'topic_id': 'B04-RTS-0281',
...
def check_gradient_clipping_80(summary):
    flags = {
...
sample_rows = [1.95, 2.2, 2.45, 2.7, 2.95]
summary = build_gradient_clipping_0281(sample_rows)
flags = check_gradient_clipping_80(summary)
print(summary)
print(flags)
