...
def build_gradient_clipping_0288(rows):
    summary = {
        'topic_id': 'B04-RTS-0288',
...
def check_gradient_clipping_87(summary):
    flags = {
...
sample_rows = [2.72, 2.97, 3.22, 3.47, 3.72]
summary = build_gradient_clipping_0288(sample_rows)
flags = check_gradient_clipping_87(summary)
print(summary)
print(flags)
