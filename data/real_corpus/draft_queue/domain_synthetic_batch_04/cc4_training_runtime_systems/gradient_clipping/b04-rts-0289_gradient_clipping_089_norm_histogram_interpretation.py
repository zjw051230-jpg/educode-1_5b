...
def build_gradient_clipping_0289(rows):
    summary = {
        'topic_id': 'B04-RTS-0289',
...
def check_gradient_clipping_88(summary):
    flags = {
...
sample_rows = [1.13, 1.38, 1.63, 1.88, 2.13]
summary = build_gradient_clipping_0289(sample_rows)
flags = check_gradient_clipping_88(summary)
print(summary)
print(flags)
