...
def build_gradient_clipping_0291(rows):
    summary = {
        'topic_id': 'B04-RTS-0291',
...
def check_gradient_clipping_90(summary):
    flags = {
...
summary = build_gradient_clipping_0291(sample_rows)
flags = check_gradient_clipping_90(summary)
print(summary)
print(flags)
