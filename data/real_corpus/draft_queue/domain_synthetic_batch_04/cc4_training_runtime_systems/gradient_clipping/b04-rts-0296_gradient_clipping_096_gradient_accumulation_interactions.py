...
def build_gradient_clipping_0296(rows):
    summary = {
        'topic_id': 'B04-RTS-0296',
...
def check_gradient_clipping_95(summary):
    flags = {
...
sample_rows = [1.9, 2.15, 2.4, 2.65, 2.9]
summary = build_gradient_clipping_0296(sample_rows)
flags = check_gradient_clipping_95(summary)
print(summary)
print(flags)
