...
def build_gradient_clipping_0298(rows):
    summary = {
        'topic_id': 'B04-RTS-0298',
        'focus': 'clipping summary fields',
        'row_count': len(rows),
...
def check_gradient_clipping_97(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'clipping summary fields',
    }
...
summary = build_gradient_clipping_0298(sample_rows)
flags = check_gradient_clipping_97(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates clipping summary fields.
