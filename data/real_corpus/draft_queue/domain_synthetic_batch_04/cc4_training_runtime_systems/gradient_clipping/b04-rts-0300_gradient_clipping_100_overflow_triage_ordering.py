...
def build_gradient_clipping_0300(rows):
    summary = {
        'topic_id': 'B04-RTS-0300',
...
def check_gradient_clipping_99(summary):
    flags = {
...
summary = build_gradient_clipping_0300(sample_rows)
flags = check_gradient_clipping_99(summary)
print(summary)
print(flags)
