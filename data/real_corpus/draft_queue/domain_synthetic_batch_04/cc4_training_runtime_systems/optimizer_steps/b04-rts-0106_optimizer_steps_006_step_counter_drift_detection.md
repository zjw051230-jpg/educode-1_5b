...
# Step Counter Drift Detection Minimal Review Flow

## Concept
Step counter drift detection is the main teaching target for this draft candidate.
...
## Explanation
Example index 106 uses a narrow lens: step counter drift detection.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0106.
The reviewer opens a optimizer_steps artifact and asks whether the primary signal for step counter drift detection is present.
...
## Review Notes
This file exists to teach one distinct review target: step counter drift detection.
