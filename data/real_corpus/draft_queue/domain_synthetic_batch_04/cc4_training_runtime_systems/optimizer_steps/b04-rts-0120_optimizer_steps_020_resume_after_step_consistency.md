...
# Resume-After-Step Consistency Naming Notes

## Concept
Resume-after-step consistency is the main teaching target for this draft candidate.
...
## Explanation
Example index 120 uses a narrow lens: resume-after-step consistency.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0120.
The reviewer opens a optimizer_steps artifact and asks whether the primary signal for resume-after-step consistency is present.
...
## Review Notes
This file exists to teach one distinct review target: resume-after-step consistency.
