...
# Weight-Decay Separation Notes Status Flags

## Concept
Weight-decay separation notes is the main teaching target for this draft candidate.
...
## Explanation
Example index 147 uses a narrow lens: weight-decay separation notes.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0147.
The reviewer opens a optimizer_steps artifact and asks whether the primary signal for weight-decay separation notes is present.
...
## Review Notes
This file exists to teach one distinct review target: weight-decay separation notes.
