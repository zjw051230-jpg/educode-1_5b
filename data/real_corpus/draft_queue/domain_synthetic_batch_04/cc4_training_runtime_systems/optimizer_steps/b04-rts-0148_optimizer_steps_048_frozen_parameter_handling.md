...
# Frozen-Parameter Handling Pass Criteria

## Concept
Frozen-parameter handling is the main teaching target for this draft candidate.
...
## Explanation
Example index 148 uses a narrow lens: frozen-parameter handling.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0148.
The reviewer opens a optimizer_steps artifact and asks whether the primary signal for frozen-parameter handling is present.
...
## Review Notes
This file exists to teach one distinct review target: frozen-parameter handling.
