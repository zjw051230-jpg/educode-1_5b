...
def build_optimizer_steps_0173(rows):
    summary = {
        'topic_id': 'B04-RTS-0173',
...
def check_optimizer_steps_72(summary):
    flags = {
...
sample_rows = [1.27, 1.52, 1.77, 2.02, 2.27]
summary = build_optimizer_steps_0173(sample_rows)
flags = check_optimizer_steps_72(summary)
print(summary)
print(flags)
