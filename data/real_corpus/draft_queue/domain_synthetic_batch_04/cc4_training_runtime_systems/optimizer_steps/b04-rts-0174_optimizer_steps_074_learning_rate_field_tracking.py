...
def build_optimizer_steps_0174(rows):
    summary = {
        'topic_id': 'B04-RTS-0174',
...
def check_optimizer_steps_73(summary):
    flags = {
...
sample_rows = [1.38, 1.63, 1.88, 2.13, 2.38]
summary = build_optimizer_steps_0174(sample_rows)
flags = check_optimizer_steps_73(summary)
print(summary)
print(flags)
