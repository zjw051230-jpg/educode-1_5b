...
def build_optimizer_steps_0176(rows):
    summary = {
        'topic_id': 'B04-RTS-0176',
...
def check_optimizer_steps_75(summary):
    flags = {
...
sample_rows = [1.6, 1.85, 2.1, 2.35, 2.6]
summary = build_optimizer_steps_0176(sample_rows)
flags = check_optimizer_steps_75(summary)
print(summary)
print(flags)
