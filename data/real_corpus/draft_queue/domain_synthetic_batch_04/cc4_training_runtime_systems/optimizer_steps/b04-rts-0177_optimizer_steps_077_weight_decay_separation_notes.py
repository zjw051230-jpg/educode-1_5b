...
def build_optimizer_steps_0177(rows):
    summary = {
        'topic_id': 'B04-RTS-0177',
...
def check_optimizer_steps_76(summary):
    flags = {
...
sample_rows = [1.71, 1.96, 2.21, 2.46, 2.71]
summary = build_optimizer_steps_0177(sample_rows)
flags = check_optimizer_steps_76(summary)
print(summary)
print(flags)
