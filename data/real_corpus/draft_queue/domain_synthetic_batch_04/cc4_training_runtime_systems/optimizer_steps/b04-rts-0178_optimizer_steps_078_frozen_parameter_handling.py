...
def build_optimizer_steps_0178(rows):
    summary = {
        'topic_id': 'B04-RTS-0178',
...
def check_optimizer_steps_77(summary):
    flags = {
...
sample_rows = [1.82, 2.07, 2.32, 2.57, 2.82]
summary = build_optimizer_steps_0178(sample_rows)
flags = check_optimizer_steps_77(summary)
print(summary)
print(flags)
