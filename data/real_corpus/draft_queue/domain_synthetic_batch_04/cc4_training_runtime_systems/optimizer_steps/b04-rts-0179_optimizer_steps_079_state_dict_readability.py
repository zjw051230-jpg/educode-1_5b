...
def build_optimizer_steps_0179(rows):
    summary = {
        'topic_id': 'B04-RTS-0179',
...
def check_optimizer_steps_78(summary):
    flags = {
...
sample_rows = [1.93, 2.18, 2.43, 2.68, 2.93]
summary = build_optimizer_steps_0179(sample_rows)
flags = check_optimizer_steps_78(summary)
print(summary)
print(flags)
