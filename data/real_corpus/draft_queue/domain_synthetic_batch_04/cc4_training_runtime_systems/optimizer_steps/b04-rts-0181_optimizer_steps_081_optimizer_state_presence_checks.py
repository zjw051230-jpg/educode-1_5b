...
def build_optimizer_steps_0181(rows):
    summary = {
        'topic_id': 'B04-RTS-0181',
...
def check_optimizer_steps_80(summary):
    flags = {
...
sample_rows = [2.15, 2.4, 2.65, 2.9, 3.15]
summary = build_optimizer_steps_0181(sample_rows)
flags = check_optimizer_steps_80(summary)
print(summary)
print(flags)
