...
def build_optimizer_steps_0182(rows):
    summary = {
        'topic_id': 'B04-RTS-0182',
...
def check_optimizer_steps_81(summary):
    flags = {
...
sample_rows = [2.26, 2.51, 2.76, 3.01, 3.26]
summary = build_optimizer_steps_0182(sample_rows)
flags = check_optimizer_steps_81(summary)
print(summary)
print(flags)
