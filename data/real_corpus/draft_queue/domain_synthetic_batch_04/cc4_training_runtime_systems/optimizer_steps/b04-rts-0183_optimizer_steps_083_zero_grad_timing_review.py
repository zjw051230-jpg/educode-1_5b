...
def build_optimizer_steps_0183(rows):
    summary = {
        'topic_id': 'B04-RTS-0183',
        'focus': 'zero_grad timing review',
        'row_count': len(rows),
...
def check_optimizer_steps_82(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'zero_grad timing review',
    }
...
summary = build_optimizer_steps_0183(sample_rows)
flags = check_optimizer_steps_82(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates zero_grad timing review.
