...
def build_optimizer_steps_0185(rows):
    summary = {
        'topic_id': 'B04-RTS-0185',
...
def check_optimizer_steps_84(summary):
    flags = {
...
summary = build_optimizer_steps_0185(sample_rows)
flags = check_optimizer_steps_84(summary)
print(summary)
print(flags)
