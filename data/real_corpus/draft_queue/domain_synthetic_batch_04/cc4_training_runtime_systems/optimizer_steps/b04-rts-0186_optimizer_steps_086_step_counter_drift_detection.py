...
def build_optimizer_steps_0186(rows):
    summary = {
        'topic_id': 'B04-RTS-0186',
...
def check_optimizer_steps_85(summary):
    flags = {
...
sample_rows = [2.7, 2.95, 3.2, 3.45, 3.7]
summary = build_optimizer_steps_0186(sample_rows)
flags = check_optimizer_steps_85(summary)
print(summary)
print(flags)
