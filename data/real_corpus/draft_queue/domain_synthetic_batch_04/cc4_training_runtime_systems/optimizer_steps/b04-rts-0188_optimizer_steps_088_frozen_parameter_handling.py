...
def build_optimizer_steps_0188(rows):
    summary = {
        'topic_id': 'B04-RTS-0188',
...
def check_optimizer_steps_87(summary):
    flags = {
...
summary = build_optimizer_steps_0188(sample_rows)
flags = check_optimizer_steps_87(summary)
print(summary)
print(flags)
