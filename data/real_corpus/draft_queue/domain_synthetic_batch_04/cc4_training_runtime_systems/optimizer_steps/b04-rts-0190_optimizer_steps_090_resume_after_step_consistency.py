...
def build_optimizer_steps_0190(rows):
    summary = {
        'topic_id': 'B04-RTS-0190',
...
def check_optimizer_steps_89(summary):
    flags = {
...
sample_rows = [1.44, 1.69, 1.94, 2.19, 2.44]
summary = build_optimizer_steps_0190(sample_rows)
flags = check_optimizer_steps_89(summary)
print(summary)
print(flags)
