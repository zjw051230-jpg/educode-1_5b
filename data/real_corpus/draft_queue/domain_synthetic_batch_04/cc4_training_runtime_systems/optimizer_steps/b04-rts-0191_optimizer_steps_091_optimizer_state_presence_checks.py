...
def build_optimizer_steps_0191(rows):
    summary = {
        'topic_id': 'B04-RTS-0191',
...
def check_optimizer_steps_90(summary):
    flags = {
...
sample_rows = [1.55, 1.8, 2.05, 2.3, 2.55]
summary = build_optimizer_steps_0191(sample_rows)
flags = check_optimizer_steps_90(summary)
print(summary)
print(flags)
