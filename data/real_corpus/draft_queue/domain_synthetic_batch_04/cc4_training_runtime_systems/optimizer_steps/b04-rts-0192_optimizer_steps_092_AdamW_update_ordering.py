...
def build_optimizer_steps_0192(rows):
    summary = {
        'topic_id': 'B04-RTS-0192',
...
def check_optimizer_steps_91(summary):
    flags = {
...
sample_rows = [1.66, 1.91, 2.16, 2.41, 2.66]
summary = build_optimizer_steps_0192(sample_rows)
flags = check_optimizer_steps_91(summary)
print(summary)
print(flags)
