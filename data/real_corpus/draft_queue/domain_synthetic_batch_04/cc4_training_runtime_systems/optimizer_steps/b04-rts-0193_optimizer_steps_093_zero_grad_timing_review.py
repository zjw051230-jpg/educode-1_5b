...
def build_optimizer_steps_0193(rows):
    summary = {
        'topic_id': 'B04-RTS-0193',
...
def check_optimizer_steps_92(summary):
    flags = {
...
summary = build_optimizer_steps_0193(sample_rows)
flags = check_optimizer_steps_92(summary)
print(summary)
print(flags)
