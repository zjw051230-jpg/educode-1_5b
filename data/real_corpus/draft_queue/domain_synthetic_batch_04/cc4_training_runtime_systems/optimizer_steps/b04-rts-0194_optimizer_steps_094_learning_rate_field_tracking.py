...
def build_optimizer_steps_0194(rows):
    summary = {
        'topic_id': 'B04-RTS-0194',
...
def check_optimizer_steps_93(summary):
    flags = {
...
summary = build_optimizer_steps_0194(sample_rows)
flags = check_optimizer_steps_93(summary)
print(summary)
print(flags)
