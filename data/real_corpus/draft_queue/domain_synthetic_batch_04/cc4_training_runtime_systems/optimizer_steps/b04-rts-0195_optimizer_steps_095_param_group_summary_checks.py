...
def build_optimizer_steps_0195(rows):
    summary = {
        'topic_id': 'B04-RTS-0195',
...
def check_optimizer_steps_94(summary):
    flags = {
...
summary = build_optimizer_steps_0195(sample_rows)
flags = check_optimizer_steps_94(summary)
print(summary)
print(flags)
