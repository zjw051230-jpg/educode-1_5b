...
def build_optimizer_steps_0197(rows):
    summary = {
        'topic_id': 'B04-RTS-0197',
...
def check_optimizer_steps_96(summary):
    flags = {
...
sample_rows = [2.21, 2.46, 2.71, 2.96, 3.21]
summary = build_optimizer_steps_0197(sample_rows)
flags = check_optimizer_steps_96(summary)
print(summary)
print(flags)
