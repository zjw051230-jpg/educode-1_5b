...
def build_optimizer_steps_0198(rows):
    summary = {
        'topic_id': 'B04-RTS-0198',
        'focus': 'frozen-parameter handling',
        'row_count': len(rows),
...
def check_optimizer_steps_97(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'frozen-parameter handling',
    }
...
summary = build_optimizer_steps_0198(sample_rows)
flags = check_optimizer_steps_97(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates frozen-parameter handling.
