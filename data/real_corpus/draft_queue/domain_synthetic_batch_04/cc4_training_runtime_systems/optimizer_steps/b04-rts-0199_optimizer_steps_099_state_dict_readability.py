...
def build_optimizer_steps_0199(rows):
    summary = {
        'topic_id': 'B04-RTS-0199',
...
def check_optimizer_steps_98(summary):
    flags = {
...
summary = build_optimizer_steps_0199(sample_rows)
flags = check_optimizer_steps_98(summary)
print(summary)
print(flags)
