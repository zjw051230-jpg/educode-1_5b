...
def build_optimizer_steps_0200(rows):
    summary = {
        'topic_id': 'B04-RTS-0200',
...
def check_optimizer_steps_99(summary):
    flags = {
...
summary = build_optimizer_steps_0200(sample_rows)
flags = check_optimizer_steps_99(summary)
print(summary)
print(flags)
