...
# Best-Step Tracking Failure Patterns

## Concept
Best-step tracking is the main teaching target for this draft candidate.
...
## Explanation
Example index 712 uses a narrow lens: best-step tracking.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0712.
The reviewer opens a overfit_detection artifact and asks whether the primary signal for best-step tracking is present.
...
## Review Notes
This file exists to teach one distinct review target: best-step tracking.
