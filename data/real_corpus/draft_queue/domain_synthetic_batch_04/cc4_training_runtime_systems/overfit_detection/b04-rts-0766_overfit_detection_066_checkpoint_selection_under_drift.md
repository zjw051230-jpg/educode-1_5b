...
# Checkpoint Selection Under Drift Minimal Review Flow

## Concept
Checkpoint selection under drift is the main teaching target for this draft candidate.
This note sits inside the overfit_detection runtime theme and focuses on one reviewable behavior rather than a whole training system.
...
## Explanation
Example index 766 uses a narrow lens: checkpoint selection under drift.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0766.
The reviewer opens a overfit_detection artifact and asks whether the primary signal for checkpoint selection under drift is present.
...
## Review Notes
This file exists to teach one distinct review target: checkpoint selection under drift.
