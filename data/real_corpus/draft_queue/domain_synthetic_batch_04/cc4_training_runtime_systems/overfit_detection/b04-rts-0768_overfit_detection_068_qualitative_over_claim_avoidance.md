...
# Qualitative Over-Claim Avoidance Pass Criteria

## Concept
Qualitative over-claim avoidance is the main teaching target for this draft candidate.
...
## Explanation
Example index 768 uses a narrow lens: qualitative over-claim avoidance.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0768.
The reviewer opens a overfit_detection artifact and asks whether the primary signal for qualitative over-claim avoidance is present.
...
## Review Notes
This file exists to teach one distinct review target: qualitative over-claim avoidance.
