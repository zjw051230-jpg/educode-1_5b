...
def build_overfit_detection_0771(rows):
    summary = {
        'topic_id': 'B04-RTS-0771',
...
def check_overfit_detection_70(summary):
    flags = {
...
summary = build_overfit_detection_0771(sample_rows)
flags = check_overfit_detection_70(summary)
print(summary)
print(flags)
