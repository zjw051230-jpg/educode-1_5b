...
def build_overfit_detection_0772(rows):
    summary = {
        'topic_id': 'B04-RTS-0772',
...
def check_overfit_detection_71(summary):
    flags = {
...
summary = build_overfit_detection_0772(sample_rows)
flags = check_overfit_detection_71(summary)
print(summary)
print(flags)
