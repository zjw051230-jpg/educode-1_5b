...
def build_overfit_detection_0774(rows):
    summary = {
        'topic_id': 'B04-RTS-0774',
        'focus': 'overfit warning language',
        'row_count': len(rows),
...
def check_overfit_detection_73(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'overfit warning language',
    }
...
summary = build_overfit_detection_0774(sample_rows)
flags = check_overfit_detection_73(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates overfit warning language.
