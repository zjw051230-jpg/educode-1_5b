...
def build_overfit_detection_0775(rows):
    summary = {
        'topic_id': 'B04-RTS-0775',
...
def check_overfit_detection_74(summary):
    flags = {
...
sample_rows = [1.99, 2.24, 2.49, 2.74, 2.99]
summary = build_overfit_detection_0775(sample_rows)
flags = check_overfit_detection_74(summary)
print(summary)
print(flags)
