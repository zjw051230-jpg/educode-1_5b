...
def build_overfit_detection_0776(rows):
    summary = {
        'topic_id': 'B04-RTS-0776',
...
def check_overfit_detection_75(summary):
    flags = {
...
summary = build_overfit_detection_0776(sample_rows)
flags = check_overfit_detection_75(summary)
print(summary)
print(flags)
