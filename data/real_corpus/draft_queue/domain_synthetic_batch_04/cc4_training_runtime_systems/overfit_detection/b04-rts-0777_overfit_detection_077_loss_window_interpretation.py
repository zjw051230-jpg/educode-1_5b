...
def build_overfit_detection_0777(rows):
    summary = {
        'topic_id': 'B04-RTS-0777',
...
def check_overfit_detection_76(summary):
    flags = {
...
summary = build_overfit_detection_0777(sample_rows)
flags = check_overfit_detection_76(summary)
print(summary)
print(flags)
