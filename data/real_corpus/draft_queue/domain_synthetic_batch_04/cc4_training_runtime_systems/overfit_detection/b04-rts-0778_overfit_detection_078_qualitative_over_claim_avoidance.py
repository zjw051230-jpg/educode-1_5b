...
def build_overfit_detection_0778(rows):
    summary = {
        'topic_id': 'B04-RTS-0778',
...
def check_overfit_detection_77(summary):
    flags = {
...
sample_rows = [2.32, 2.57, 2.82, 3.07, 3.32]
summary = build_overfit_detection_0778(sample_rows)
flags = check_overfit_detection_77(summary)
print(summary)
print(flags)
