...
def build_overfit_detection_0780(rows):
    summary = {
        'topic_id': 'B04-RTS-0780',
...
def check_overfit_detection_79(summary):
    flags = {
...
sample_rows = [2.54, 2.79, 3.04, 3.29, 3.54]
summary = build_overfit_detection_0780(sample_rows)
flags = check_overfit_detection_79(summary)
print(summary)
print(flags)
