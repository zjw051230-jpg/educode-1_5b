...
def build_overfit_detection_0781(rows):
    summary = {
        'topic_id': 'B04-RTS-0781',
...
def check_overfit_detection_80(summary):
    flags = {
...
sample_rows = [2.65, 2.9, 3.15, 3.4, 3.65]
summary = build_overfit_detection_0781(sample_rows)
flags = check_overfit_detection_80(summary)
print(summary)
print(flags)
