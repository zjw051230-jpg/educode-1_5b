...
def build_overfit_detection_0782(rows):
    summary = {
        'topic_id': 'B04-RTS-0782',
...
def check_overfit_detection_81(summary):
    flags = {
...
sample_rows = [1.06, 1.31, 1.56, 1.81, 2.06]
summary = build_overfit_detection_0782(sample_rows)
flags = check_overfit_detection_81(summary)
print(summary)
print(flags)
