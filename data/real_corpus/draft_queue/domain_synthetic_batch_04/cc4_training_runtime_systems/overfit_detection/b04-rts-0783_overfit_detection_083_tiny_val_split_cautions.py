...
def build_overfit_detection_0783(rows):
    summary = {
        'topic_id': 'B04-RTS-0783',
...
def check_overfit_detection_82(summary):
    flags = {
...
summary = build_overfit_detection_0783(sample_rows)
flags = check_overfit_detection_82(summary)
print(summary)
print(flags)
