...
def build_overfit_detection_0784(rows):
    summary = {
        'topic_id': 'B04-RTS-0784',
...
def check_overfit_detection_83(summary):
    flags = {
...
summary = build_overfit_detection_0784(sample_rows)
flags = check_overfit_detection_83(summary)
print(summary)
print(flags)
