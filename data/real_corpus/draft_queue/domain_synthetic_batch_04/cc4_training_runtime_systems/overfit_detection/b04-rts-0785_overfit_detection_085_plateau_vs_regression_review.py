...
def build_overfit_detection_0785(rows):
    summary = {
        'topic_id': 'B04-RTS-0785',
...
def check_overfit_detection_84(summary):
    flags = {
...
sample_rows = [1.39, 1.64, 1.89, 2.14, 2.39]
summary = build_overfit_detection_0785(sample_rows)
flags = check_overfit_detection_84(summary)
print(summary)
print(flags)
