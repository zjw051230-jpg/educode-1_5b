...
def build_overfit_detection_0787(rows):
    summary = {
        'topic_id': 'B04-RTS-0787',
...
def check_overfit_detection_86(summary):
    flags = {
...
sample_rows = [1.61, 1.86, 2.11, 2.36, 2.61]
summary = build_overfit_detection_0787(sample_rows)
flags = check_overfit_detection_86(summary)
print(summary)
print(flags)
