...
def build_overfit_detection_0789(rows):
    summary = {
        'topic_id': 'B04-RTS-0789',
...
def check_overfit_detection_88(summary):
    flags = {
...
summary = build_overfit_detection_0789(sample_rows)
flags = check_overfit_detection_88(summary)
print(summary)
print(flags)
