...
def build_overfit_detection_0793(rows):
    summary = {
        'topic_id': 'B04-RTS-0793',
...
def check_overfit_detection_92(summary):
    flags = {
...
sample_rows = [2.27, 2.52, 2.77, 3.02, 3.27]
summary = build_overfit_detection_0793(sample_rows)
flags = check_overfit_detection_92(summary)
print(summary)
print(flags)
