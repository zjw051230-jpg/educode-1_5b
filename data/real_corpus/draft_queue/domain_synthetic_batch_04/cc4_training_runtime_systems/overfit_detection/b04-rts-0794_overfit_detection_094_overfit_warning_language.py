...
def build_overfit_detection_0794(rows):
    summary = {
        'topic_id': 'B04-RTS-0794',
...
def check_overfit_detection_93(summary):
    flags = {
...
sample_rows = [2.38, 2.63, 2.88, 3.13, 3.38]
summary = build_overfit_detection_0794(sample_rows)
flags = check_overfit_detection_93(summary)
print(summary)
print(flags)
