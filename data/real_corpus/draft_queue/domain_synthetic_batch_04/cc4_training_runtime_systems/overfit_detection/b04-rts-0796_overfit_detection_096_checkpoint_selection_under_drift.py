...
def build_overfit_detection_0796(rows):
    summary = {
        'topic_id': 'B04-RTS-0796',
...
def check_overfit_detection_95(summary):
    flags = {
...
sample_rows = [2.6, 2.85, 3.1, 3.35, 3.6]
summary = build_overfit_detection_0796(sample_rows)
flags = check_overfit_detection_95(summary)
print(summary)
print(flags)
