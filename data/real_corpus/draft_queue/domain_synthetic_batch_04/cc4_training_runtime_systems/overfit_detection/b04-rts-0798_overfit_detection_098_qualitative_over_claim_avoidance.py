...
def build_overfit_detection_0798(rows):
    summary = {
        'topic_id': 'B04-RTS-0798',
...
def check_overfit_detection_97(summary):
    flags = {
...
sample_rows = [2.82, 3.07, 3.32, 3.57, 3.82]
summary = build_overfit_detection_0798(sample_rows)
flags = check_overfit_detection_97(summary)
print(summary)
print(flags)
