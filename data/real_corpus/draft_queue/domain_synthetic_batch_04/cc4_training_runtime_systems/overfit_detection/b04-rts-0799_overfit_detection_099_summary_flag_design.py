...
def build_overfit_detection_0799(rows):
    summary = {
        'topic_id': 'B04-RTS-0799',
...
def check_overfit_detection_98(summary):
    flags = {
...
sample_rows = [1.23, 1.48, 1.73, 1.98, 2.23]
summary = build_overfit_detection_0799(sample_rows)
flags = check_overfit_detection_98(summary)
print(summary)
print(flags)
