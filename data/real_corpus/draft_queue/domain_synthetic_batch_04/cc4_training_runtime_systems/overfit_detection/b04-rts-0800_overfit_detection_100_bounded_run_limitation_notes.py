...
def build_overfit_detection_0800(rows):
    summary = {
        'topic_id': 'B04-RTS-0800',
...
def check_overfit_detection_99(summary):
    flags = {
...
sample_rows = [1.34, 1.59, 1.84, 2.09, 2.34]
summary = build_overfit_detection_0800(sample_rows)
flags = check_overfit_detection_99(summary)
print(summary)
print(flags)
