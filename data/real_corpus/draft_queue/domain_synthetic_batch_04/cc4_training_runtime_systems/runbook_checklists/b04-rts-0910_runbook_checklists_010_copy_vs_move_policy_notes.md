...
# Copy-Vs-Move Policy Notes Naming Notes

## Concept
Copy-vs-move policy notes is the main teaching target for this draft candidate.
...
## Explanation
Example index 910 uses a narrow lens: copy-vs-move policy notes.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0910.
The reviewer opens a runbook_checklists artifact and asks whether the primary signal for copy-vs-move policy notes is present.
...
## Review Notes
This file exists to teach one distinct review target: copy-vs-move policy notes.
