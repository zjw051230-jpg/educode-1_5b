...
# Retention Window Examples Summary Design

## Concept
Retention window examples is the main teaching target for this draft candidate.
...
## Explanation
Example index 939 uses a narrow lens: retention window examples.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0939.
The reviewer opens a runbook_checklists artifact and asks whether the primary signal for retention window examples is present.
...
## Review Notes
This file exists to teach one distinct review target: retention window examples.
