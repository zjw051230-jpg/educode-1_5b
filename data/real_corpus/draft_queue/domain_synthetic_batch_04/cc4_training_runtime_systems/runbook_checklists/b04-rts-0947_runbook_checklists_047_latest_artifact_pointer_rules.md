...
# Latest Artifact Pointer Rules Status Flags

## Concept
Latest artifact pointer rules is the main teaching target for this draft candidate.
...
## Explanation
Example index 947 uses a narrow lens: latest artifact pointer rules.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0947.
The reviewer opens a runbook_checklists artifact and asks whether the primary signal for latest artifact pointer rules is present.
...
## Review Notes
This file exists to teach one distinct review target: latest artifact pointer rules.
