...
# Artifact Transfer Naming Rules Failure Patterns

## Concept
Artifact transfer naming rules is the main teaching target for this draft candidate.
...
## Explanation
Example index 952 uses a narrow lens: artifact transfer naming rules.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0952.
The reviewer opens a runbook_checklists artifact and asks whether the primary signal for artifact transfer naming rules is present.
...
## Review Notes
This file exists to teach one distinct review target: artifact transfer naming rules.
