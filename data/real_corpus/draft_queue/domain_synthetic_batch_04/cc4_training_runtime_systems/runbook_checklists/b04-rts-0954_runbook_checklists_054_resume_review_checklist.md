...
# Resume Review Checklist Audit Cues

## Concept
Resume review checklist is the main teaching target for this draft candidate.
...
## Explanation
Example index 954 uses a narrow lens: resume review checklist.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0954.
The reviewer opens a runbook_checklists artifact and asks whether the primary signal for resume review checklist is present.
...
## Review Notes
This file exists to teach one distinct review target: resume review checklist.
