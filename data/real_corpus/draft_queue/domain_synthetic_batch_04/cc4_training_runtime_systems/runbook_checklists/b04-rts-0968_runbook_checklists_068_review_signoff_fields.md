...
# Review Signoff Fields Pass Criteria

## Concept
Review signoff fields is the main teaching target for this draft candidate.
...
## Explanation
Example index 968 uses a narrow lens: review signoff fields.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0968.
The reviewer opens a runbook_checklists artifact and asks whether the primary signal for review signoff fields is present.
...
## Review Notes
This file exists to teach one distinct review target: review signoff fields.
