...
def build_runbook_checklists_0971(rows):
    summary = {
        'topic_id': 'B04-RTS-0971',
...
def check_runbook_checklists_70(summary):
    flags = {
...
sample_rows = [1.15, 1.4, 1.65, 1.9, 2.15]
summary = build_runbook_checklists_0971(sample_rows)
flags = check_runbook_checklists_70(summary)
print(summary)
print(flags)
