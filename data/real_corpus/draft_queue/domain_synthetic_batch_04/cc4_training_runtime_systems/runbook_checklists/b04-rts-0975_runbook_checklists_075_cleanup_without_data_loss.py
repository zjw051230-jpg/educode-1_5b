...
def build_runbook_checklists_0975(rows):
    summary = {
        'topic_id': 'B04-RTS-0975',
...
def check_runbook_checklists_74(summary):
    flags = {
...
sample_rows = [1.59, 1.84, 2.09, 2.34, 2.59]
summary = build_runbook_checklists_0975(sample_rows)
flags = check_runbook_checklists_74(summary)
print(summary)
print(flags)
