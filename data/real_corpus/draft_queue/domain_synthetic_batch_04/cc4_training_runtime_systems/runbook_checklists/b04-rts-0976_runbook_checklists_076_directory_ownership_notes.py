...
def build_runbook_checklists_0976(rows):
    summary = {
        'topic_id': 'B04-RTS-0976',
...
def check_runbook_checklists_75(summary):
    flags = {
...
sample_rows = [1.7, 1.95, 2.2, 2.45, 2.7]
summary = build_runbook_checklists_0976(sample_rows)
flags = check_runbook_checklists_75(summary)
print(summary)
print(flags)
