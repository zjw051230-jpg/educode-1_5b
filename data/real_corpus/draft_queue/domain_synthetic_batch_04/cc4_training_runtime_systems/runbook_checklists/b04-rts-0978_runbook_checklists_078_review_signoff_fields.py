...
def build_runbook_checklists_0978(rows):
    summary = {
        'topic_id': 'B04-RTS-0978',
...
def check_runbook_checklists_77(summary):
    flags = {
...
sample_rows = [1.92, 2.17, 2.42, 2.67, 2.92]
summary = build_runbook_checklists_0978(sample_rows)
flags = check_runbook_checklists_77(summary)
print(summary)
print(flags)
