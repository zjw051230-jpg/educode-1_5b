...
def build_runbook_checklists_0979(rows):
    summary = {
        'topic_id': 'B04-RTS-0979',
...
def check_runbook_checklists_78(summary):
    flags = {
...
sample_rows = [2.03, 2.28, 2.53, 2.78, 3.03]
summary = build_runbook_checklists_0979(sample_rows)
flags = check_runbook_checklists_78(summary)
print(summary)
print(flags)
