...
def build_runbook_checklists_0980(rows):
    summary = {
        'topic_id': 'B04-RTS-0980',
...
def check_runbook_checklists_79(summary):
    flags = {
...
sample_rows = [2.14, 2.39, 2.64, 2.89, 3.14]
summary = build_runbook_checklists_0980(sample_rows)
flags = check_runbook_checklists_79(summary)
print(summary)
print(flags)
