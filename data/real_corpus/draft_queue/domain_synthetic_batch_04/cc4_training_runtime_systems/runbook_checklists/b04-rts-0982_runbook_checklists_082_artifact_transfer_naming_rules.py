...
def build_runbook_checklists_0982(rows):
    summary = {
        'topic_id': 'B04-RTS-0982',
...
def check_runbook_checklists_81(summary):
    flags = {
...
sample_rows = [2.36, 2.61, 2.86, 3.11, 3.36]
summary = build_runbook_checklists_0982(sample_rows)
flags = check_runbook_checklists_81(summary)
print(summary)
print(flags)
