...
def build_runbook_checklists_0983(rows):
    summary = {
        'topic_id': 'B04-RTS-0983',
...
def check_runbook_checklists_82(summary):
    flags = {
...
sample_rows = [2.47, 2.72, 2.97, 3.22, 3.47]
summary = build_runbook_checklists_0983(sample_rows)
flags = check_runbook_checklists_82(summary)
print(summary)
print(flags)
