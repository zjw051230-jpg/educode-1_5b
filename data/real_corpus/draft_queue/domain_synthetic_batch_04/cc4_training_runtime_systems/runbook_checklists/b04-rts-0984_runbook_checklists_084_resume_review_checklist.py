...
def build_runbook_checklists_0984(rows):
    summary = {
        'topic_id': 'B04-RTS-0984',
...
def check_runbook_checklists_83(summary):
    flags = {
...
sample_rows = [2.58, 2.83, 3.08, 3.33, 3.58]
summary = build_runbook_checklists_0984(sample_rows)
flags = check_runbook_checklists_83(summary)
print(summary)
print(flags)
