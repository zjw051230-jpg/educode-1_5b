...
def build_runbook_checklists_0987(rows):
    summary = {
        'topic_id': 'B04-RTS-0987',
...
def check_runbook_checklists_86(summary):
    flags = {
...
sample_rows = [1.21, 1.46, 1.71, 1.96, 2.21]
summary = build_runbook_checklists_0987(sample_rows)
flags = check_runbook_checklists_86(summary)
print(summary)
print(flags)
