...
def build_runbook_checklists_0989(rows):
    summary = {
        'topic_id': 'B04-RTS-0989',
...
def check_runbook_checklists_88(summary):
    flags = {
...
sample_rows = [1.43, 1.68, 1.93, 2.18, 2.43]
summary = build_runbook_checklists_0989(sample_rows)
flags = check_runbook_checklists_88(summary)
print(summary)
print(flags)
