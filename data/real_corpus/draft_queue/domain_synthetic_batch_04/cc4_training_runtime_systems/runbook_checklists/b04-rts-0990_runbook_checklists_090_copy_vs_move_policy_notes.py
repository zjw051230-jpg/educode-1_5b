...
def build_runbook_checklists_0990(rows):
    summary = {
        'topic_id': 'B04-RTS-0990',
...
def check_runbook_checklists_89(summary):
    flags = {
...
sample_rows = [1.54, 1.79, 2.04, 2.29, 2.54]
summary = build_runbook_checklists_0990(sample_rows)
flags = check_runbook_checklists_89(summary)
print(summary)
print(flags)
