...
def build_runbook_checklists_0991(rows):
    summary = {
        'topic_id': 'B04-RTS-0991',
...
def check_runbook_checklists_90(summary):
    flags = {
...
sample_rows = [1.65, 1.9, 2.15, 2.4, 2.65]
summary = build_runbook_checklists_0991(sample_rows)
flags = check_runbook_checklists_90(summary)
print(summary)
print(flags)
