...
def build_runbook_checklists_0992(rows):
    summary = {
        'topic_id': 'B04-RTS-0992',
...
def check_runbook_checklists_91(summary):
    flags = {
...
sample_rows = [1.76, 2.01, 2.26, 2.51, 2.76]
summary = build_runbook_checklists_0992(sample_rows)
flags = check_runbook_checklists_91(summary)
print(summary)
print(flags)
