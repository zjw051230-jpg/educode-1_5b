...
def build_runbook_checklists_0993(rows):
    summary = {
        'topic_id': 'B04-RTS-0993',
...
def check_runbook_checklists_92(summary):
    flags = {
...
sample_rows = [1.87, 2.12, 2.37, 2.62, 2.87]
summary = build_runbook_checklists_0993(sample_rows)
flags = check_runbook_checklists_92(summary)
print(summary)
print(flags)
