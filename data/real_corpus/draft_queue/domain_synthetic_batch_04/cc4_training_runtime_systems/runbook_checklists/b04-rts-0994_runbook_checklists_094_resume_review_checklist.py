...
def build_runbook_checklists_0994(rows):
    summary = {
        'topic_id': 'B04-RTS-0994',
...
def check_runbook_checklists_93(summary):
    flags = {
...
sample_rows = [1.98, 2.23, 2.48, 2.73, 2.98]
summary = build_runbook_checklists_0994(sample_rows)
flags = check_runbook_checklists_93(summary)
print(summary)
print(flags)
