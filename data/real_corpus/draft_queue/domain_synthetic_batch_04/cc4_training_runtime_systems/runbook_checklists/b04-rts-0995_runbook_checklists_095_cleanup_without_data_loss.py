...
def build_runbook_checklists_0995(rows):
    summary = {
        'topic_id': 'B04-RTS-0995',
...
def check_runbook_checklists_94(summary):
    flags = {
...
sample_rows = [2.09, 2.34, 2.59, 2.84, 3.09]
summary = build_runbook_checklists_0995(sample_rows)
flags = check_runbook_checklists_94(summary)
print(summary)
print(flags)
