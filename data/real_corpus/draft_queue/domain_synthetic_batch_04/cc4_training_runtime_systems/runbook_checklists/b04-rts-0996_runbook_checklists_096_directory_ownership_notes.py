...
def build_runbook_checklists_0996(rows):
    summary = {
        'topic_id': 'B04-RTS-0996',
...
def check_runbook_checklists_95(summary):
    flags = {
...
sample_rows = [2.2, 2.45, 2.7, 2.95, 3.2]
summary = build_runbook_checklists_0996(sample_rows)
flags = check_runbook_checklists_95(summary)
print(summary)
print(flags)
