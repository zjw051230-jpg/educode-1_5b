...
def build_runbook_checklists_0997(rows):
    summary = {
        'topic_id': 'B04-RTS-0997',
...
def check_runbook_checklists_96(summary):
    flags = {
...
sample_rows = [2.31, 2.56, 2.81, 3.06, 3.31]
summary = build_runbook_checklists_0997(sample_rows)
flags = check_runbook_checklists_96(summary)
print(summary)
print(flags)
