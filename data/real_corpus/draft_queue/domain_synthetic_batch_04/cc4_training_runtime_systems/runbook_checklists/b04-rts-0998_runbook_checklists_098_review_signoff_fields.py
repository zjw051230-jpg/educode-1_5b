...
def build_runbook_checklists_0998(rows):
    summary = {
        'topic_id': 'B04-RTS-0998',
...
def check_runbook_checklists_97(summary):
    flags = {
...
sample_rows = [2.42, 2.67, 2.92, 3.17, 3.42]
summary = build_runbook_checklists_0998(sample_rows)
flags = check_runbook_checklists_97(summary)
print(summary)
print(flags)
