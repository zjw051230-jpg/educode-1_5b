...
# Step-Time Window Choice Failure Patterns

## Concept
Step-time window choice is the main teaching target for this draft candidate.
...
## Explanation
Example index 802 uses a narrow lens: step-time window choice.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0802.
The reviewer opens a throughput_profiles artifact and asks whether the primary signal for step-time window choice is present.
...
## Review Notes
This file exists to teach one distinct review target: step-time window choice.
