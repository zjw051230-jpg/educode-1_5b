...
# Profile Label Consistency Comparison Notes

## Concept
Profile label consistency is the main teaching target for this draft candidate.
...
## Explanation
Example index 803 uses a narrow lens: profile label consistency.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0803.
The reviewer opens a throughput_profiles artifact and asks whether the primary signal for profile label consistency is present.
...
## Review Notes
This file exists to teach one distinct review target: profile label consistency.
