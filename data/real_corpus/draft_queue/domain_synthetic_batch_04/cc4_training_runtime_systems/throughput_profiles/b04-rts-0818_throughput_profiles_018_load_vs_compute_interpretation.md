...
# Load-Vs-Compute Interpretation Pass Criteria

## Concept
Load-vs-compute interpretation is the main teaching target for this draft candidate.
...
## Explanation
Example index 818 uses a narrow lens: load-vs-compute interpretation.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0818.
The reviewer opens a throughput_profiles artifact and asks whether the primary signal for load-vs-compute interpretation is present.
...
## Review Notes
This file exists to teach one distinct review target: load-vs-compute interpretation.
