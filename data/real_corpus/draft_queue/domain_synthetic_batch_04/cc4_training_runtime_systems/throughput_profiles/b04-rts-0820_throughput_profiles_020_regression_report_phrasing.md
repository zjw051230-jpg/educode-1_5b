...
# Regression Report Phrasing Naming Notes

## Concept
Regression report phrasing is the main teaching target for this draft candidate.
...
## Explanation
Example index 820 uses a narrow lens: regression report phrasing.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0820.
The reviewer opens a throughput_profiles artifact and asks whether the primary signal for regression report phrasing is present.
...
## Review Notes
This file exists to teach one distinct review target: regression report phrasing.
