...
# Latency Percentile Summaries Summary Design

## Concept
Latency percentile summaries is the main teaching target for this draft candidate.
...
## Explanation
Example index 839 uses a narrow lens: latency percentile summaries.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0839.
The reviewer opens a throughput_profiles artifact and asks whether the primary signal for latency percentile summaries is present.
...
## Review Notes
This file exists to teach one distinct review target: latency percentile summaries.
