...
# Seq-Len Profile Comparison Audit Cues

## Concept
Seq-len profile comparison is the main teaching target for this draft candidate.
...
## Explanation
Example index 844 uses a narrow lens: seq-len profile comparison.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0844.
The reviewer opens a throughput_profiles artifact and asks whether the primary signal for seq-len profile comparison is present.
...
## Review Notes
This file exists to teach one distinct review target: seq-len profile comparison.
