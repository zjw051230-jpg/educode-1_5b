...
# Warmup Exclusion Notes Minimal Review Flow

## Concept
Warmup exclusion notes is the main teaching target for this draft candidate.
...
## Explanation
Example index 846 uses a narrow lens: warmup exclusion notes.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0846.
The reviewer opens a throughput_profiles artifact and asks whether the primary signal for warmup exclusion notes is present.
...
## Review Notes
This file exists to teach one distinct review target: warmup exclusion notes.
