...
def build_throughput_profiles_0872(rows):
    summary = {
        'topic_id': 'B04-RTS-0872',
        'focus': 'step-time window choice',
        'row_count': len(rows),
...
def check_throughput_profiles_71(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'step-time window choice',
    }
...
summary = build_throughput_profiles_0872(sample_rows)
flags = check_throughput_profiles_71(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates step-time window choice.
