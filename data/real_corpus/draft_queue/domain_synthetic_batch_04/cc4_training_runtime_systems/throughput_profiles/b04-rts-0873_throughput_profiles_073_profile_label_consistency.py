...
def build_throughput_profiles_0873(rows):
    summary = {
        'topic_id': 'B04-RTS-0873',
        'focus': 'profile label consistency',
        'row_count': len(rows),
...
def check_throughput_profiles_72(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'profile label consistency',
    }
...
summary = build_throughput_profiles_0873(sample_rows)
flags = check_throughput_profiles_72(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates profile label consistency.
