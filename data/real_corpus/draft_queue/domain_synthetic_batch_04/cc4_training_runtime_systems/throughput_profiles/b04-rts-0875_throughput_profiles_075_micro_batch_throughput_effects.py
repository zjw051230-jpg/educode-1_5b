...
def build_throughput_profiles_0875(rows):
    summary = {
        'topic_id': 'B04-RTS-0875',
...
def check_throughput_profiles_74(summary):
    flags = {
...
summary = build_throughput_profiles_0875(sample_rows)
flags = check_throughput_profiles_74(summary)
print(summary)
print(flags)
