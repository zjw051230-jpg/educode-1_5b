...
def build_throughput_profiles_0876(rows):
    summary = {
        'topic_id': 'B04-RTS-0876',
...
def check_throughput_profiles_75(summary):
    flags = {
...
summary = build_throughput_profiles_0876(sample_rows)
flags = check_throughput_profiles_75(summary)
print(summary)
print(flags)
