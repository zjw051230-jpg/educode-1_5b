...
def build_throughput_profiles_0877(rows):
    summary = {
        'topic_id': 'B04-RTS-0877',
...
def check_throughput_profiles_76(summary):
    flags = {
...
summary = build_throughput_profiles_0877(sample_rows)
flags = check_throughput_profiles_76(summary)
print(summary)
print(flags)
