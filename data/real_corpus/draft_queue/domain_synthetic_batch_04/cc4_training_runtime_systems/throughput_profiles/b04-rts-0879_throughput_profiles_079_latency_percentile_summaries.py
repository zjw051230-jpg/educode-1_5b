...
def build_throughput_profiles_0879(rows):
    summary = {
        'topic_id': 'B04-RTS-0879',
...
def check_throughput_profiles_78(summary):
    flags = {
...
sample_rows = [2.23, 2.48, 2.73, 2.98, 3.23]
summary = build_throughput_profiles_0879(sample_rows)
flags = check_throughput_profiles_78(summary)
print(summary)
print(flags)
