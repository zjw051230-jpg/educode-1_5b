...
def build_throughput_profiles_0881(rows):
    summary = {
        'topic_id': 'B04-RTS-0881',
...
def check_throughput_profiles_80(summary):
    flags = {
...
sample_rows = [2.45, 2.7, 2.95, 3.2, 3.45]
summary = build_throughput_profiles_0881(sample_rows)
flags = check_throughput_profiles_80(summary)
print(summary)
print(flags)
