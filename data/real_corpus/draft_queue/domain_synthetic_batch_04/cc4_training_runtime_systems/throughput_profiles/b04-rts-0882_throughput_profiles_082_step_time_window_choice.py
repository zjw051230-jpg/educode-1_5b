...
def build_throughput_profiles_0882(rows):
    summary = {
        'topic_id': 'B04-RTS-0882',
...
def check_throughput_profiles_81(summary):
    flags = {
...
summary = build_throughput_profiles_0882(sample_rows)
flags = check_throughput_profiles_81(summary)
print(summary)
print(flags)
