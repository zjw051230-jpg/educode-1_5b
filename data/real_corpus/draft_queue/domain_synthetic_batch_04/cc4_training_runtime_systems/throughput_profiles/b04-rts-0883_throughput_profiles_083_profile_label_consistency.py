...
def build_throughput_profiles_0883(rows):
    summary = {
        'topic_id': 'B04-RTS-0883',
...
def check_throughput_profiles_82(summary):
    flags = {
...
sample_rows = [2.67, 2.92, 3.17, 3.42, 3.67]
summary = build_throughput_profiles_0883(sample_rows)
flags = check_throughput_profiles_82(summary)
print(summary)
print(flags)
