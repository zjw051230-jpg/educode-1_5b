...
def build_throughput_profiles_0884(rows):
    summary = {
        'topic_id': 'B04-RTS-0884',
...
def check_throughput_profiles_83(summary):
    flags = {
...
sample_rows = [1.08, 1.33, 1.58, 1.83, 2.08]
summary = build_throughput_profiles_0884(sample_rows)
flags = check_throughput_profiles_83(summary)
print(summary)
print(flags)
