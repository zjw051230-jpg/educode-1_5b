...
def build_throughput_profiles_0885(rows):
    summary = {
        'topic_id': 'B04-RTS-0885',
...
def check_throughput_profiles_84(summary):
    flags = {
...
summary = build_throughput_profiles_0885(sample_rows)
flags = check_throughput_profiles_84(summary)
print(summary)
print(flags)
