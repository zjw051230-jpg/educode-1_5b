...
def build_throughput_profiles_0886(rows):
    summary = {
        'topic_id': 'B04-RTS-0886',
...
def check_throughput_profiles_85(summary):
    flags = {
...
summary = build_throughput_profiles_0886(sample_rows)
flags = check_throughput_profiles_85(summary)
print(summary)
print(flags)
