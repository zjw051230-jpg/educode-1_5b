...
def build_throughput_profiles_0888(rows):
    summary = {
        'topic_id': 'B04-RTS-0888',
...
def check_throughput_profiles_87(summary):
    flags = {
...
sample_rows = [1.52, 1.77, 2.02, 2.27, 2.52]
summary = build_throughput_profiles_0888(sample_rows)
flags = check_throughput_profiles_87(summary)
print(summary)
print(flags)
