...
def build_throughput_profiles_0890(rows):
    summary = {
        'topic_id': 'B04-RTS-0890',
...
def check_throughput_profiles_89(summary):
    flags = {
...
sample_rows = [1.74, 1.99, 2.24, 2.49, 2.74]
summary = build_throughput_profiles_0890(sample_rows)
flags = check_throughput_profiles_89(summary)
print(summary)
print(flags)
