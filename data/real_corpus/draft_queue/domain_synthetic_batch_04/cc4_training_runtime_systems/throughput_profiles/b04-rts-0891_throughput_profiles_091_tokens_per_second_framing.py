...
def build_throughput_profiles_0891(rows):
    summary = {
        'topic_id': 'B04-RTS-0891',
...
def check_throughput_profiles_90(summary):
    flags = {
...
sample_rows = [1.85, 2.1, 2.35, 2.6, 2.85]
summary = build_throughput_profiles_0891(sample_rows)
flags = check_throughput_profiles_90(summary)
print(summary)
print(flags)
