...
def build_throughput_profiles_0892(rows):
    summary = {
        'topic_id': 'B04-RTS-0892',
...
def check_throughput_profiles_91(summary):
    flags = {
...
sample_rows = [1.96, 2.21, 2.46, 2.71, 2.96]
summary = build_throughput_profiles_0892(sample_rows)
flags = check_throughput_profiles_91(summary)
print(summary)
print(flags)
