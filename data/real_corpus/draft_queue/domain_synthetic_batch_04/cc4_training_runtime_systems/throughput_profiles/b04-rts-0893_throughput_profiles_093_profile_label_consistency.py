...
def build_throughput_profiles_0893(rows):
    summary = {
        'topic_id': 'B04-RTS-0893',
...
def check_throughput_profiles_92(summary):
    flags = {
...
sample_rows = [2.07, 2.32, 2.57, 2.82, 3.07]
summary = build_throughput_profiles_0893(sample_rows)
flags = check_throughput_profiles_92(summary)
print(summary)
print(flags)
