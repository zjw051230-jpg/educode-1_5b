...
def build_throughput_profiles_0894(rows):
    summary = {
        'topic_id': 'B04-RTS-0894',
...
def check_throughput_profiles_93(summary):
    flags = {
...
sample_rows = [2.18, 2.43, 2.68, 2.93, 3.18]
summary = build_throughput_profiles_0894(sample_rows)
flags = check_throughput_profiles_93(summary)
print(summary)
print(flags)
