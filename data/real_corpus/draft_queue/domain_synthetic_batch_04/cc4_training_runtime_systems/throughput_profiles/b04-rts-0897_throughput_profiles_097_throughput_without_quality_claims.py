...
def build_throughput_profiles_0897(rows):
    summary = {
        'topic_id': 'B04-RTS-0897',
...
def check_throughput_profiles_96(summary):
    flags = {
...
sample_rows = [2.51, 2.76, 3.01, 3.26, 3.51]
summary = build_throughput_profiles_0897(sample_rows)
flags = check_throughput_profiles_96(summary)
print(summary)
print(flags)
