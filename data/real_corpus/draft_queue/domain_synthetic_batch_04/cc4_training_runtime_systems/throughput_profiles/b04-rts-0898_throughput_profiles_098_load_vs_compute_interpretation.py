...
def build_throughput_profiles_0898(rows):
    summary = {
        'topic_id': 'B04-RTS-0898',
...
def check_throughput_profiles_97(summary):
    flags = {
...
sample_rows = [2.62, 2.87, 3.12, 3.37, 3.62]
summary = build_throughput_profiles_0898(sample_rows)
flags = check_throughput_profiles_97(summary)
print(summary)
print(flags)
