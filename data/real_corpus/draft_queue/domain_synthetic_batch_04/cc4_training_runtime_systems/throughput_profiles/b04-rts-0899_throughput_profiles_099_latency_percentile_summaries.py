...
def build_throughput_profiles_0899(rows):
    summary = {
        'topic_id': 'B04-RTS-0899',
...
def check_throughput_profiles_98(summary):
    flags = {
...
sample_rows = [2.73, 2.98, 3.23, 3.48, 3.73]
summary = build_throughput_profiles_0899(sample_rows)
flags = check_throughput_profiles_98(summary)
print(summary)
print(flags)
