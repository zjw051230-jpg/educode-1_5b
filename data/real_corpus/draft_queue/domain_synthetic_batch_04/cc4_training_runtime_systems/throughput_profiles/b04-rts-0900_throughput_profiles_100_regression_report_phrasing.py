...
def build_throughput_profiles_0900(rows):
    summary = {
        'topic_id': 'B04-RTS-0900',
...
def check_throughput_profiles_99(summary):
    flags = {
...
sample_rows = [2.84, 3.09, 3.34, 3.59, 3.84]
summary = build_throughput_profiles_0900(sample_rows)
flags = check_throughput_profiles_99(summary)
print(summary)
print(flags)
