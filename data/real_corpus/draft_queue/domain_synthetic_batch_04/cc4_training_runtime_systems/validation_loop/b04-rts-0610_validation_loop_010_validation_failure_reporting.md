...
# Validation Failure Reporting Naming Notes

## Concept
Validation failure reporting is the main teaching target for this draft candidate.
...
## Explanation
Example index 610 uses a narrow lens: validation failure reporting.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0610.
The reviewer opens a validation_loop artifact and asks whether the primary signal for validation failure reporting is present.
...
## Review Notes
This file exists to teach one distinct review target: validation failure reporting.
