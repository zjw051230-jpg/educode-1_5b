...
# Validation Artifact Hooks Minimal Review Flow

## Concept
Validation artifact hooks is the main teaching target for this draft candidate.
...
## Explanation
Example index 626 uses a narrow lens: validation artifact hooks.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0626.
The reviewer opens a validation_loop artifact and asks whether the primary signal for validation artifact hooks is present.
...
## Review Notes
This file exists to teach one distinct review target: validation artifact hooks.
