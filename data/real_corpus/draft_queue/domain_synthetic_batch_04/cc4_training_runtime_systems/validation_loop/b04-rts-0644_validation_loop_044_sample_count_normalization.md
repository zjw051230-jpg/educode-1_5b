...
# Sample-Count Normalization Audit Cues

## Concept
Sample-count normalization is the main teaching target for this draft candidate.
...
## Explanation
Example index 644 uses a narrow lens: sample-count normalization.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0644.
The reviewer opens a validation_loop artifact and asks whether the primary signal for sample-count normalization is present.
...
## Review Notes
This file exists to teach one distinct review target: sample-count normalization.
