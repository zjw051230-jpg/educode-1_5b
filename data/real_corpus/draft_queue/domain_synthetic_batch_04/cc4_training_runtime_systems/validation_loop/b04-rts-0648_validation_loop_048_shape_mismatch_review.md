...
# Shape Mismatch Review Pass Criteria

## Concept
Shape mismatch review is the main teaching target for this draft candidate.
...
## Explanation
Example index 648 uses a narrow lens: shape mismatch review.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0648.
The reviewer opens a validation_loop artifact and asks whether the primary signal for shape mismatch review is present.
...
## Review Notes
This file exists to teach one distinct review target: shape mismatch review.
