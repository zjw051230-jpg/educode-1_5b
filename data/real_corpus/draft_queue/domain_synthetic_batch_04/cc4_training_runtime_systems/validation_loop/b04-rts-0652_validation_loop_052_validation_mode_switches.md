...
# Validation Mode Switches Failure Patterns

## Concept
Validation mode switches is the main teaching target for this draft candidate.
...
## Explanation
Example index 652 uses a narrow lens: validation mode switches.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0652.
The reviewer opens a validation_loop artifact and asks whether the primary signal for validation mode switches is present.
...
## Review Notes
This file exists to teach one distinct review target: validation mode switches.
