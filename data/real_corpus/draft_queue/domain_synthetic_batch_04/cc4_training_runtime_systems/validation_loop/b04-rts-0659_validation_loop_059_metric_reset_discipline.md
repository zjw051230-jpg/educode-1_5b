...
# Metric Reset Discipline Summary Design

## Concept
Metric reset discipline is the main teaching target for this draft candidate.
...
## Explanation
Example index 659 uses a narrow lens: metric reset discipline.
...
## Minimal Example
Imagine a bounded run note for topic B04-RTS-0659.
The reviewer opens a validation_loop artifact and asks whether the primary signal for metric reset discipline is present.
...
## Review Notes
This file exists to teach one distinct review target: metric reset discipline.
