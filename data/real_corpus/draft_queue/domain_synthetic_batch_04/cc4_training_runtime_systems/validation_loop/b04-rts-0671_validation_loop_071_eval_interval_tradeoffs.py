...
def build_validation_loop_0671(rows):
    summary = {
        'topic_id': 'B04-RTS-0671',
        'focus': 'eval interval tradeoffs',
        'row_count': len(rows),
...
def check_validation_loop_70(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'eval interval tradeoffs',
    }
...
summary = build_validation_loop_0671(sample_rows)
flags = check_validation_loop_70(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates eval interval tradeoffs.
