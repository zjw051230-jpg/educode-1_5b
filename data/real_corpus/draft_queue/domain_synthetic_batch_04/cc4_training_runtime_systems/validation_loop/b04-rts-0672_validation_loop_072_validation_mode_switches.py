...
def build_validation_loop_0672(rows):
    summary = {
        'topic_id': 'B04-RTS-0672',
...
def check_validation_loop_71(summary):
    flags = {
...
sample_rows = [1.86, 2.11, 2.36, 2.61, 2.86]
summary = build_validation_loop_0672(sample_rows)
flags = check_validation_loop_71(summary)
print(summary)
print(flags)
