...
def build_validation_loop_0673(rows):
    summary = {
        'topic_id': 'B04-RTS-0673',
...
def check_validation_loop_72(summary):
    flags = {
...
sample_rows = [1.97, 2.22, 2.47, 2.72, 2.97]
summary = build_validation_loop_0673(sample_rows)
flags = check_validation_loop_72(summary)
print(summary)
print(flags)
