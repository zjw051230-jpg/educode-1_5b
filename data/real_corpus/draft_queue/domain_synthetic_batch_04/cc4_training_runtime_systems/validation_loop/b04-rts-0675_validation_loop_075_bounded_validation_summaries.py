...
def build_validation_loop_0675(rows):
    summary = {
        'topic_id': 'B04-RTS-0675',
...
def check_validation_loop_74(summary):
    flags = {
...
sample_rows = [2.19, 2.44, 2.69, 2.94, 3.19]
summary = build_validation_loop_0675(sample_rows)
flags = check_validation_loop_74(summary)
print(summary)
print(flags)
