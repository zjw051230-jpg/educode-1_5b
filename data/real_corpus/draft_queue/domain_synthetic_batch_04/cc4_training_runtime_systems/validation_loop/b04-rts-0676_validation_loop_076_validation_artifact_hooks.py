...
def build_validation_loop_0676(rows):
    summary = {
        'topic_id': 'B04-RTS-0676',
...
def check_validation_loop_75(summary):
    flags = {
...
sample_rows = [2.3, 2.55, 2.8, 3.05, 3.3]
summary = build_validation_loop_0676(sample_rows)
flags = check_validation_loop_75(summary)
print(summary)
print(flags)
