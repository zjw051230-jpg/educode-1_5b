...
def build_validation_loop_0678(rows):
    summary = {
        'topic_id': 'B04-RTS-0678',
...
def check_validation_loop_77(summary):
    flags = {
...
summary = build_validation_loop_0678(sample_rows)
flags = check_validation_loop_77(summary)
print(summary)
print(flags)
