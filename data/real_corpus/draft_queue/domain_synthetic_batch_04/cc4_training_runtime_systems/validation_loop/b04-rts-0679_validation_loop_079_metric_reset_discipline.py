...
def build_validation_loop_0679(rows):
    summary = {
        'topic_id': 'B04-RTS-0679',
...
def check_validation_loop_78(summary):
    flags = {
...
sample_rows = [2.63, 2.88, 3.13, 3.38, 3.63]
summary = build_validation_loop_0679(sample_rows)
flags = check_validation_loop_78(summary)
print(summary)
print(flags)
