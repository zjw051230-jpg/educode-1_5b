...
def build_validation_loop_0681(rows):
    summary = {
        'topic_id': 'B04-RTS-0681',
...
def check_validation_loop_80(summary):
    flags = {
...
summary = build_validation_loop_0681(sample_rows)
flags = check_validation_loop_80(summary)
print(summary)
print(flags)
