...
def build_validation_loop_0682(rows):
    summary = {
        'topic_id': 'B04-RTS-0682',
...
def check_validation_loop_81(summary):
    flags = {
...
summary = build_validation_loop_0682(sample_rows)
flags = check_validation_loop_81(summary)
print(summary)
print(flags)
