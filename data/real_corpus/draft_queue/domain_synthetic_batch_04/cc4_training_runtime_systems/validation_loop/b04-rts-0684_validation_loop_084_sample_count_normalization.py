...
def build_validation_loop_0684(rows):
    summary = {
        'topic_id': 'B04-RTS-0684',
...
def check_validation_loop_83(summary):
    flags = {
...
summary = build_validation_loop_0684(sample_rows)
flags = check_validation_loop_83(summary)
print(summary)
print(flags)
