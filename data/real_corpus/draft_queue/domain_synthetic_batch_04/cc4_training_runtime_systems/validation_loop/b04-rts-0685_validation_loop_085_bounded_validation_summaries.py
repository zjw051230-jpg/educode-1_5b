...
def build_validation_loop_0685(rows):
    summary = {
        'topic_id': 'B04-RTS-0685',
        'focus': 'bounded validation summaries',
        'row_count': len(rows),
...
def check_validation_loop_84(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'bounded validation summaries',
    }
...
summary = build_validation_loop_0685(sample_rows)
flags = check_validation_loop_84(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates bounded validation summaries.
