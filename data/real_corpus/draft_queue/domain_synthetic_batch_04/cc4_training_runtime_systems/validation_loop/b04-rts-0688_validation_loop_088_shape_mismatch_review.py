...
def build_validation_loop_0688(rows):
    summary = {
        'topic_id': 'B04-RTS-0688',
...
def check_validation_loop_87(summary):
    flags = {
...
summary = build_validation_loop_0688(sample_rows)
flags = check_validation_loop_87(summary)
print(summary)
print(flags)
