...
def build_validation_loop_0689(rows):
    summary = {
        'topic_id': 'B04-RTS-0689',
...
def check_validation_loop_88(summary):
    flags = {
...
summary = build_validation_loop_0689(sample_rows)
flags = check_validation_loop_88(summary)
print(summary)
print(flags)
