...
def build_validation_loop_0690(rows):
    summary = {
        'topic_id': 'B04-RTS-0690',
        'focus': 'validation failure reporting',
        'row_count': len(rows),
...
def check_validation_loop_89(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'validation failure reporting',
    }
...
summary = build_validation_loop_0690(sample_rows)
flags = check_validation_loop_89(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates validation failure reporting.
