...
def build_validation_loop_0691(rows):
    summary = {
        'topic_id': 'B04-RTS-0691',
...
def check_validation_loop_90(summary):
    flags = {
...
summary = build_validation_loop_0691(sample_rows)
flags = check_validation_loop_90(summary)
print(summary)
print(flags)
