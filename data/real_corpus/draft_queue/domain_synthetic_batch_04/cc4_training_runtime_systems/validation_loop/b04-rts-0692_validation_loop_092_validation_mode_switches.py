...
def build_validation_loop_0692(rows):
    summary = {
        'topic_id': 'B04-RTS-0692',
        'focus': 'validation mode switches',
        'row_count': len(rows),
...
def check_validation_loop_91(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'validation mode switches',
    }
...
summary = build_validation_loop_0692(sample_rows)
flags = check_validation_loop_91(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates validation mode switches.
