...
def build_validation_loop_0693(rows):
    summary = {
        'topic_id': 'B04-RTS-0693',
...
def check_validation_loop_92(summary):
    flags = {
...
summary = build_validation_loop_0693(sample_rows)
flags = check_validation_loop_92(summary)
print(summary)
print(flags)
