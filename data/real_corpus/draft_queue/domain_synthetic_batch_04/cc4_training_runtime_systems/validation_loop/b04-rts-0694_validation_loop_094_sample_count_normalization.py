...
def build_validation_loop_0694(rows):
    summary = {
        'topic_id': 'B04-RTS-0694',
...
def check_validation_loop_93(summary):
    flags = {
...
summary = build_validation_loop_0694(sample_rows)
flags = check_validation_loop_93(summary)
print(summary)
print(flags)
