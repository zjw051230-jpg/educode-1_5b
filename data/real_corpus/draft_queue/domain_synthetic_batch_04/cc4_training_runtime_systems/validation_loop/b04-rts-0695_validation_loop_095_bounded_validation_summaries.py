...
def build_validation_loop_0695(rows):
    summary = {
        'topic_id': 'B04-RTS-0695',
...
def check_validation_loop_94(summary):
    flags = {
...
summary = build_validation_loop_0695(sample_rows)
flags = check_validation_loop_94(summary)
print(summary)
print(flags)
