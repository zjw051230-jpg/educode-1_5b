...
def build_validation_loop_0696(rows):
    summary = {
        'topic_id': 'B04-RTS-0696',
...
def check_validation_loop_95(summary):
    flags = {
...
sample_rows = [2.8, 3.05, 3.3, 3.55, 3.8]
summary = build_validation_loop_0696(sample_rows)
flags = check_validation_loop_95(summary)
print(summary)
print(flags)
