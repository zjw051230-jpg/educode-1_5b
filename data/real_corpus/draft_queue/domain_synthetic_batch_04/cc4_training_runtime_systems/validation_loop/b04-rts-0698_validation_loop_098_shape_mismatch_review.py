...
def build_validation_loop_0698(rows):
    summary = {
        'topic_id': 'B04-RTS-0698',
        'focus': 'shape mismatch review',
        'row_count': len(rows),
...
def check_validation_loop_97(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'shape mismatch review',
    }
...
summary = build_validation_loop_0698(sample_rows)
flags = check_validation_loop_97(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates shape mismatch review.
