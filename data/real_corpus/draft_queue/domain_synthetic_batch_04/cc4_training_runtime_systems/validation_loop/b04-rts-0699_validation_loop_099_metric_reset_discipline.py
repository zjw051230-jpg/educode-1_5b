...
def build_validation_loop_0699(rows):
    summary = {
        'topic_id': 'B04-RTS-0699',
        'focus': 'metric reset discipline',
        'row_count': len(rows),
...
def check_validation_loop_98(summary):
    flags = {
        'has_rows': summary['row_count'] > 0,
        'range_known': 'min_value' in summary and 'max_value' in summary,
        'focus_matches': summary['focus'] == 'metric reset discipline',
    }
...
summary = build_validation_loop_0699(sample_rows)
flags = check_validation_loop_98(summary)
print(summary)
print(flags)

# Teaching note:
# This example demonstrates metric reset discipline.
