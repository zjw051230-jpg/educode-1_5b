...
def build_validation_loop_0700(rows):
    summary = {
        'topic_id': 'B04-RTS-0700',
...
def check_validation_loop_99(summary):
    flags = {
...
summary = build_validation_loop_0700(sample_rows)
flags = check_validation_loop_99(summary)
print(summary)
print(flags)
