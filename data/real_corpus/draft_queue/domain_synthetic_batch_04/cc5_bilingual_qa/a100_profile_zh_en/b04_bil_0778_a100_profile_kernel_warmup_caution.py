...
"""A100 Profiling and CUDA Memory 78: Kernel Warmup Caution

ZH: warmup 对 profile 读数有何影响。
...
def build_demo_rows() -> List[Dict[str, object]]:
    ...
    return [
        {
            "topic_id": "B04-BIL-0778",
            "group_theme": "A100 Profiling and CUDA Memory",
            "variant": "kernel warmup caution",
...
# - 这个 Python 片段围绕 kernel warmup caution 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around kernel warmup caution.
