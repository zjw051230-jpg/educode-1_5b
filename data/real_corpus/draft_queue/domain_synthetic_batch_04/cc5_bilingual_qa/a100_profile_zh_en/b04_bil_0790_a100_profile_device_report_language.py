...
"""A100 Profiling and CUDA Memory 90: Device Report Language
    ...
    return [
        {
            ...
            "variant": "device report language",
...
# - 这个 Python 片段围绕 device report language 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around device report language.
