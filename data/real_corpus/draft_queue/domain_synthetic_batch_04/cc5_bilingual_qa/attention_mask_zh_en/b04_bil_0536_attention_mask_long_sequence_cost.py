...
"""Attention Masks and Logits 36: Long Sequence Cost

ZH: 长序列为什么会放大 mask 成本。
...
# - 这个 Python 片段围绕 long sequence cost 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around long sequence cost.
