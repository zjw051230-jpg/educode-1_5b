...
"""Attention Masks and Logits 54: Softmax Axis Intuition

ZH: attention softmax 轴选错会怎样。
...
def build_demo_rows() -> List[Dict[str, object]]:
    ...
    return [
        {
            "topic_id": "B04-BIL-0554",
            "group_theme": "Attention Masks and Logits",
            "variant": "softmax axis intuition",
...
# - 这个 Python 片段围绕 softmax axis intuition 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around softmax axis intuition.
