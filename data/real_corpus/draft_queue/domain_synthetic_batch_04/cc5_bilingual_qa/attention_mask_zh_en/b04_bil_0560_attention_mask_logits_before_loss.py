...
"""Attention Masks and Logits 60: Logits Before Loss

ZH: 计算 loss 前 logits 应该长什么样。
...
# - 这个 Python 片段围绕 logits before loss 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around logits before loss.
