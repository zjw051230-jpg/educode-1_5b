...
"""Attention Masks and Logits 72: Mask Shape Layout

ZH: attention mask 的 shape 应该怎样想。
...
# - 这个 Python 片段围绕 mask shape layout 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around mask shape layout.
