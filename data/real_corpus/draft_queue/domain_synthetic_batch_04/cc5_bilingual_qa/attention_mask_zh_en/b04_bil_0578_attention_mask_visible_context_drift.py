...
"""Attention Masks and Logits 78: Visible Context Drift
...
# - 这个 Python 片段围绕 visible context drift 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around visible context drift.
