...
"""BPE Merge Rules and Vocabulary Growth 12: Merge Competition

ZH: 中英文片段在 merge 竞争里会发生什么。
...
# - 这个 Python 片段围绕 merge competition 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around merge competition.
