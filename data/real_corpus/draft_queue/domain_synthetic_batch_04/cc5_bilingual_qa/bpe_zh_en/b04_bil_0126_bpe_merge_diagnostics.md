...
# BPE Merge Rules and Vocabulary Growth 26: Merge Diagnostics
...
## Explanation
Q: 如果我只从表面文本看，为什么容易误判 merge diagnostics？
EN: Why is merge diagnostics easy to misread if I only inspect the visible text?
...
## Minimal Example
Q: 能给一个围绕 merge diagnostics 的小例子吗？
EN: Can you give a small example around merge diagnostics?
...
## Common Pitfalls
- 把 merge diagnostics 的现象当成模型质量结论，而不是草稿级观察。
- Treating merge diagnostics as a model-quality conclusion instead of a draft-level observation.
