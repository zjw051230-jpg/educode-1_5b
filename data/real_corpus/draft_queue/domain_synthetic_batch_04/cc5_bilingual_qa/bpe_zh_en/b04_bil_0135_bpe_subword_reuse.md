...
# BPE Merge Rules and Vocabulary Growth 35: Subword Reuse

## Concept
Q: 子词复用如何帮助 mixed domain 样本？
EN: how subword reuse helps mixed-domain samples?
...
## Explanation
Q: 如果我只从表面文本看，为什么容易误判 subword reuse？
EN: Why is subword reuse easy to misread if I only inspect the visible text?
...
## Minimal Example
Q: 能给一个围绕 subword reuse 的小例子吗？
EN: Can you give a small example around subword reuse?
...
## Common Pitfalls
- 把 subword reuse 的现象当成模型质量结论，而不是草稿级观察。
- Treating subword reuse as a model-quality conclusion instead of a draft-level observation.
