...
"""BPE Merge Rules and Vocabulary Growth 48: Byte To Merge Ladder

ZH: 从 byte 到 merge 的层级直觉是什么。
...
# - 这个 Python 片段围绕 byte to merge ladder 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around byte to merge ladder.
