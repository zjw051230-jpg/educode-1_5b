...
# BPE Merge Rules and Vocabulary Growth 59: Merge Review Cues

## Concept
Q: 人工 review merge 结果时看什么？
EN: what to inspect when reviewing merge outcomes?
...
## Explanation
Q: 如果我只从表面文本看，为什么容易误判 merge review cues？
EN: Why is merge review cues easy to misread if I only inspect the visible text?
...
## Minimal Example
Q: 能给一个围绕 merge review cues 的小例子吗？
EN: Can you give a small example around merge review cues?
...
## Common Pitfalls
- 把 merge review cues 的现象当成模型质量结论，而不是草稿级观察。
- Treating merge review cues as a model-quality conclusion instead of a draft-level observation.
