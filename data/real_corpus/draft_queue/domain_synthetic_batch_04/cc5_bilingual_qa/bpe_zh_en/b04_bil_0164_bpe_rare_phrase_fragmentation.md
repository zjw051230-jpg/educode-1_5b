...
# BPE Merge Rules and Vocabulary Growth 64: Rare Phrase Fragmentation

## Concept
Q: 稀有短语为什么更容易保持碎片化？
EN: why rare phrases stay fragmented?
...
## Explanation
Q: 如果我只从表面文本看，为什么容易误判 rare phrase fragmentation？
EN: Why is rare phrase fragmentation easy to misread if I only inspect the visible text?
...
## Minimal Example
Q: 能给一个围绕 rare phrase fragmentation 的小例子吗？
EN: Can you give a small example around rare phrase fragmentation?
...
## Common Pitfalls
- 把 rare phrase fragmentation 的现象当成模型质量结论，而不是草稿级观察。
- Treating rare phrase fragmentation as a model-quality conclusion instead of a draft-level observation.
