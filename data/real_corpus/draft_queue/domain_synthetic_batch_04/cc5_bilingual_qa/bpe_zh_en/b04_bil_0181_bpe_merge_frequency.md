...
# BPE Merge Rules and Vocabulary Growth 81: Merge Frequency

## Concept
Q: 高频 merge 为什么会先学习局部模式？
EN: why high-frequency merges learn local patterns first?
...
## Explanation
Q: 如果我只从表面文本看，为什么容易误判 merge frequency？
EN: Why is merge frequency easy to misread if I only inspect the visible text?
...
## Minimal Example
Q: 能给一个围绕 merge frequency 的小例子吗？
EN: Can you give a small example around merge frequency?
...
## Common Pitfalls
- 把 merge frequency 的现象当成模型质量结论，而不是草稿级观察。
- Treating merge frequency as a model-quality conclusion instead of a draft-level observation.
