...
# BPE Merge Rules and Vocabulary Growth 82: Merge Competition

## Concept
Q: 中英文片段在 merge 竞争里会发生什么？
EN: what happens when Chinese and English pieces compete for merges?
...
## Explanation
Q: 如果我只从表面文本看，为什么容易误判 merge competition？
EN: Why is merge competition easy to misread if I only inspect the visible text?
...
## Minimal Example
Q: 能给一个围绕 merge competition 的小例子吗？
EN: Can you give a small example around merge competition?
...
## Common Pitfalls
- 把 merge competition 的现象当成模型质量结论，而不是草稿级观察。
- Treating merge competition as a model-quality conclusion instead of a draft-level observation.
