...
"""BPE Merge Rules and Vocabulary Growth 84: Rare Phrase Fragmentation
    ...
    return [
        {
            ...
            "variant": "rare phrase fragmentation",
...
# - 这个 Python 片段围绕 rare phrase fragmentation 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around rare phrase fragmentation.
