...
"""BPE Merge Rules and Vocabulary Growth 90: Vocab Budget Tradeoff

ZH: 有限 vocab budget 如何分配给双语样本。
...
# - 这个 Python 片段围绕 vocab budget tradeoff 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around vocab budget tradeoff.
