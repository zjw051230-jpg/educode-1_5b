...
# BPE Merge Rules and Vocabulary Growth 93: Merge Saturation

## Concept
Q: merge 数增加到一定程度后收益为何变小？
EN: why extra merges give diminishing returns?
...
## Explanation
Q: 如果我只从表面文本看，为什么容易误判 merge saturation？
EN: Why is merge saturation easy to misread if I only inspect the visible text?
...
## Minimal Example
Q: 能给一个围绕 merge saturation 的小例子吗？
EN: Can you give a small example around merge saturation?
...
## Common Pitfalls
- 把 merge saturation 的现象当成模型质量结论，而不是草稿级观察。
- Treating merge saturation as a model-quality conclusion instead of a draft-level observation.
