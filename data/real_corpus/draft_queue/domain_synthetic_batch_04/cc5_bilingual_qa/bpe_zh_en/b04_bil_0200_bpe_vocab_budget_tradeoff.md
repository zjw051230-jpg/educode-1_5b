...
# BPE Merge Rules and Vocabulary Growth 100: Vocab Budget Tradeoff

## Concept
Q: 有限 vocab budget 如何分配给双语样本？
EN: how to allocate limited vocab budget in bilingual corpora?
...
## Explanation
Q: 如果我只从表面文本看，为什么容易误判 vocab budget tradeoff？
EN: Why is vocab budget tradeoff easy to misread if I only inspect the visible text?
...
## Minimal Example
Q: 能给一个围绕 vocab budget tradeoff 的小例子吗？
EN: Can you give a small example around vocab budget tradeoff?
...
## Common Pitfalls
- 把 vocab budget tradeoff 的现象当成模型质量结论，而不是草稿级观察。
- Treating vocab budget tradeoff as a model-quality conclusion instead of a draft-level observation.
