...
"""Checkpoint Reload and Experiment State 12: Optimizer State Importance
    ...
    return [
        {
            ...
            "variant": "optimizer state importance",
...
# - 这个 Python 片段围绕 optimizer state importance 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around optimizer state importance.
