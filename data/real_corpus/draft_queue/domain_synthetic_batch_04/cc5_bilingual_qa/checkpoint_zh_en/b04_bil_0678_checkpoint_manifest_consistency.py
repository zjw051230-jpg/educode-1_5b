...
"""Checkpoint Reload and Experiment State 78: Manifest Consistency

ZH: checkpoint manifest 不一致会怎样。
...
# - 这个 Python 片段围绕 manifest consistency 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around manifest consistency.
