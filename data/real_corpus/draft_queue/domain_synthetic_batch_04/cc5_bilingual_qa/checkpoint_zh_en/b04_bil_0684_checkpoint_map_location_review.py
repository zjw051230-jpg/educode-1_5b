...
"""Checkpoint Reload and Experiment State 84: Map Location Review

ZH: 为什么 reload review 常先放到 CPU。
...
# - 这个 Python 片段围绕 map location review 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around map location review.
