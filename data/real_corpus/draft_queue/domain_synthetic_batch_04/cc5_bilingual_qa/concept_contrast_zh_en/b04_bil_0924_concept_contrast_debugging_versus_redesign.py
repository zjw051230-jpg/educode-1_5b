...
"""Concept Contrasts and Evaluation Caution 24: Debugging Versus Redesign

ZH: 什么时候该调 bug 什么时候该改模板。
    ...
    return [
        {
            ...
            "variant": "debugging versus redesign",
...
# - 这个 Python 片段围绕 debugging versus redesign 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around debugging versus redesign.
# - 它不访问网络、不读写真实用户数据，也不运行训练。
# - It does not touch networks, real user data, or training execution.
# - 第 24 个局部样例强调 reviewer 应先看结构，再看表面措辞。
