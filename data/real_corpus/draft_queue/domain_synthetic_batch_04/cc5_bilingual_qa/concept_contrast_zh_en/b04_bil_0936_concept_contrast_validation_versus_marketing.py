...
"""Concept Contrasts and Evaluation Caution 36: Validation Versus Marketing
    ...
    return [
        {
            ...
            "variant": "validation versus marketing",
...
# - 这个 Python 片段围绕 validation versus marketing 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around validation versus marketing.
# - 它不访问网络、不读写真实用户数据，也不运行训练。
# - It does not touch networks, real user data, or training execution.
# - 第 36 个局部样例强调 reviewer 应先看结构，再看表面措辞。
