...
"""Concept Contrasts and Evaluation Caution 48: Metric Versus Sample Review

ZH: 为什么指标和样本 review 要一起看。
    ...
    return [
        {
            ...
            "variant": "metric versus sample review",
...
# - 这个 Python 片段围绕 metric versus sample review 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around metric versus sample review.
# - 它不访问网络、不读写真实用户数据，也不运行训练。
# - It does not touch networks, real user data, or training execution.
# - 第 48 个局部样例强调 reviewer 应先看结构，再看表面措辞。
