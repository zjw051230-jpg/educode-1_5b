...
"""Data Pipeline and JSONL Processing 72: Source Category Meaning

ZH: source_category 在 draft 阶段到底表达什么。
...
def build_demo_rows() -> List[Dict[str, object]]:
    ...
    return [
        {
            "topic_id": "B04-BIL-0872",
            "group_theme": "Data Pipeline and JSONL Processing",
            "variant": "source category meaning",
...
# - 这个 Python 片段围绕 source category meaning 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around source category meaning.
