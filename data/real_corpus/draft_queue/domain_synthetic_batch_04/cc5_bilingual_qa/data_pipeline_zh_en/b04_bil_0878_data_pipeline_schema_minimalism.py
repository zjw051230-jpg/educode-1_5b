...
"""Data Pipeline and JSONL Processing 78: Schema Minimalism

ZH: 双语问答 schema 为什么要克制。
...
# - 这个 Python 片段围绕 schema minimalism 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around schema minimalism.
