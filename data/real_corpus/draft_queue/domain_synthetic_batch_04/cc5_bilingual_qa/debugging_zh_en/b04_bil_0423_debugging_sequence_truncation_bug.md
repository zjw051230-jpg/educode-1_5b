...
# Debugging Tensor Shapes and Data Issues 23: Sequence Truncation Bug

## Concept
Q: 截断逻辑如何悄悄破坏 supervision？
EN: how truncation logic quietly breaks supervision?
...
## Explanation
Q: 如果我只从表面文本看，为什么容易误判 sequence truncation bug？
EN: Why is sequence truncation bug easy to misread if I only inspect the visible text?
...
## Minimal Example
Q: 能给一个围绕 sequence truncation bug 的小例子吗？
EN: Can you give a small example around sequence truncation bug?
...
## Common Pitfalls
- 把 sequence truncation bug 的现象当成模型质量结论，而不是草稿级观察。
- Treating sequence truncation bug as a model-quality conclusion instead of a draft-level observation.
