...
"""Debugging Tensor Shapes and Data Issues 36: Batch Collation

ZH: collation 阶段的 bug 为什么常伪装成模型问题。
...
# - 这个 Python 片段围绕 batch collation 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around batch collation.
