...
# Debugging Tensor Shapes and Data Issues 44: Padding Leak

## Concept
Q: padding 泄露进有效 loss 会怎样？
EN: what happens when padding leaks into effective loss?
...
## Explanation
Q: 如果我只从表面文本看，为什么容易误判 padding leak？
EN: Why is padding leak easy to misread if I only inspect the visible text?
...
## Minimal Example
Q: 能给一个围绕 padding leak 的小例子吗？
EN: Can you give a small example around padding leak?
...
## Common Pitfalls
- 把 padding leak 的现象当成模型质量结论，而不是草稿级观察。
- Treating padding leak as a model-quality conclusion instead of a draft-level observation.
