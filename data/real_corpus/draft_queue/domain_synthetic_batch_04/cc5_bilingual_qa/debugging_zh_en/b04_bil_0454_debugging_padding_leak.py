...
"""Debugging Tensor Shapes and Data Issues 54: Padding Leak

ZH: padding 泄露进有效 loss 会怎样。
...
# - 这个 Python 片段围绕 padding leak 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around padding leak.
