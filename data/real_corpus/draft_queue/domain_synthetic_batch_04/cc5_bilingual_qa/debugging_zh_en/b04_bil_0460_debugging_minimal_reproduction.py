...
"""Debugging Tensor Shapes and Data Issues 60: Minimal Reproduction

ZH: 为什么最小复现对双语数据排错特别有用。
...
# - 这个 Python 片段围绕 minimal reproduction 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around minimal reproduction.
