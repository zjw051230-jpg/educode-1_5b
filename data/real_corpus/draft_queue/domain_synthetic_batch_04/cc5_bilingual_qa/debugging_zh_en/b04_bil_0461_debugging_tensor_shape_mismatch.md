...
# Debugging Tensor Shapes and Data Issues 61: Tensor Shape Mismatch

## Concept
Q: tensor shape 不对时最先确认什么？
EN: what to confirm first in a tensor shape mismatch?
...
## Explanation
Q: 如果我只从表面文本看，为什么容易误判 tensor shape mismatch？
EN: Why is tensor shape mismatch easy to misread if I only inspect the visible text?
...
## Minimal Example
Q: 能给一个围绕 tensor shape mismatch 的小例子吗？
EN: Can you give a small example around tensor shape mismatch?
...
## Common Pitfalls
- 把 tensor shape mismatch 的现象当成模型质量结论，而不是草稿级观察。
- Treating tensor shape mismatch as a model-quality conclusion instead of a draft-level observation.
