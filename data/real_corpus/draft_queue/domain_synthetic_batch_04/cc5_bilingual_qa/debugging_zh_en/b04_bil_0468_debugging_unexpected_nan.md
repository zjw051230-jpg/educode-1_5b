...
# Debugging Tensor Shapes and Data Issues 68: Unexpected Nan
...
## Explanation
Q: 如果我只从表面文本看，为什么容易误判 unexpected nan？
EN: Why is unexpected nan easy to misread if I only inspect the visible text?
...
## Minimal Example
Q: 能给一个围绕 unexpected nan 的小例子吗？
EN: Can you give a small example around unexpected nan?
...
## Common Pitfalls
- 把 unexpected nan 的现象当成模型质量结论，而不是草稿级观察。
- Treating unexpected nan as a model-quality conclusion instead of a draft-level observation.
