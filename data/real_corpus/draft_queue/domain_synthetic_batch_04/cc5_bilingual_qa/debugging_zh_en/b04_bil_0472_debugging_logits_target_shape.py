...
"""Debugging Tensor Shapes and Data Issues 72: Logits Target Shape

ZH: logits 和 target 维度为何经常错一位。
...
# - 这个 Python 片段围绕 logits target shape 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around logits target shape.
