...
# Debugging Tensor Shapes and Data Issues 85: Mojibake Triage

## Concept
Q: 乱码和 shape bug 同时出现时怎么排查？
EN: how to triage mojibake and shape bugs together?
...
## Explanation
Q: 如果我只从表面文本看，为什么容易误判 mojibake triage？
EN: Why is mojibake triage easy to misread if I only inspect the visible text?
...
## Minimal Example
Q: 能给一个围绕 mojibake triage 的小例子吗？
EN: Can you give a small example around mojibake triage?
...
## Common Pitfalls
- 把 mojibake triage 的现象当成模型质量结论，而不是草稿级观察。
- Treating mojibake triage as a model-quality conclusion instead of a draft-level observation.
