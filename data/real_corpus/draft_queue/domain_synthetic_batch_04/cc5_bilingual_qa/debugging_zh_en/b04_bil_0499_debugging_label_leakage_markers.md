...
# Debugging Tensor Shapes and Data Issues 99: Label Leakage Markers

## Concept
Q: 如何发现模板标签被错误拼进答案？
EN: how to detect leaked template labels in targets?
...
## Explanation
Q: 如果我只从表面文本看，为什么容易误判 label leakage markers？
EN: Why is label leakage markers easy to misread if I only inspect the visible text?
...
## Minimal Example
Q: 能给一个围绕 label leakage markers 的小例子吗？
EN: Can you give a small example around label leakage markers?
...
## Common Pitfalls
- 把 label leakage markers 的现象当成模型质量结论，而不是草稿级观察。
- Treating label leakage markers as a model-quality conclusion instead of a draft-level observation.
