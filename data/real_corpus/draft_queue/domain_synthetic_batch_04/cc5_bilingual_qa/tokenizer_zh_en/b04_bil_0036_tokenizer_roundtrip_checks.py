...
"""Tokenizer Boundaries and Mixed Scripts 36: Roundtrip Checks

ZH: encode decode roundtrip 能发现什么。
...
# - 这个 Python 片段围绕 roundtrip checks 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around roundtrip checks.
