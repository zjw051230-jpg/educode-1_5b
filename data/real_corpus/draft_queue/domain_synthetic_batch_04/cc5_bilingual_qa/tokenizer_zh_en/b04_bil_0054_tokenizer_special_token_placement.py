...
"""Tokenizer Boundaries and Mixed Scripts 54: Special Token Placement

ZH: special token 放置不稳会带来什么问题。
    ...
    return [
        {
            ...
            "variant": "special token placement",
...
# - 这个 Python 片段围绕 special token placement 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around special token placement.
