...
"""Tokenizer Boundaries and Mixed Scripts 78: Term Preservation

ZH: 专业术语保留原文会影响 tokenizer 吗。
...
# - 这个 Python 片段围绕 term preservation 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around term preservation.
