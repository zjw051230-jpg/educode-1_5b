...
"""Training Loop Mechanics 12: Label Shift Alignment

ZH: label shift 为什么容易在问答模板里出错。
...
def build_demo_rows() -> List[Dict[str, object]]:
    ...
    return [
        {
            "topic_id": "B04-BIL-0212",
            "group_theme": "Training Loop Mechanics",
            "variant": "label shift alignment",
...
# - 这个 Python 片段围绕 label shift alignment 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around label shift alignment.
