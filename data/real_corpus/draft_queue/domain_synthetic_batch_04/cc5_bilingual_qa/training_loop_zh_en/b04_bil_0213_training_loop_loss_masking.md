...
# Training Loop Mechanics 13: Loss Masking

## Concept
Q: loss mask 如何避免把 padding 学进去？
EN: how loss masks avoid learning padding?
...
## Explanation
Q: 如果我只从表面文本看，为什么容易误判 loss masking？
EN: Why is loss masking easy to misread if I only inspect the visible text?
...
## Minimal Example
Q: 能给一个围绕 loss masking 的小例子吗？
EN: Can you give a small example around loss masking?
...
## Common Pitfalls
- 把 loss masking 的现象当成模型质量结论，而不是草稿级观察。
- Treating loss masking as a model-quality conclusion instead of a draft-level observation.
