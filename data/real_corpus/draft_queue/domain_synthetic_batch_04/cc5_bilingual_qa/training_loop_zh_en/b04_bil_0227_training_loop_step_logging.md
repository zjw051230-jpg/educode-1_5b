...
# Training Loop Mechanics 27: Step Logging

## Concept
Q: 每步日志最少需要记录哪些字段？
EN: which fields are minimally useful in per-step logs?
...
## Explanation
Q: 如果我只从表面文本看，为什么容易误判 step logging？
EN: Why is step logging easy to misread if I only inspect the visible text?
...
## Minimal Example
Q: 能给一个围绕 step logging 的小例子吗？
EN: Can you give a small example around step logging?
...
## Common Pitfalls
- 把 step logging 的现象当成模型质量结论，而不是草稿级观察。
- Treating step logging as a model-quality conclusion instead of a draft-level observation.
