...
"""Training Loop Mechanics 36: Grad Accumulation

ZH: 小显存下 grad accumulation 改变了什么。
...
# - 这个 Python 片段围绕 grad accumulation 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around grad accumulation.
