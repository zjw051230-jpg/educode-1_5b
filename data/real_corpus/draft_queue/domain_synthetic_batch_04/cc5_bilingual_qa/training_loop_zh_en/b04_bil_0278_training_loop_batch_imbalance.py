...
"""Training Loop Mechanics 78: Batch Imbalance

ZH: batch 中中英文比例波动如何影响训练观察。
...
# - 这个 Python 片段围绕 batch imbalance 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around batch imbalance.
