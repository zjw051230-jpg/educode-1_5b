...
"""Training Loop Mechanics 84: Backward Stability

ZH: backward 看到异常梯度时先查哪里。
...
# - 这个 Python 片段围绕 backward stability 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around backward stability.
