...
"""Validation and Overfitting Signals 36: Validation Wording Drift

ZH: 验证 prompt 风格变化会污染比较吗。
    ...
    return [
        {
            ...
            "variant": "validation wording drift",
...
# - 这个 Python 片段围绕 validation wording drift 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around validation wording drift.
