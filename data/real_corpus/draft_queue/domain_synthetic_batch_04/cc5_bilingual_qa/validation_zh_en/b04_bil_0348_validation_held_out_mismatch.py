...
"""Validation and Overfitting Signals 48: Held-Out Mismatch
...
# - 这个 Python 片段围绕 held-out mismatch 构造最小双语检查样例。
# - This Python snippet builds a tiny bilingual inspection example around held-out mismatch.
