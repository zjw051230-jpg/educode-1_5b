...
# Metrics Writer Review Note 006
...
In this variant, the secondary emphasis is **metrics writer**. That means the note should connect the main topic to one nearby concern, such as how a summary row is written, how a bounded validation loop stops, or how a tokenizer preview should be interpreted.
...
- Is the nearby concept `metrics writer` explained in concrete terms?
