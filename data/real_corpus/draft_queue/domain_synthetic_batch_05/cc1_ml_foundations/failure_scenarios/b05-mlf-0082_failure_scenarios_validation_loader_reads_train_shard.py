...
"""Validation Loader Reads a Train Shard.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Use a shard-routing failure to show how false validation wins are created.
...
DEFINITION = "Validation Loader Reads a Train Shard"
LEARNING_OBJECTIVE = "Use a shard-routing failure to show how false validation wins are created."
ANCHOR = "failure scenario"

def load_trace_0082():
    return [
        {"step": 1, "train_loss": 2.710, "val_loss": 2.870, "grad_norm": 3.030},
        {"step": 2, "train_loss": 2.830, "val_loss": 2.990, "grad_norm": 3.150},
        {"step": 3, "train_loss": 2.860, "val_loss": 3.020, "grad_norm": 3.180},
        {"step": 4, "train_loss": 2.980, "val_loss": 3.140, "grad_norm": 3.300},
    ]
