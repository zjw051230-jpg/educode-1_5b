...
"""Skipped Evaluation After a NaN Guard.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Show how a NaN guard can accidentally skip evaluation and create an optimistic report.
Writing form: bug-reproduction snippet. Concrete anchor: small pseudo-run log.
"""
...
DEFINITION = "Skipped Evaluation After a NaN Guard"
LEARNING_OBJECTIVE = "Show how a NaN guard can accidentally skip evaluation and create an optimistic report."
