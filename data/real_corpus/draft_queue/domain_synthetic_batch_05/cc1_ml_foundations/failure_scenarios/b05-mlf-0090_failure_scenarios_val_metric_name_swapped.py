...
"""Validation Metric Name Swapped.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Use a metric-name swap to show how dashboards can tell the wrong story with correct numbers.
Writing form: bug-reproduction snippet. Concrete anchor: debugging transcript.
"""
...
DEFINITION = "Validation Metric Name Swapped"
LEARNING_OBJECTIVE = "Use a metric-name swap to show how dashboards can tell the wrong story with correct numbers."
