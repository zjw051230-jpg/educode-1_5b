...
# Partial Resume Without Optimizer State

A failure scenario teaches more than a slogan when each symptom points toward a different wrong explanation first.
The learning objective is specific: Teach how partial resume failures create strange second-phase dynamics.
...
- focus: partial_resume_without_optimizer_state
...
The first trap in partial resume without optimizer state is to turn one scalar into a universal rule.
