...
"""Padding Side Flip Between Splits.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Use a padding-side mismatch to explain contradictory train and validation losses.
Writing form: bug-reproduction snippet. Concrete anchor: tensor shape.
"""
...
DEFINITION = "Padding Side Flip Between Splits"
LEARNING_OBJECTIVE = "Use a padding-side mismatch to explain contradictory train and validation losses."
ANCHOR = "tensor shape"

def load_trace_0093():
    return [
        {"step": 1, "train_loss": 2.350, "val_loss": 2.510, "grad_norm": 2.670},
        {"step": 2, "train_loss": 2.470, "val_loss": 2.630, "grad_norm": 2.790},
        {"step": 3, "train_loss": 2.590, "val_loss": 2.750, "grad_norm": 2.910},
        {"step": 4, "train_loss": 2.620, "val_loss": 2.780, "grad_norm": 2.940},
    ]
