...
"""Vanishing Update Under Saturation.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Show how activation saturation can shrink useful updates long before the loss visibly stalls.
Writing form: gradient-stat trace demo. Concrete anchor: numeric toy example.
"""
...
DEFINITION = "Vanishing Update Under Saturation"
LEARNING_OBJECTIVE = "Show how activation saturation can shrink useful updates long before the loss visibly stalls."
ANCHOR = "numeric toy example"

def load_trace_0062():
    return [
        {"step": 1, "train_loss": 2.850, "val_loss": 3.010, "grad_norm": 3.170},
        {"step": 2, "train_loss": 2.880, "val_loss": 3.040, "grad_norm": 3.200},
        {"step": 3, "train_loss": 3.000, "val_loss": 3.160, "grad_norm": 3.320},
        {"step": 4, "train_loss": 3.120, "val_loss": 3.280, "grad_norm": 3.440},
    ]
