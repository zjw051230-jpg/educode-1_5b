...
"""Gradient Noise Versus Signal.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Teach how to distinguish noisy gradients from gradients that are directionally useful.
Writing form: gradient-stat trace demo. Concrete anchor: before/after comparison.
"""
...
DEFINITION = "Gradient Noise Versus Signal"
LEARNING_OBJECTIVE = "Teach how to distinguish noisy gradients from gradients that are directionally useful."
ANCHOR = "before/after comparison"

def load_trace_0064():
    return [
        {"step": 1, "train_loss": 2.270, "val_loss": 2.430, "grad_norm": 2.590},
        {"step": 2, "train_loss": 2.390, "val_loss": 2.550, "grad_norm": 2.710},
        {"step": 3, "train_loss": 2.420, "val_loss": 2.580, "grad_norm": 2.740},
        {"step": 4, "train_loss": 2.540, "val_loss": 2.700, "grad_norm": 2.860},
    ]
