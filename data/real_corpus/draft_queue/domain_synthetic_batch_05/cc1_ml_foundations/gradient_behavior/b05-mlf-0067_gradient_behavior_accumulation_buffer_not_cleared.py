...
"""Accumulation Buffer Not Cleared.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Teach how uncleared accumulation buffers distort gradient magnitude across steps.
Writing form: gradient-stat trace demo. Concrete anchor: debugging transcript.
"""
...
DEFINITION = "Accumulation Buffer Not Cleared"
LEARNING_OBJECTIVE = "Teach how uncleared accumulation buffers distort gradient magnitude across steps."
ANCHOR = "debugging transcript"

def load_trace_0067():
    return [
        {"step": 1, "train_loss": 2.600, "val_loss": 2.760, "grad_norm": 2.920},
        {"step": 2, "train_loss": 2.720, "val_loss": 2.880, "grad_norm": 3.040},
        {"step": 3, "train_loss": 2.750, "val_loss": 2.910, "grad_norm": 3.070},
        {"step": 4, "train_loss": 2.870, "val_loss": 3.030, "grad_norm": 3.190},
    ]
