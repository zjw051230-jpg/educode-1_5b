...
"""One Layer Spikes Only.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Use per-layer traces to explain why one unstable layer matters even when the global norm looks ordinary.
...
DEFINITION = "One Layer Spikes Only"
LEARNING_OBJECTIVE = "Use per-layer traces to explain why one unstable layer matters even when the global norm looks ordinary."
ANCHOR = "numeric toy example"

def load_trace_0070():
    return [
        {"step": 1, "train_loss": 2.160, "val_loss": 2.320, "grad_norm": 2.480},
        {"step": 2, "train_loss": 2.280, "val_loss": 2.440, "grad_norm": 2.600},
        {"step": 3, "train_loss": 2.310, "val_loss": 2.470, "grad_norm": 2.630},
        {"step": 4, "train_loss": 2.430, "val_loss": 2.590, "grad_norm": 2.750},
    ]
