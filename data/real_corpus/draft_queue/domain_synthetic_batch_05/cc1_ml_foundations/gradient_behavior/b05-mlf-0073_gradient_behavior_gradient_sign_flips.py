...
Learning objective: Use sign-flip traces to explain oscillatory optimization behavior.
Writing form: gradient-stat trace demo. Concrete anchor: mini code trace.
"""
...
DEFINITION = "Gradient Sign Flips"
LEARNING_OBJECTIVE = "Use sign-flip traces to explain oscillatory optimization behavior."
