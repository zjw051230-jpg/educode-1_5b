...
"""Late-Step Norm Rebound.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Interpret a late-step norm rebound without confusing it with recovery.
Writing form: gradient-stat trace demo. Concrete anchor: metrics interpretation.
"""
...
DEFINITION = "Late-Step Norm Rebound"
LEARNING_OBJECTIVE = "Interpret a late-step norm rebound without confusing it with recovery."
ANCHOR = "metrics interpretation"

def load_trace_0078():
    return [
        {"step": 1, "train_loss": 2.240, "val_loss": 2.400, "grad_norm": 2.560},
        {"step": 2, "train_loss": 2.360, "val_loss": 2.520, "grad_norm": 2.680},
        {"step": 3, "train_loss": 2.480, "val_loss": 2.640, "grad_norm": 2.800},
        {"step": 4, "train_loss": 2.510, "val_loss": 2.670, "grad_norm": 2.830},
    ]
