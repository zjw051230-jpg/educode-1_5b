...
# Layerwise Trace Table

Instead of summarizing gradients in abstract terms, this file assembles the exact clues a reviewer would inspect.
The learning objective is specific: Use a layerwise trace table to teach which gradient clues deserve escalation.
This note is written as a evidence-first checklist and uses a decision checklist as the concrete anchor.

## Evidence before naming the bug
- topic_id: B05-MLF-0079
- subdirectory: gradient_behavior
- focus: layerwise_trace_table
...
The first trap in layerwise trace table is to turn one scalar into a universal rule.
