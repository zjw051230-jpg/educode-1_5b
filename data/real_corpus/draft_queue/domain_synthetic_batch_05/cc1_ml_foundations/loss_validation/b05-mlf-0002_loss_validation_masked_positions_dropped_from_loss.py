...
"""Masked Positions Dropped From Loss.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Show how excluding masked positions changes both the denominator and the interpretation of the reported loss.
Writing form: toy metric calculator. Concrete anchor: mini code trace.
"""
...
DEFINITION = "Masked Positions Dropped From Loss"
LEARNING_OBJECTIVE = "Show how excluding masked positions changes both the denominator and the interpretation of the reported loss."
ANCHOR = "mini code trace"

def load_trace_0002():
    return [
        {"step": 1, "train_loss": 2.410, "val_loss": 2.570, "grad_norm": 2.730},
        {"step": 2, "train_loss": 2.440, "val_loss": 2.600, "grad_norm": 2.760},
        {"step": 3, "train_loss": 2.560, "val_loss": 2.720, "grad_norm": 2.880},
        {"step": 4, "train_loss": 2.680, "val_loss": 2.840, "grad_norm": 3.000},
    ]
