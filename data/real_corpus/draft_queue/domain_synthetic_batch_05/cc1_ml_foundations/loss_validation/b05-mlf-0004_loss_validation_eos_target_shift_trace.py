...
"""EOS Target Shift Trace.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Use a target-shift trace to explain how an off-by-one target map inflates validation loss.
Writing form: toy metric calculator. Concrete anchor: tensor shape.
"""
...
DEFINITION = "EOS Target Shift Trace"
LEARNING_OBJECTIVE = "Use a target-shift trace to explain how an off-by-one target map inflates validation loss."
ANCHOR = "tensor shape"
