...
"""Per-Token Loss Table Reading.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Teach how to read a per-token loss table instead of collapsing everything into one scalar.
...
DEFINITION = "Per-Token Loss Table Reading"
LEARNING_OBJECTIVE = "Teach how to read a per-token loss table instead of collapsing everything into one scalar."
