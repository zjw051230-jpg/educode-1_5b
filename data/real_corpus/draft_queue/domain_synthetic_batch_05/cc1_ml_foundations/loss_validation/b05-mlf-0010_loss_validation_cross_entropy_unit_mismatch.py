...
"""Cross-Entropy Unit Mismatch.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Clarify how unit mismatches between logged metrics create false loss regressions.
Writing form: toy metric calculator. Concrete anchor: config snippet.
"""
...
DEFINITION = "Cross-Entropy Unit Mismatch"
LEARNING_OBJECTIVE = "Clarify how unit mismatches between logged metrics create false loss regressions."
ANCHOR = "config snippet"

def load_trace_0010():
    return [
        {"step": 1, "train_loss": 2.490, "val_loss": 2.650, "grad_norm": 2.810},
        {"step": 2, "train_loss": 2.610, "val_loss": 2.770, "grad_norm": 2.930},
        {"step": 3, "train_loss": 2.640, "val_loss": 2.800, "grad_norm": 2.960},
        {"step": 4, "train_loss": 2.760, "val_loss": 2.920, "grad_norm": 3.080},
    ]
