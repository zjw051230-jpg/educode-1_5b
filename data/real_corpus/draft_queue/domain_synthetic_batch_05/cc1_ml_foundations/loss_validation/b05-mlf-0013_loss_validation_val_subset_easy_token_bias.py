...
"""Validation Subset Easy Token Bias.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Explain how an easy-token-biased validation subset can make early checkpoints look misleadingly good.
Writing form: toy metric calculator. Concrete anchor: failure scenario.
"""
...
DEFINITION = "Validation Subset Easy Token Bias"
LEARNING_OBJECTIVE = "Explain how an easy-token-biased validation subset can make early checkpoints look misleadingly good."
ANCHOR = "failure scenario"

def load_trace_0013():
    return [
        {"step": 1, "train_loss": 2.820, "val_loss": 2.980, "grad_norm": 3.140},
        {"step": 2, "train_loss": 2.940, "val_loss": 3.100, "grad_norm": 3.260},
        {"step": 3, "train_loss": 2.970, "val_loss": 3.130, "grad_norm": 3.290},
        {"step": 4, "train_loss": 3.090, "val_loss": 3.250, "grad_norm": 3.410},
    ]
