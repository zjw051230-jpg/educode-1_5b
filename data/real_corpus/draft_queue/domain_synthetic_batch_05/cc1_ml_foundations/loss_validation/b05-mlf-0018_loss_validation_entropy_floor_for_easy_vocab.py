...
"""Entropy Floor for an Easy Vocabulary Slice.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Teach why a low loss on an easy vocabulary slice should not be treated as overall mastery.
Writing form: toy metric calculator. Concrete anchor: numeric toy example.
"""
...
DEFINITION = "Entropy Floor for an Easy Vocabulary Slice"
LEARNING_OBJECTIVE = "Teach why a low loss on an easy vocabulary slice should not be treated as overall mastery."
ANCHOR = "numeric toy example"

def load_trace_0018():
    return [
        {"step": 1, "train_loss": 2.570, "val_loss": 2.730, "grad_norm": 2.890},
        {"step": 2, "train_loss": 2.690, "val_loss": 2.850, "grad_norm": 3.010},
        {"step": 3, "train_loss": 2.810, "val_loss": 2.970, "grad_norm": 3.130},
        {"step": 4, "train_loss": 2.840, "val_loss": 3.000, "grad_norm": 3.160},
    ]
