...
"""Decay Starts Too Soon.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Teach how premature schedule decay can freeze a model before useful features are learned.
Writing form: hyperparameter sweep mini-simulator. Concrete anchor: metrics interpretation.
"""
...
DEFINITION = "Decay Starts Too Soon"
LEARNING_OBJECTIVE = "Teach how premature schedule decay can freeze a model before useful features are learned."
