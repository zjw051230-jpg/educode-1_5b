...
Learning objective: Teach how batch-size changes alter the safe learning-rate range.
...
DEFINITION = "Batch Size and Learning-Rate Coupling"
LEARNING_OBJECTIVE = "Teach how batch-size changes alter the safe learning-rate range."
ANCHOR = "before/after comparison"

def load_trace_0047():
    return [
        {"step": 1, "train_loss": 2.740, "val_loss": 2.900, "grad_norm": 3.060},
        {"step": 2, "train_loss": 2.770, "val_loss": 2.930, "grad_norm": 3.090},
        {"step": 3, "train_loss": 2.890, "val_loss": 3.050, "grad_norm": 3.210},
        {"step": 4, "train_loss": 3.010, "val_loss": 3.170, "grad_norm": 3.330},
    ]
