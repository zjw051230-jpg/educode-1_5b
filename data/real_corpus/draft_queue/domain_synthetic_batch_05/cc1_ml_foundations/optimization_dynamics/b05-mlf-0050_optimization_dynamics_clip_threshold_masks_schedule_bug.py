...
"""Clip Threshold Masks a Schedule Bug.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Show how gradient clipping can hide a bad schedule choice rather than solve it.
...
DEFINITION = "Clip Threshold Masks a Schedule Bug"
LEARNING_OBJECTIVE = "Show how gradient clipping can hide a bad schedule choice rather than solve it."
ANCHOR = "failure scenario"

def load_trace_0050():
    return [
        {"step": 1, "train_loss": 2.300, "val_loss": 2.460, "grad_norm": 2.620},
        {"step": 2, "train_loss": 2.330, "val_loss": 2.490, "grad_norm": 2.650},
        {"step": 3, "train_loss": 2.450, "val_loss": 2.610, "grad_norm": 2.770},
        {"step": 4, "train_loss": 2.570, "val_loss": 2.730, "grad_norm": 2.890},
    ]
