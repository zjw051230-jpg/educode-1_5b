...
"""Resume Run With a New Scheduler.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Teach how resumed runs can mislead when scheduler phase state no longer matches the optimizer history.
Writing form: hyperparameter sweep mini-simulator. Concrete anchor: failure scenario.
"""
...
DEFINITION = "Resume Run With a New Scheduler"
LEARNING_OBJECTIVE = "Teach how resumed runs can mislead when scheduler phase state no longer matches the optimizer history."
ANCHOR = "failure scenario"

def load_trace_0053():
    return [
        {"step": 1, "train_loss": 2.630, "val_loss": 2.790, "grad_norm": 2.950},
        {"step": 2, "train_loss": 2.660, "val_loss": 2.820, "grad_norm": 2.980},
        {"step": 3, "train_loss": 2.780, "val_loss": 2.940, "grad_norm": 3.100},
        {"step": 4, "train_loss": 2.900, "val_loss": 3.060, "grad_norm": 3.220},
    ]
