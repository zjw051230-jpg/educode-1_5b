...
"""Scheduler Step Every Batch Versus Every Epoch.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Use a configuration comparison to show how scheduler cadence changes the run trajectory.
Writing form: hyperparameter sweep mini-simulator. Concrete anchor: config snippet.
"""
...
DEFINITION = "Scheduler Step Every Batch Versus Every Epoch"
LEARNING_OBJECTIVE = "Use a configuration comparison to show how scheduler cadence changes the run trajectory."
ANCHOR = "config snippet"

def load_trace_0058():
    return [
        {"step": 1, "train_loss": 2.380, "val_loss": 2.540, "grad_norm": 2.700},
        {"step": 2, "train_loss": 2.500, "val_loss": 2.660, "grad_norm": 2.820},
        {"step": 3, "train_loss": 2.530, "val_loss": 2.690, "grad_norm": 2.850},
        {"step": 4, "train_loss": 2.650, "val_loss": 2.810, "grad_norm": 2.970},
    ]
