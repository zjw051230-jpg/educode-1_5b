...
"""Memorized Header Tokens.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Use repeated header tokens to show how memorization can hide inside a falling train loss.
Writing form: diagnostic comparison script. Concrete anchor: failure scenario.
"""
...
DEFINITION = "Memorized Header Tokens"
LEARNING_OBJECTIVE = "Use repeated header tokens to show how memorization can hide inside a falling train loss."
