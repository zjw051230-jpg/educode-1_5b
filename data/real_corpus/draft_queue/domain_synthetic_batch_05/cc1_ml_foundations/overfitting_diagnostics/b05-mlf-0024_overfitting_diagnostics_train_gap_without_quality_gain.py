...
"""Train Gap Without Quality Gain.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Show why a train-loss gap alone does not prove useful learning happened.
Writing form: diagnostic comparison script. Concrete anchor: metrics interpretation.
"""
...
DEFINITION = "Train Gap Without Quality Gain"
LEARNING_OBJECTIVE = "Show why a train-loss gap alone does not prove useful learning happened."
ANCHOR = "metrics interpretation"

def load_trace_0024():
    return [
        {"step": 1, "train_loss": 2.460, "val_loss": 2.620, "grad_norm": 2.780},
        {"step": 2, "train_loss": 2.580, "val_loss": 2.740, "grad_norm": 2.900},
        {"step": 3, "train_loss": 2.700, "val_loss": 2.860, "grad_norm": 3.020},
        {"step": 4, "train_loss": 2.730, "val_loss": 2.890, "grad_norm": 3.050},
    ]
