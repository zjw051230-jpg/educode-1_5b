...
"""Memorization on Short Suffixes.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Teach how short-suffix memorization appears in token-level metrics before it appears in aggregate loss.
Writing form: diagnostic comparison script. Concrete anchor: mini code trace.
"""
...
DEFINITION = "Memorization on Short Suffixes"
LEARNING_OBJECTIVE = "Teach how short-suffix memorization appears in token-level metrics before it appears in aggregate loss."
ANCHOR = "mini code trace"

def load_trace_0027():
    return [
        {"step": 1, "train_loss": 2.790, "val_loss": 2.950, "grad_norm": 3.110},
        {"step": 2, "train_loss": 2.910, "val_loss": 3.070, "grad_norm": 3.230},
        {"step": 3, "train_loss": 3.030, "val_loss": 3.190, "grad_norm": 3.350},
        {"step": 4, "train_loss": 3.060, "val_loss": 3.220, "grad_norm": 3.380},
    ]
