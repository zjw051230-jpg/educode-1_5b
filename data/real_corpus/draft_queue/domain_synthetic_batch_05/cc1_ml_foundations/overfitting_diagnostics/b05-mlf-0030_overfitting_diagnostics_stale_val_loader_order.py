...
"""Stale Validation Loader Order.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Diagnose how a frozen validation order can make repeated failures look stable.
...
DEFINITION = "Stale Validation Loader Order"
LEARNING_OBJECTIVE = "Diagnose how a frozen validation order can make repeated failures look stable."
