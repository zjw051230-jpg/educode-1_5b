...
"""Artifact From Easy Prompts.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Use easy prompts to explain why some validation wins should be discounted.
Writing form: diagnostic comparison script. Concrete anchor: small pseudo-run log.
"""
...
DEFINITION = "Artifact From Easy Prompts"
LEARNING_OBJECTIVE = "Use easy prompts to explain why some validation wins should be discounted."
ANCHOR = "small pseudo-run log"

def load_trace_0033():
    return [
        {"step": 1, "train_loss": 2.680, "val_loss": 2.840, "grad_norm": 3.000},
        {"step": 2, "train_loss": 2.800, "val_loss": 2.960, "grad_norm": 3.120},
        {"step": 3, "train_loss": 2.920, "val_loss": 3.080, "grad_norm": 3.240},
        {"step": 4, "train_loss": 2.950, "val_loss": 3.110, "grad_norm": 3.270},
    ]
