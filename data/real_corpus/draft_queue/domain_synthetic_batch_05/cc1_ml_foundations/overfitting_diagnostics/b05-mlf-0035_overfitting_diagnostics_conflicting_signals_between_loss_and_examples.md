...
# Conflicting Signals Between Loss and Examples

A widening gap is not enough by itself, so this draft reconstructs the evidence chain step by step.
The learning objective is specific: Show how manual examples can contradict scalar loss in an overfitting investigation.
...
- focus: conflicting_signals_between_loss_and_examples
...
The first trap in conflicting signals between loss and examples is to turn one scalar into a universal rule.
