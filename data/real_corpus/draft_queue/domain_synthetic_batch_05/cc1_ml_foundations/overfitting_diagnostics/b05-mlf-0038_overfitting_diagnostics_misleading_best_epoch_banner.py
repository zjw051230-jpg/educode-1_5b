...
"""Misleading Best-Epoch Banner.
Synthetic teaching script for CC-1 batch_05.
Learning objective: Use a banner-selection bug to show how reporting layers can amplify overfitting mistakes.
Writing form: diagnostic comparison script. Concrete anchor: debugging transcript.
"""
...
DEFINITION = "Misleading Best-Epoch Banner"
LEARNING_OBJECTIVE = "Use a banner-selection bug to show how reporting layers can amplify overfitting mistakes."
ANCHOR = "debugging transcript"

def load_trace_0038():
    return [
        {"step": 1, "train_loss": 2.520, "val_loss": 2.680, "grad_norm": 2.840},
        {"step": 2, "train_loss": 2.550, "val_loss": 2.710, "grad_norm": 2.870},
        {"step": 3, "train_loss": 2.670, "val_loss": 2.830, "grad_norm": 2.990},
        {"step": 4, "train_loss": 2.790, "val_loss": 2.950, "grad_norm": 3.110},
    ]
