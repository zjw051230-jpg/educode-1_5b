...
# Input Target Shift Off By One

## Review target
diagnose an off-by-one input/target shift using a 4-token toy batch.
...
## Decision note
This checklist uses a numeric toy example so the file is anchored in a concrete pass/fail review rather than a free-floating overview.
