...
# Document Family Leakage In Grouped Batches

## Review target
explain leakage introduced when grouped document families are split too late.
...
## Decision note
This checklist uses a debugging transcript so the file is anchored in a concrete pass/fail review rather than a free-floating overview.
