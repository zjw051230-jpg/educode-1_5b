...
"""Validate Batch Shapes For Targets.
Learning objective: validate that inputs, targets, and masks share compatible shapes.
Concrete anchor: tensor shape trace.
"""
