...
# Shuffle Before Grouping Bug

## Review target
analyze why shuffling before grouping creates unstable leakage results.
...
## Decision note
This checklist uses a failure scenario so the file is anchored in a concrete pass/fail review rather than a free-floating overview.
