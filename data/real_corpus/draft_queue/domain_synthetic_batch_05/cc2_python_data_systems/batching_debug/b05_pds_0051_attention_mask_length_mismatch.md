...
# Attention Mask Length Mismatch

## Review target
read a tiny log showing attention-mask length mismatch after truncation.
...
## Decision note
This checklist uses a small pseudo-run log so the file is anchored in a concrete pass/fail review rather than a free-floating overview.
