...
# Bucket Debug Checklist

## Review target
use a checklist to review bucket width, order, and overflow behavior.
...
## Decision note
This checklist uses a decision checklist so the file is anchored in a concrete pass/fail review rather than a free-floating overview.
