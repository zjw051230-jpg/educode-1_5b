...
## Review question
simulate a short batch trace log with shapes, pad counts, and dropped rows.
...
It is driven by a concrete config snippet and a review-style comparison, with emphasis on small pseudo-run log.
