...
# Repair Steps After Truncation Bug

## Review target
outline concrete repair steps after discovering inconsistent truncation rules.
...
## Decision note
This checklist uses a repair checklist so the file is anchored in a concrete pass/fail review rather than a free-floating overview.
