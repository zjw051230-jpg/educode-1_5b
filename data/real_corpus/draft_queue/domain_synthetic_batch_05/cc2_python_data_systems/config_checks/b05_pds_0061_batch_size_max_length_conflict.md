...
# Batch Size Max Length Conflict

**Learning objective:** explain why a chosen batch_size conflicts with max_length in a toy memory budget.

## Question 1
What is the first observation that tells you the artifact is broken?

## Answer 1
The answer comes from a config snippet that exposes a mismatch before any large pipeline reasoning is needed.
