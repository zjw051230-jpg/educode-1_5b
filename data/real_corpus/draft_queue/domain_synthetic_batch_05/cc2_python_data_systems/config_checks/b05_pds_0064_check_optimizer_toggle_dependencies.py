...
"""Check Optimizer Toggle Dependencies.
Learning objective: check that enabling a toy optimizer toggle also enables its required fields.
...
def _review_prompt() -> str:
    return "check that enabling a toy optimizer toggle also enables its required fields"
