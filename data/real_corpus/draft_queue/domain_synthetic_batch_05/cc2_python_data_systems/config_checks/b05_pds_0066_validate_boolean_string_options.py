...
Learning objective: validate boolean-like config strings and reject ambiguous spellings.
...
def _review_prompt() -> str:
    return "validate boolean-like config strings and reject ambiguous spellings"
