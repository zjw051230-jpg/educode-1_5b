...
# Split Ratio Rounding Repair

**Learning objective:** repair ratio rounding that leaves one leftover example unassigned.

## Question 1
What is the first observation that tells you the artifact is broken?

## Answer 1
The answer comes from a numeric toy example that exposes a mismatch before any large pipeline reasoning is needed.
