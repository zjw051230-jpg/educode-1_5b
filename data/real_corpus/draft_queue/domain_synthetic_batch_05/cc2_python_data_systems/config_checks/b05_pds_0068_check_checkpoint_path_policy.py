...
"""Check Checkpoint Path Policy.
Learning objective: check a toy checkpoint config for relative path and naming policy issues.
...
def _review_prompt() -> str:
    return "check a toy checkpoint config for relative path and naming policy issues"
