...
"""Detect Conflicting Truncation Flags.
Learning objective: detect conflicting truncation flags in a small config dictionary.
...
def _review_prompt() -> str:
    return "detect conflicting truncation flags in a small config dictionary"
