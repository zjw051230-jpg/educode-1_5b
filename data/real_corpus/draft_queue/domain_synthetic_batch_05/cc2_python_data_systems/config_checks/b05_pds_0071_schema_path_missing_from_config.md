...
# Schema Path Missing From Config

**Learning objective:** use a mini incident diary for a missing schema_path field.

## Question 1
What is the first observation that tells you the artifact is broken?

## Answer 1
The answer comes from a debugging transcript that exposes a mismatch before any large pipeline reasoning is needed.
