...
"""Check Max Examples Cap.
Learning objective: check a toy max_examples cap against observed manifest size.
...
def _review_prompt() -> str:
    return "check a toy max_examples cap against observed manifest size"
