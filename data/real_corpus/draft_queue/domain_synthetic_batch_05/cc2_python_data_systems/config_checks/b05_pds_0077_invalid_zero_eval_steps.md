...
# Invalid Zero Eval Steps

**Learning objective:** explain why eval_steps=0 breaks metric interpretation even in a toy run.

## Question 1
What is the first observation that tells you the artifact is broken?

## Answer 1
The answer comes from a failure scenario that exposes a mismatch before any large pipeline reasoning is needed.
