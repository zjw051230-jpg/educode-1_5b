...
"""Repair Default Split Names.
Learning objective: repair missing split names by inserting canonical train/val/test labels.
...
def _review_prompt() -> str:
    return "repair missing split names by inserting canonical train/val/test labels"
