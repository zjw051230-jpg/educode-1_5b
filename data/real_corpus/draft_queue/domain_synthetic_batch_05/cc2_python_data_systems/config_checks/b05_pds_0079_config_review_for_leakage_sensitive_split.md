...
# Config Review For Leakage Sensitive Split

**Learning objective:** review a split config specifically for document-family leakage risk.

## Question 1
What is the first observation that tells you the artifact is broken?

## Answer 1
The answer comes from a decision checklist that exposes a mismatch before any large pipeline reasoning is needed.
