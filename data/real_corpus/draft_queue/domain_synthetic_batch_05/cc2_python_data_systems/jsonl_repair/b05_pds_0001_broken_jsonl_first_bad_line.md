...
# Broken Jsonl First Bad Line

## What the learner should leave with
locate the first malformed JSONL row from a tiny loader log.
...
```text
topic_id: B05-PDS-0001
broken_focus: broken_jsonl_first_bad_line
...
## Distinctive detail
The learning objective is not “understand jsonl_repair broadly”; it is to locate the first malformed JSONL row from a tiny loader log.
