...
"""Repair Missing Quote In Key.
Learning objective: repair a narrow missing-quote key pattern and mark unresolved rows.
Concrete anchor: broken JSONL case.
"""
