...
# Json Decode Error To Row Action

## What the learner should leave with
map decode error positions to concrete row-level repair actions.
...
```text
topic_id: B05-PDS-0015
broken_focus: json_decode_error_to_row_action
...
## Distinctive detail
The learning objective is not “understand jsonl_repair broadly”; it is to map decode error positions to concrete row-level repair actions.
