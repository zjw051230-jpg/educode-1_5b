...
Learning objective: check monotonicity of toy metric rows and report the first backward step.
...
def _review_prompt() -> str:
    return "check monotonicity of toy metric rows and report the first backward step"
