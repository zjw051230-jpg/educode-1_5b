...
# Train Val Merge Confusion

## Comparison target
compare train and validation rows that were accidentally merged into one chart.
...
## What to notice
The table is anchored by before/after comparison, so the comparison is about observable differences rather than generic “better wording.”
