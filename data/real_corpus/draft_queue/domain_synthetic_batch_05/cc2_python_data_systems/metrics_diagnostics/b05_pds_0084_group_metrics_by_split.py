...
Learning objective: group toy metric rows by split before computing summaries.
...
def _review_prompt() -> str:
    return "group toy metric rows by split before computing summaries"
