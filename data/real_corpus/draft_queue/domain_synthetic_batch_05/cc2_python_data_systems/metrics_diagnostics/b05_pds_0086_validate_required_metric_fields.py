...
Learning objective: validate required metric fields such as step, split, loss, and token_count.
...
def _review_prompt() -> str:
    return "validate required metric fields such as step, split, loss, and token_count"
