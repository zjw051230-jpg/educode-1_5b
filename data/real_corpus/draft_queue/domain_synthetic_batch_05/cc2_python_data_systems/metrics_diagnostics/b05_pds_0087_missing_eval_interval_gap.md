...
# Missing Eval Interval Gap

## Comparison target
explain what a missing evaluation interval looks like in a tiny pseudo-run log.
...
## What to notice
The table is anchored by small pseudo-run log, so the comparison is about observable differences rather than generic “better wording.”
