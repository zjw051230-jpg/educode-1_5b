...
# Loss Scale Jump After Batch Change

## Comparison target
relate a sudden loss-scale jump to a batch-size config change.
...
## What to notice
The table is anchored by config snippet, so the comparison is about observable differences rather than generic “better wording.”
