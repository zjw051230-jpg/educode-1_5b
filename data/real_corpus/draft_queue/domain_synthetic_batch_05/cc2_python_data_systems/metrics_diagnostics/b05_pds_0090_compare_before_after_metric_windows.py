...
"""Compare Before After Metric Windows.
Learning objective: compare two small metric windows before and after a repair.
...
def _review_prompt() -> str:
    return "compare two small metric windows before and after a repair"
