...
# Eval Loss Missing While Train Loss Exists

## Comparison target
analyze a run where train loss exists but eval loss never appears.
...
## What to notice
The table is anchored by failure scenario, so the comparison is about observable differences rather than generic “better wording.”
