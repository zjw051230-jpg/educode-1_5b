...
"""Check Metric Unit Annotations.
Learning objective: check that metric rows carry explicit unit annotations where needed.
...
def _review_prompt() -> str:
    return "check that metric rows carry explicit unit annotations where needed"
