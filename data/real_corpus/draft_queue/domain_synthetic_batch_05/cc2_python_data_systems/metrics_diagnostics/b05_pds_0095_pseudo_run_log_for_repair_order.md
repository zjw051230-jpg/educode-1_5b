...
# Pseudo Run Log For Repair Order

## Comparison target
read a pseudo-run log and decide whether to repair steps, units, or split labels first.
...
## What to notice
The table is anchored by debugging transcript, so the comparison is about observable differences rather than generic “better wording.”
