...
"""Detect Split Label Drift In Metrics.
Learning objective: detect split label drift such as val versus validation across rows.
...
def _review_prompt() -> str:
    return "detect split label drift such as val versus validation across rows"
