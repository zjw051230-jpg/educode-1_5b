...
"""Estimate Examples Per Second.
Learning objective: estimate examples per second from toy token and time counters.
...
def _review_prompt() -> str:
    return "estimate examples per second from toy token and time counters"
