...
# Unstable Run Identifier Fields

## Comparison target
explain why unstable run identifier fields break metric joins across files.
...
## What to notice
The table is anchored by metrics interpretation, so the comparison is about observable differences rather than generic “better wording.”
