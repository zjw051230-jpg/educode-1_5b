...
# Int String Schema Drift

## Diary entry
I started with a symptom tied to schema mismatch.
The concrete target was to explain why silently coercing string ids to integers can hide upstream schema drift.
