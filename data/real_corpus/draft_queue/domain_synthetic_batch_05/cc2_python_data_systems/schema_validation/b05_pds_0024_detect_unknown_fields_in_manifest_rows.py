...
"""Detect Unknown Fields In Manifest Rows.
Learning objective: detect unknown fields in split manifest rows without rejecting known extensions.
...
def _review_prompt() -> str:
    return "detect unknown fields in split manifest rows without rejecting known extensions"
