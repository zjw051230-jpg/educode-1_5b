...
# Shape Field Pair Consistency

## Diary entry
I started with a symptom tied to tensor shape trace.
The concrete target was to trace a mismatch between stored length fields and observed token counts.
