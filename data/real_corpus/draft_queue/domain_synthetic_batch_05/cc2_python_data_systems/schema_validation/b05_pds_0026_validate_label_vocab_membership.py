...
"""Validate Label Vocab Membership.
Learning objective: validate that class labels belong to a declared toy vocabulary.
...
def _review_prompt() -> str:
    return "validate that class labels belong to a declared toy vocabulary"
