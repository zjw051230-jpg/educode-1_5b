...
# Schema Version Upgrade Notes

## Diary entry
I started with a symptom tied to before/after comparison.
The concrete target was to compare two tiny schema versions and explain the repair required for each row.
