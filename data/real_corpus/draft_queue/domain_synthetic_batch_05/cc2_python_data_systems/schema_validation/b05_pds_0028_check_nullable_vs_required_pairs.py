...
"""Check Nullable Vs Required Pairs.
Learning objective: check that nullable and required field rules are not contradictory.
...
def _review_prompt() -> str:
    return "check that nullable and required field rules are not contradictory"
