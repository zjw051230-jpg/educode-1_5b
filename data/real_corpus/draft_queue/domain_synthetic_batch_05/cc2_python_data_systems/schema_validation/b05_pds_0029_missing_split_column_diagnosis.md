...
# Missing Split Column Diagnosis

## Diary entry
I started with a symptom tied to debugging transcript.
The concrete target was to read a short failure transcript caused by a missing split column.
