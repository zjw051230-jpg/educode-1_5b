...
"""Report Type Errors With Row Keys.
Learning objective: report type errors with row number and offending keys for quick repair.
...
def _review_prompt() -> str:
    return "report type errors with row number and offending keys for quick repair"
