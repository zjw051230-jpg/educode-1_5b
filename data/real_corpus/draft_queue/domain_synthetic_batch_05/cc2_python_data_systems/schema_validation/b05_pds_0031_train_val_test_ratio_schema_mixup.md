...
# Train Val Test Ratio Schema Mixup

## Diary entry
I started with a symptom tied to small pseudo-run log.
The concrete target was to explain a schema mixup where ratios were stored as strings in one shard.
