...
"""Validate Nested Metrics Schema.
Learning objective: validate nested metric summaries with expected float fields.
...
def _review_prompt() -> str:
    return "validate nested metric summaries with expected float fields"
