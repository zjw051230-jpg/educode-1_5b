...
# Field Rename Without Backfill

## Diary entry
I started with a symptom tied to before/after comparison.
The concrete target was to analyze the breakage caused by renaming text_length to token_count without backfill.
