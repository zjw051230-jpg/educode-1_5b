...
# Document Family Key Requirement

## Diary entry
I started with a symptom tied to decision checklist.
The concrete target was to explain why document_family_id is required before leakage checks can run.
