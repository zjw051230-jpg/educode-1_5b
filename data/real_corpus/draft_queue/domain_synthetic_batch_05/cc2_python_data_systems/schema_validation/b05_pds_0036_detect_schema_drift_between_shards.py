...
"""Detect Schema Drift Between Shards.
Learning objective: detect field set drift across three toy shard manifests.
...
def _review_prompt() -> str:
    return "detect field set drift across three toy shard manifests"
