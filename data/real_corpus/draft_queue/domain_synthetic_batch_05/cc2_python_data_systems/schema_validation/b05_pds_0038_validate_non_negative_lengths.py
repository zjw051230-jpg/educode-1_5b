...
"""Validate Non Negative Lengths.
Learning objective: validate non-negative length fields and collect offending rows.
...
def _review_prompt() -> str:
    return "validate non-negative length fields and collect offending rows"
