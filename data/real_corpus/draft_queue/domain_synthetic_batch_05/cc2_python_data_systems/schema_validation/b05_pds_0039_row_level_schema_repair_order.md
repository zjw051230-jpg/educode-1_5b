...
# Row Level Schema Repair Order

## Diary entry
I started with a symptom tied to repair checklist.
The concrete target was to choose an efficient order for missing-field fill, type repair, and final validation.
