...
| --- | --- | --- |
| input | `(2, 4, 15)` | `(2, 4, 15)` |
| focused artifact | ambiguous mask matrix note | explicit failure scenario |
...
## Reader task
Rewrite one additional line so the mask matrix trace becomes even easier to audit.
