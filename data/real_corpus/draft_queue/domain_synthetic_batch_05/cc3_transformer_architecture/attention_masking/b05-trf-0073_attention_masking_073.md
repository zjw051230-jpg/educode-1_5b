...
## Bug diary excerpt
Symptom: a tiny mask matrix demo passed shape checks at the input boundary but failed after one later transformation.

### Day 1 observation
- The first healthy line was `(batch=2, seq=6, width=12)`.
...
### Resolution
The real fix was not “understand transformers better”; it was naming the exact mask matrix invariant and checking it earlier.
