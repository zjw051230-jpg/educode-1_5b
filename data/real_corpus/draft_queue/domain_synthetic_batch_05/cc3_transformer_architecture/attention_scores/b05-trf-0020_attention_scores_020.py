...
"""Auditing score masking before normalization (attention score grid)."""

def demo_attention_scores_0020():
    num_heads = 2
    seq_len = 4
    scale = 1.25
    ...
    print("anchor:", 'small pseudo-run log')
    ...
    review_points = [
        ...
        "name the chosen anchor: small pseudo-run log",
