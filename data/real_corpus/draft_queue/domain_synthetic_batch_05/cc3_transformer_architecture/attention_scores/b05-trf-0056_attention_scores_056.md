...
```
[info] topic=B05-TRF-0056
[info] subdir=attention_scores
[info] opening-artifact=failure scenario
[trace] hidden=(2, 5, 18)
...
## Reading the log
This file is intentionally written like a decision memo so that the opening texture changes from neighboring markdown files.
