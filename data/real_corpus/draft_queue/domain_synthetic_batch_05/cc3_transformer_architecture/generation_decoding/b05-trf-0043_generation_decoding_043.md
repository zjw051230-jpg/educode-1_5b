...
## Bug diary excerpt
Symptom: a tiny decode step demo passed shape checks at the input boundary but failed after one later transformation.

### Day 1 observation
- The first healthy line was `(batch=2, seq=6, width=12)`.
- The suspicious line appeared after a failure scenario.
...
### Resolution
The real fix was not “understand transformers better”; it was naming the exact decode step invariant and checking it earlier.
