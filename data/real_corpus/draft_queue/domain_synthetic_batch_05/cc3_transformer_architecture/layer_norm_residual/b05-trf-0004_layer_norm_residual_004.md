...
# Finding the first unstable channel (layer norm path)

## Before / after snapshot
| stage | before | after |
| --- | --- | --- |
| input | `(2, 4, 15)` | `(2, 4, 15)` |
| focused artifact | ambiguous layer norm path note | explicit small pseudo-run log |
...
## Reader task
Rewrite one additional line so the layer norm path trace becomes even easier to audit.
