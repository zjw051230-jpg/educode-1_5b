...
# Interpreting a suspicious final linear layer (logits projection)

## Bug diary excerpt
Symptom: a tiny logits projection demo passed shape checks at the input boundary but failed after one later transformation.

### Day 1 observation
- The first healthy line was `(batch=2, seq=6, width=14)`.
- The suspicious line appeared after a numeric toy example.
...
### Resolution
The real fix was not “understand transformers better”; it was naming the exact logits projection invariant and checking it earlier.
