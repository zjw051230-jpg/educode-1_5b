...
```
[info] topic=B05-TRF-0046
[info] subdir=logits_projection
[info] opening-artifact=mini code trace
[trace] hidden=(2, 5, 15)
[trace] focused-path=logits projection
[warn] mismatch discovered after line-of-interest
```

## Reading the log
This file is intentionally written like a pseudo-run log so that the opening texture changes from neighboring markdown files.
