...
"""When q_proj matches but v_proj drifts (QKV head split)."""

def demo_qkv_shapes_0037():
    batch_size = 2
    seq_len = 4
    d_model = 12
    num_heads = 2
    ...
    print("anchor:", 'decision checklist')
    ...
    review_points = [
        ...
        "name the chosen anchor: decision checklist",
