...
# Explaining why head_dim must divide d_model (QKV head split)

## Before / after snapshot
| stage | before | after |
| --- | --- | --- |
| input | `(2, 4, 15)` | `(2, 4, 15)` |
| focused artifact | ambiguous QKV head split note | explicit debugging transcript |
...
## Reader task
Rewrite one additional line so the QKV head split trace becomes even easier to audit.
