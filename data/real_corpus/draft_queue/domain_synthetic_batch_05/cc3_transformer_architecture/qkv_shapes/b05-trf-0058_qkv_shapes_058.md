...
## Failure scenario
A teammate reports that the QKV head split branch is “probably fine” because the outer tensor shape still matches.
...
### Better response
Ask for one small pseudo-run log, one explicit tuple, and one statement of the intended invariant.
