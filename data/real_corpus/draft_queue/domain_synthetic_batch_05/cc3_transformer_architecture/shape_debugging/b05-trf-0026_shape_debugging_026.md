...
```
[info] topic=B05-TRF-0026
[info] subdir=shape_debugging
[info] opening-artifact=metrics interpretation
[trace] hidden=(2, 5, 16)
...
## Reading the log
This file is intentionally written like a failure analysis so that the opening texture changes from neighboring markdown files.
