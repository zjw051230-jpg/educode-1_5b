...
## Bug diary excerpt
Symptom: a tiny shape mismatch demo passed shape checks at the input boundary but failed after one later transformation.

### Day 1 observation
- The first healthy line was `(batch=2, seq=6, width=16)`.
- The suspicious line appeared after a config snippet.
...
### Resolution
The real fix was not “understand transformers better”; it was naming the exact shape mismatch invariant and checking it earlier.
