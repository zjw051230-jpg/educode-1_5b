...
# Eval Trigger Stall In Smoke Test

Instead of explaining eval trigger stall in smoke test in the abstract, this file starts from a concrete artifact packet.

**Learning objective:** Diagnose a short smoke run that stalls only when validation triggers at step 25.

Use this checklist on a bounded artifact packet before turning one runtime anomaly into a broad claim.

## Artifact packet
- `step log around validation boundary`
- topic_id: B05-RTS-0025
...
## Example packet
```text
step=12475 train_tokens_per_sec=128750
step=12475 max_memory_allocated_gb=41.9
step=12475 max_memory_reserved_gb=59.9
step=12476 validation_start seq_len=3072 microbatch=4
step=12477 validation_end val_loss=2.030
```
