...
def build_packet_fragmentation_like_growth_vs_real_leak() -> dict:
    return {
        "topic_id": "B05-RTS-0017",
        "title": "Fragmentation Or Real Leak",
        "learning_objective": "Distinguish cache growth from a real leak when peak reserved increases but allocated resets after each eval.",
        "writing_form": "explainer note",
        "concrete_anchor": "before/after comparison",
        "artifact_focus": "pseudo-run memory trace",
        "step": 12085,
        "seq_len": 3072,
        "max_memory_allocated_gb": 37.2,
        "max_memory_reserved_gb": 63.7,
        "peak_reserved_gb": 66.5,
        "train_tokens_per_sec": 124670,
        "val_loss": 1.96,
        "weighted_val_loss": 1.929,
        "latest_step": 12087,
        "best_step": 12061,
        "optimizer_step": 12083,
        "event_rows": [
            {"event": "train_step", "step": 12085, "tokens_per_sec": 124670},
            {"event": "eval_end", "step": 12086, "val_loss": 1.96, "samples": 512},
            {"event": "checkpoint_save", "step": 12087, "duration_ms": 441},
        ],
    }
...
def diagnose_fragmentation_like_growth_vs_real_leak(packet: dict) -> DiagnosticResult:
    evidence: list[str] = []
    suspicious = False
...
def main() -> None:
    packet = build_packet_fragmentation_like_growth_vs_real_leak()
    result = diagnose_fragmentation_like_growth_vs_real_leak(packet)
