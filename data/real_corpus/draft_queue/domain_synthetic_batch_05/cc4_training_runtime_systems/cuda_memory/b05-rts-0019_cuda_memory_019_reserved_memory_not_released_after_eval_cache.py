...
def build_packet_reserved_memory_not_released_after_eval_cache() -> dict:
    return {
        "topic_id": "B05-RTS-0019",
        "title": "Reserved Cache Did Not Release",
        "learning_objective": "Review whether a manual cache clear fixed the symptom or only masked an eval buffer ownership bug.",
        "writing_form": "explainer note",
        "concrete_anchor": "tensor shape",
        "artifact_focus": "before/after cache clear log",
        "step": 12095,
        "seq_len": 4608,
        "max_memory_allocated_gb": 39.6,
        "max_memory_reserved_gb": 57.7,
        "peak_reserved_gb": 60.5,
        "train_tokens_per_sec": 125690,
        "val_loss": 1.8,
        "weighted_val_loss": 1.769,
        "latest_step": 12097,
        "best_step": 12071,
        "optimizer_step": 12091,
        "event_rows": [
            {"event": "train_step", "step": 12095, "tokens_per_sec": 125690},
            {"event": "eval_end", "step": 12096, "val_loss": 1.8, "samples": 512},
            {"event": "checkpoint_save", "step": 12097, "duration_ms": 447},
        ],
    }
...
def diagnose_reserved_memory_not_released_after_eval_cache(packet: dict) -> DiagnosticResult:
    evidence: list[str] = []
    suspicious = False
...
def main() -> None:
    packet = build_packet_reserved_memory_not_released_after_eval_cache()
    result = diagnose_reserved_memory_not_released_after_eval_cache(packet)
