...
def build_packet_summary_field_selection_for_debug_packet() -> dict:
    return {
        "topic_id": "B05-RTS-0039",
        "title": "Summary Field Selection",
        "learning_objective": "Choose which five summary fields are worth carrying into a compact debug packet for runtime triage.",
        "writing_form": "checklist",
        "concrete_anchor": "failure scenario",
        "artifact_focus": "summary.json snippet",
        "step": 12195,
        "seq_len": 4608,
        "max_memory_allocated_gb": 44.4,
        "max_memory_reserved_gb": 66.7,
        "peak_reserved_gb": 69.5,
        "train_tokens_per_sec": 135890,
        "val_loss": 1.88,
        "weighted_val_loss": 1.849,
        "latest_step": 12197,
        "best_step": 12171,
        "optimizer_step": 12191,
        "event_rows": [
            {"event": "train_step", "step": 12195, "tokens_per_sec": 135890},
            {"event": "eval_end", "step": 12196, "val_loss": 1.88, "samples": 512},
            {"event": "checkpoint_save", "step": 12197, "duration_ms": 507},
        ],
    }
...
def diagnose_summary_field_selection_for_debug_packet(packet: dict) -> DiagnosticResult:
    evidence: list[str] = []
    suspicious = False
...
def main() -> None:
    packet = build_packet_summary_field_selection_for_debug_packet()
    result = diagnose_summary_field_selection_for_debug_packet(packet)
