...
# Shape Mismatch After Tokenizer Growth

Instead of explaining shape mismatch after tokenizer growth in the abstract, this file starts from a concrete artifact packet.

**Learning objective:** Explain how tokenizer vocab growth can surface first as checkpoint reload shape mismatch in validation.

## Runtime scene
This walkthrough uses `shape listing + config delta` plus a small pseudo trace to show how a topic-specific check should reason about the packet.
