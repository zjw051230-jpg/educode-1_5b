...
def build_packet_promotion_subset_runtime_preflight() -> dict:
    return {
        "topic_id": "B05-RTS-0075",
        "title": "Promotion Subset Runtime Preflight",
        "learning_objective": "Build a preflight checklist for deciding whether a runtime artifact bundle is even safe to review for promotion.",
        "writing_form": "code walkthrough",
        "concrete_anchor": "failure scenario",
        "artifact_focus": "decision checklist with artifact presence",
        "step": 12375,
        "seq_len": 4608,
        "max_memory_allocated_gb": 39.6,
        "max_memory_reserved_gb": 61.9,
        "peak_reserved_gb": 64.7,
        "train_tokens_per_sec": 154250,
        "val_loss": 1.8,
        "weighted_val_loss": 1.769,
        "latest_step": 12377,
        "best_step": 12351,
        "optimizer_step": 12375,
        "event_rows": [
            {"event": "train_step", "step": 12375, "tokens_per_sec": 154250},
            {"event": "eval_end", "step": 12376, "val_loss": 1.8, "samples": 512},
            {"event": "checkpoint_save", "step": 12377, "duration_ms": 615},
        ],
    }
...
def diagnose_promotion_subset_runtime_preflight(packet: dict) -> DiagnosticResult:
    evidence: list[str] = []
    suspicious = False
...
def main() -> None:
    packet = build_packet_promotion_subset_runtime_preflight()
    result = diagnose_promotion_subset_runtime_preflight(packet)
