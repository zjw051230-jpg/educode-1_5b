...
def build_packet_step_window_evidence_packet_for_reviewer_handoff() -> dict:
    return {
        "topic_id": "B05-RTS-0095",
        "title": "Step Window Evidence Handoff",
        "learning_objective": "Build a compact handoff packet for another reviewer using only the evidence from one suspicious step window.",
        "writing_form": "config review",
        "concrete_anchor": "pseudo-run log",
        "artifact_focus": "mini incident packet + selected rows",
        "step": 12475,
        "seq_len": 4608,
        "max_memory_allocated_gb": 44.4,
        "max_memory_reserved_gb": 70.9,
        "peak_reserved_gb": 73.7,
        "train_tokens_per_sec": 164450,
        "val_loss": 1.88,
        "weighted_val_loss": 1.849,
        "latest_step": 12477,
        "best_step": 12451,
        "optimizer_step": 12475,
        "event_rows": [
            {"event": "train_step", "step": 12475, "tokens_per_sec": 164450},
            {"event": "eval_end", "step": 12476, "val_loss": 1.88, "samples": 512},
            {"event": "checkpoint_save", "step": 12477, "duration_ms": 675},
        ],
    }
...
def diagnose_step_window_evidence_packet_for_reviewer_handoff(packet: dict) -> DiagnosticResult:
    evidence: list[str] = []
    suspicious = False
...
def main() -> None:
    packet = build_packet_step_window_evidence_packet_for_reviewer_handoff()
    result = diagnose_step_window_evidence_packet_for_reviewer_handoff(packet)
