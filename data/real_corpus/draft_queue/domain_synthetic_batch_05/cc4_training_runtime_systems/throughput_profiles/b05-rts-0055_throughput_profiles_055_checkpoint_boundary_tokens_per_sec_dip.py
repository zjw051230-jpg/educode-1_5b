...
def build_packet_checkpoint_boundary_tokens_per_sec_dip() -> dict:
    return {
        "topic_id": "B05-RTS-0055",
        "title": "Checkpoint Boundary Throughput Dip",
        "learning_objective": "Interpret a throughput dip immediately after a checkpoint save without over-attributing it to model instability.",
        "writing_form": "mini lab",
        "concrete_anchor": "tensor shape",
        "artifact_focus": "throughput log around save",
        "step": 12275,
        "seq_len": 4608,
        "max_memory_allocated_gb": 44.4,
        "max_memory_reserved_gb": 62.5,
        "peak_reserved_gb": 65.3,
        "train_tokens_per_sec": 144050,
        "val_loss": 1.72,
        "weighted_val_loss": 1.689,
        "latest_step": 12277,
        "best_step": 12251,
        "optimizer_step": 12275,
        "event_rows": [
            {"event": "train_step", "step": 12275, "tokens_per_sec": 144050},
            {"event": "eval_end", "step": 12276, "val_loss": 1.72, "samples": 512},
            {"event": "checkpoint_save", "step": 12277, "duration_ms": 555},
        ],
    }
...
def diagnose_checkpoint_boundary_tokens_per_sec_dip(packet: dict) -> DiagnosticResult:
    evidence: list[str] = []
    suspicious = False
...
def main() -> None:
    packet = build_packet_checkpoint_boundary_tokens_per_sec_dip()
    result = diagnose_checkpoint_boundary_tokens_per_sec_dip(packet)
