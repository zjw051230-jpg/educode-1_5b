...
def build_packet_checkpoint_compression_cpu_spillover() -> dict:
    return {
        "topic_id": "B05-RTS-0060",
        "title": "Checkpoint Compression Cpu Spillover",
        "learning_objective": "Review whether checkpoint compression on CPU explains the next-step latency bump after save.",
        "writing_form": "Q&A",
        "concrete_anchor": "metrics interpretation",
        "artifact_focus": "save log + next-step latency row",
        "step": 12300,
        "seq_len": 2048,
        "max_memory_allocated_gb": 40.8,
        "max_memory_reserved_gb": 56.8,
        "peak_reserved_gb": 59.6,
        "train_tokens_per_sec": 146600,
        "val_loss": 1.88,
        "weighted_val_loss": 1.849,
        "latest_step": 12302,
        "best_step": 12276,
        "optimizer_step": 12300,
        "event_rows": [
            {"event": "train_step", "step": 12300, "tokens_per_sec": 146600},
            {"event": "eval_end", "step": 12301, "val_loss": 1.88, "samples": 512},
            {"event": "checkpoint_save", "step": 12302, "duration_ms": 570},
        ],
    }
...
def diagnose_checkpoint_compression_cpu_spillover(packet: dict) -> DiagnosticResult:
    evidence: list[str] = []
    suspicious = False
...
def main() -> None:
    packet = build_packet_checkpoint_compression_cpu_spillover()
    result = diagnose_checkpoint_compression_cpu_spillover(packet)
