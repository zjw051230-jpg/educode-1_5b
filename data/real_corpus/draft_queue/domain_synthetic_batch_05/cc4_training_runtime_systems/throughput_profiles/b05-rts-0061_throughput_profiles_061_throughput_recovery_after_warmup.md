...
# Throughput Recovery After Warmup

The fastest way to misread throughput recovery after warmup is to quote the neatest number and ignore the artifact trail behind it.

**Learning objective:** Use a small pseudo-run to show why step 1-5 should not be compared directly with steady-state step 40-60.

## Runtime scene
This walkthrough uses `early vs steady-state throughput table` plus a small pseudo trace to show how a topic-specific check should reason about the packet.
