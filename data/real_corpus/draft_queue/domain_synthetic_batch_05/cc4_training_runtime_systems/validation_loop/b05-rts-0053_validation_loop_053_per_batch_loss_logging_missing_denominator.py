...
def build_packet_per_batch_loss_logging_missing_denominator() -> dict:
    return {
        "topic_id": "B05-RTS-0053",
        "title": "Per Batch Loss Missing Denominator",
        "learning_objective": "Explain why logged per-batch loss is not enough to recompute epoch loss without token or sample denominators.",
        "writing_form": "mini lab",
        "concrete_anchor": "before/after comparison",
        "artifact_focus": "eval rows missing counts",
        "step": 12265,
        "seq_len": 3072,
        "max_memory_allocated_gb": 42.0,
        "max_memory_reserved_gb": 68.5,
        "peak_reserved_gb": 71.3,
        "train_tokens_per_sec": 143030,
        "val_loss": 1.88,
        "weighted_val_loss": 1.849,
        "latest_step": 12267,
        "best_step": 12241,
        "optimizer_step": 12262,
        "event_rows": [
            {"event": "train_step", "step": 12265, "tokens_per_sec": 143030},
            {"event": "eval_end", "step": 12266, "val_loss": 1.88, "samples": 512},
            {"event": "checkpoint_save", "step": 12267, "duration_ms": 549},
        ],
    }
...
def diagnose_per_batch_loss_logging_missing_denominator(packet: dict) -> DiagnosticResult:
    evidence: list[str] = []
    suspicious = False
...
def main() -> None:
    packet = build_packet_per_batch_loss_logging_missing_denominator()
    result = diagnose_per_batch_loss_logging_missing_denominator(packet)
