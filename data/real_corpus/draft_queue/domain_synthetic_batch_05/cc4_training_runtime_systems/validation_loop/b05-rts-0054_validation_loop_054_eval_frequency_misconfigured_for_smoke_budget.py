...
def build_packet_eval_frequency_misconfigured_for_smoke_budget() -> dict:
    return {
        "topic_id": "B05-RTS-0054",
        "title": "Eval Frequency Misconfigured",
        "learning_objective": "Review a smoke config where eval every 5 steps overwhelms the actual training budget.",
        "writing_form": "Q&A",
        "concrete_anchor": "decision checklist",
        "artifact_focus": "config snippet + step timeline",
        "step": 12270,
        "seq_len": 4096,
        "max_memory_allocated_gb": 43.2,
        "max_memory_reserved_gb": 59.2,
        "peak_reserved_gb": 62.0,
        "train_tokens_per_sec": 143540,
        "val_loss": 1.8,
        "weighted_val_loss": 1.769,
        "latest_step": 12272,
        "best_step": 12246,
        "optimizer_step": 12266,
        "event_rows": [
            {"event": "train_step", "step": 12270, "tokens_per_sec": 143540},
            {"event": "eval_end", "step": 12271, "val_loss": 1.8, "samples": 512},
            {"event": "checkpoint_save", "step": 12272, "duration_ms": 552},
        ],
    }
...
def diagnose_eval_frequency_misconfigured_for_smoke_budget(packet: dict) -> DiagnosticResult:
    evidence: list[str] = []
    suspicious = False
...
def main() -> None:
    packet = build_packet_eval_frequency_misconfigured_for_smoke_budget()
    result = diagnose_eval_frequency_misconfigured_for_smoke_budget(packet)
