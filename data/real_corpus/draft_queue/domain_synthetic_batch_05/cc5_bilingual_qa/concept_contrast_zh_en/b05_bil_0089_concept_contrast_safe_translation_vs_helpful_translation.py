...
"""Concept Contrasts and Evaluation Caution 89: Safe Translation Versus Helpful Translation
...
def main() -> None:
    ...
    print('writing_form', 'Q&A')
    print('concrete_anchor', 'metrics interpretation')
    print(score(pair))
