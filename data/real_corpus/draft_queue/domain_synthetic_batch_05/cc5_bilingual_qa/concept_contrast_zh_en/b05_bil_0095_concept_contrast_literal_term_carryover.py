...
"""Concept Contrasts and Evaluation Caution 95: Literal Term Carryover
...
def main() -> None:
    ...
    print('focus', 'Literal Term Carryover')
    print('writing_form', 'comparison table')
    print('concrete_anchor', 'before/after comparison')
    print(score(pair))
