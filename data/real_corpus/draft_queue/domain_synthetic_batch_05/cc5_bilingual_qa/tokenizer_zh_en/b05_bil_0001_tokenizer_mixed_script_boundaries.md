...
# Tokenizer Boundaries and Mixed Scripts 01: Mixed-Script Boundary Decisions

## Learning objective
- ZH: 识别 `mixed_script_boundaries` 如何改变中英混排中的切分边界。
- EN: See how `mixed_script_boundaries` shifts boundary decisions in mixed Chinese-English text.
