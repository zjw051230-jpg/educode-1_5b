...
# Tokenizer Boundaries and Mixed Scripts 02: Punctuation Spacing Repair

## Learning objective
- ZH: 识别 `punctuation_spacing_repair` 如何改变中英混排中的切分边界。
- EN: See how `punctuation_spacing_repair` shifts boundary decisions in mixed Chinese-English text.
