...
# Tokenizer Boundaries and Mixed Scripts 03: Unicode NFKC Edge Case

## Learning objective
- ZH: 识别 `unicode_nfkc_edge_case` 如何改变中英混排中的切分边界。
- EN: See how `unicode_nfkc_edge_case` shifts boundary decisions in mixed Chinese-English text.
