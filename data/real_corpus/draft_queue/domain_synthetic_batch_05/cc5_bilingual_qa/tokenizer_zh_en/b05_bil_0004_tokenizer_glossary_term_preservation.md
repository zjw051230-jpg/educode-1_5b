...
# Tokenizer Boundaries and Mixed Scripts 04: Glossary Term Preservation

## Learning objective
- ZH: 识别 `glossary_term_preservation` 如何改变中英混排中的切分边界。
- EN: See how `glossary_term_preservation` shifts boundary decisions in mixed Chinese-English text.
