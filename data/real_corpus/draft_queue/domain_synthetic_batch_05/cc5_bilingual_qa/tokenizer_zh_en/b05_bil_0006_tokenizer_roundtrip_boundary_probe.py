...
"""Tokenizer Boundaries and Mixed Scripts 06: Roundtrip Boundary Probe
...
def main() -> None:
    ...
    print("focus", 'Roundtrip Boundary Probe')
    print("writing_form", 'code walkthrough')
    print("concrete_anchor", 'debugging transcript')
