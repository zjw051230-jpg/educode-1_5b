...
# Tokenizer Boundaries and Mixed Scripts 09: Emoji Code Switching

## Learning objective
- ZH: 识别 `emoji_code_switching` 如何改变中英混排中的切分边界。
- EN: See how `emoji_code_switching` shifts boundary decisions in mixed Chinese-English text.
