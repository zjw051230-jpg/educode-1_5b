...
# Tokenizer Boundaries and Mixed Scripts 10: ZH-EN List Separator

## Learning objective
- ZH: 识别 `zh_en_list_separator` 如何改变中英混排中的切分边界。
- EN: See how `zh_en_list_separator` shifts boundary decisions in mixed Chinese-English text.
