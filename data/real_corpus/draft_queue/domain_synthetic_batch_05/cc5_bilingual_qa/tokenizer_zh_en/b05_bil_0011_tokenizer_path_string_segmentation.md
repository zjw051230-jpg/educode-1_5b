...
# Tokenizer Boundaries and Mixed Scripts 11: Path String Segmentation

## Learning objective
- ZH: 识别 `path_string_segmentation` 如何改变中英混排中的切分边界。
- EN: See how `path_string_segmentation` shifts boundary decisions in mixed Chinese-English text.
