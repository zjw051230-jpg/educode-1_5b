...
# Tokenizer Boundaries and Mixed Scripts 17: Delimiter Token Count Drift

## Learning objective
- ZH: 识别 `delimiter_token_count_drift` 如何改变中英混排中的切分边界。
- EN: See how `delimiter_token_count_drift` shifts boundary decisions in mixed Chinese-English text.
