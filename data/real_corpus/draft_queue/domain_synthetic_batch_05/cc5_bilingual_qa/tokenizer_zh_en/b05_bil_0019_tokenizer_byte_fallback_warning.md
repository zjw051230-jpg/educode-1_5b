...
# Tokenizer Boundaries and Mixed Scripts 19: Byte Fallback Warning

## Learning objective
- ZH: 识别 `byte_fallback_warning` 如何改变中英混排中的切分边界。
- EN: See how `byte_fallback_warning` shifts boundary decisions in mixed Chinese-English text.
