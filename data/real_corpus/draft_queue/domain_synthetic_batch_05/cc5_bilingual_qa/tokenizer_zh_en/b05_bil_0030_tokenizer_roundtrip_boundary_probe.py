...
"""Tokenizer Boundaries and Mixed Scripts 30: Roundtrip Boundary Probe
...
def main() -> None:
    ...
    print("writing_form", 'debugging diary')
    print("concrete_anchor", 'small pseudo-run log')
