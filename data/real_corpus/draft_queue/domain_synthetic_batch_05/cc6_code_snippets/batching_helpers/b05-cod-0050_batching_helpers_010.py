...
# learning_objective: Build concrete padding masks from uneven inputs.
...
def topic_action(samples: list[list[int]]) -> object:
    ...
    return [[1] * len(sample) + [0] * (width - len(sample)) for sample in samples]
