...
# learning_objective: Pad and pack real sample lists into aligned arrays.
...
TOPIC_ID = 'B05-COD-0051'
TITLE = 'Pack uneven sequences with pads'
...
def topic_action(samples: list[list[int]]) -> object:
    ...
    return [sample + [0] * (width - len(sample)) for sample in samples]
