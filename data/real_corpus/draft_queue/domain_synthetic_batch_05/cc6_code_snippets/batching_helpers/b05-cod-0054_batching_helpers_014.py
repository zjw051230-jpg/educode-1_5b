...
# learning_objective: Count tokens per batch for inspection.
...
TOPIC_ID = 'B05-COD-0054'
TITLE = 'Preview batch token counts'
...
def topic_action(samples: list[list[int]]) -> object:
    ...
    return [sum(len(sample) for sample in batch) for batch in batched]
