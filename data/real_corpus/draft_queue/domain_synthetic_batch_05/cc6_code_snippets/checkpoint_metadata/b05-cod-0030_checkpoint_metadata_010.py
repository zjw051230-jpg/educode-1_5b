...
# learning_objective: Turn raw checkpoint metadata into a compact summary record.
...
TOPIC_ID = 'B05-COD-0030'
TITLE = 'Project checkpoint metadata into a summary row'
...
def topic_action(payload: dict[str, object]) -> object:
    return {'topic_id': TOPIC_ID, 'step': payload['step'], 'run_name': payload['metadata']['run_name'], 'best_val_loss': payload['metadata']['best_val_loss']}
