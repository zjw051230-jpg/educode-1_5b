...
# learning_objective: Check whether tokenizer-related settings drifted across runs.
...
TOPIC_ID = 'B05-COD-0031'
TITLE = 'Detect mismatched tokenizer settings in metadata'
...
def topic_action(payload: dict[str, object]) -> object:
    return payload['metadata']['tokenizer_hash'] != payload['config']['tokenizer_hash']
