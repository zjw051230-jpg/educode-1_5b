...
# learning_objective: Flatten nested metadata so comparisons become easier.
...
TOPIC_ID = 'B05-COD-0032'
TITLE = 'Flatten nested checkpoint metadata'
...
def topic_action(payload: dict[str, object]) -> object:
    return {f'metadata.{k}': v for k, v in payload['metadata'].items()}
