...
# learning_objective: Verify resume paths and save paths belong to the same run root.
...
TOPIC_ID = 'B05-COD-0036'
TITLE = 'Check resume path consistency'
...
def topic_action(payload: dict[str, object]) -> object:
    save_root = 'ckpt'
    return str(payload['path']).startswith(save_root)
