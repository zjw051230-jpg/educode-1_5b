...
# learning_objective: Flag stale best-validation markers.
...
TOPIC_ID = 'B05-COD-0037'
TITLE = 'Flag stale best-metric metadata'
...
def topic_action(payload: dict[str, object]) -> object:
    best_step = 800
    return {'current_step': payload['step'], 'best_step': best_step, 'stale': best_step < payload['step'] - 1000}
