...
# learning_objective: Format a small inspection transcript with concrete findings.
...
TOPIC_ID = 'B05-COD-0040'
TITLE = 'Render a checkpoint inspection transcript'
...
def topic_action(payload: dict[str, object]) -> object:
    return ['inspect checkpoint', fstep={payload['step']}, frun={payload['metadata']['run_name']}]
