...
# learning_objective: Validate precision values against a small allowlist.
...
TOPIC_ID = 'B05-COD-0068'
TITLE = 'Validate allowed precision values'
...
def topic_action(config: dict[str, object]) -> object:
    return config['training']['precision'] in {'fp32', 'bf16'}
