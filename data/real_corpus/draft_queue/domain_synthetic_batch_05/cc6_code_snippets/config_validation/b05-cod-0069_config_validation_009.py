...
# learning_objective: Catch sequence-length mismatches between runtime and checkpoint sections.
...
TOPIC_ID = 'B05-COD-0069'
TITLE = 'Compare runtime and checkpoint sequence lengths'
...
def topic_action(config: dict[str, object]) -> object:
    return config['training']['seq_len'] == config['checkpoint']['seq_len']
