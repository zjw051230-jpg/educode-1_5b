...
# learning_objective: Reject zero and negative batch sizes.
...
TOPIC_ID = 'B05-COD-0071'
TITLE = 'Reject non-positive batch sizes'
...
def topic_action(config: dict[str, object]) -> object:
    return int(config['training']['micro_batch_size']) > 0
