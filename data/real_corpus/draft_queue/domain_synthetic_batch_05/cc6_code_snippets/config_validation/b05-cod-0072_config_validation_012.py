...
# learning_objective: Check whether evaluation intervals divide cleanly into save intervals.
...
TOPIC_ID = 'B05-COD-0072'
TITLE = 'Check eval interval divisibility'
...
def topic_action(config: dict[str, object]) -> object:
    return config['training']['save_interval'] % config['training']['eval_interval'] == 0
