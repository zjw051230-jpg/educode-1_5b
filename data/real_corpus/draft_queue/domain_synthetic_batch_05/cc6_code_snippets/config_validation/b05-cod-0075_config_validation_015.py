...
# learning_objective: Validate resume toggles against checkpoint requirements.
...
TOPIC_ID = 'B05-COD-0075'
TITLE = 'Validate checkpoint resume toggles'
...
def topic_action(config: dict[str, object]) -> object:
    return (not config['resume']['enabled']) or bool(config['paths']['resume_path'])
