...
# learning_objective: Check whether logging configuration fields are complete enough to write metrics.
...
TOPIC_ID = 'B05-COD-0077'
TITLE = 'Check logging config completeness'
...
def topic_action(config: dict[str, object]) -> object:
    return bool(config['logging']['metrics_path']) and int(config['logging']['write_every']) > 0
