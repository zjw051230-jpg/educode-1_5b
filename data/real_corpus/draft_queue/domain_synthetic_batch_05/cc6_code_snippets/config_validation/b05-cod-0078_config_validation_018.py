...
# learning_objective: Normalize boolean-like strings before validation.
...
TOPIC_ID = 'B05-COD-0078'
TITLE = 'Normalize boolean-like string flags'
...
def topic_action(config: dict[str, object]) -> object:
    return {key: str(value).strip().lower() == 'true' for key, value in config['flags'].items()}
