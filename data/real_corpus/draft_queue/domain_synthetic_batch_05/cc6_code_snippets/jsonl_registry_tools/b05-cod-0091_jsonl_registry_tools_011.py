...
# learning_objective: Count how many rows fall into each subdirectory.
...
TOPIC_ID = 'B05-COD-0091'
TITLE = 'Count rows by subdirectory'
...
def topic_action(text: str) -> object:
    return dict(Counter(row['subdirectory'] for row in parse_rows(text)))
