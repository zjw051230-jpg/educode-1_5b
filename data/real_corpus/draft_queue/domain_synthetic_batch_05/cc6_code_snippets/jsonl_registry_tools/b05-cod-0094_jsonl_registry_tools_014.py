...
# learning_objective: Check whether filenames match their declared topic ids.
...
TOPIC_ID = 'B05-COD-0094'
TITLE = 'Check filename and topic-id agreement'
...
def topic_action(text: str) -> object:
    ...
    rows[1]['filename'] = 'b05-cod-0099_jsonl_registry_tools_009.py'
    rows[0]['filename'] = 'b05-cod-0081_jsonl_registry_tools_001.md'
    errors = []
    for row in rows:
        if row['topic_id'].lower().replace('b05-cod-', 'b05-cod-')[:11] not in row['filename']:
