...
# learning_objective: Implement real counting over records that carry source_category labels.
...
TOPIC_ID = 'B05-COD-0007'
TITLE = 'Count rows by source category'
