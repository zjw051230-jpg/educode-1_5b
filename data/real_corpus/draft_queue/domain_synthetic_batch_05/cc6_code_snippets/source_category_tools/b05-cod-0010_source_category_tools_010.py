...
# learning_objective: Produce a concrete text report from category totals.
...
TOPIC_ID = 'B05-COD-0010'
TITLE = 'Render a category report table'
...
def topic_action(rows: list[dict[str, object]]) -> object:
    ...
    return ['source_category,count'] + [f'{k},{v}' for k, v in counts.items()]
