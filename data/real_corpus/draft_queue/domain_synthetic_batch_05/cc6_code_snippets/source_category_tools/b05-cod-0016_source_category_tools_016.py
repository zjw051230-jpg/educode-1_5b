...
# learning_objective: Show the effect of canonicalizing alias labels before counting.
...
TOPIC_ID = 'B05-COD-0016'
TITLE = 'Compute category deltas after normalization'
...
def topic_action(rows: list[dict[str, object]]) -> object:
    before = {'synthetic': 1, 'synthetic_examples': 1}
    after = count_by_category(rows)
