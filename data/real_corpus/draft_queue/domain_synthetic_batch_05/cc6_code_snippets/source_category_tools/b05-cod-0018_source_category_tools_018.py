...
# learning_objective: Map alias labels into canonical source categories.
...
TOPIC_ID = 'B05-COD-0018'
TITLE = 'Collapse aliases into canonical categories'
...
def topic_action(rows: list[dict[str, object]]) -> object:
    alias_map = {'synthetic': 'synthetic_examples', 'ext': 'external_general_text'}
    labels = ['synthetic', 'ext', 'synthetic_examples']
    return [alias_map.get(label, label) for label in labels]
