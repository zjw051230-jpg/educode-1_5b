...
| EXP-20260515-016-d8-synthetic-expanded-45-file-intake | N/A | D8 | data | `scripts/intake_synthetic_expanded_corpus.py` | pending local commit | success | 45-file expanded synthetic corpus intake completed | `docs/d8_synthetic_expanded_45_file_intake.md` | retrain the expanded/domain BPE tokenizer on the refreshed 45-file corpus next |
