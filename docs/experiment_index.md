...
| EXP-20260515-014-d6-6-50-vs-100-step-expanded-bpe-comparison | N/A | D6.6 | comparison | `docs/d6_6_50_vs_100_step_expanded_bpe_comparison.md` | pending local commit | success | 50-step and 100-step expanded BPE training runs compared | `docs/d6_6_50_vs_100_step_expanded_bpe_comparison.md` | expand the approved corpus before any longer expanded-BPE training |
