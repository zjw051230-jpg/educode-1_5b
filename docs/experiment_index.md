...
| EXP-20260514-011-t4-3-synthetic-seed-corpus | N/A | T4.3 | Windows RTX 2080 Ti | `docs/t4_3_synthetic_seed_corpus.md` | pending local commit | success | project-authored synthetic seed corpus created | `docs/t4_3_synthetic_seed_corpus.md` | plan the real data intake and cleaning scripts next |
