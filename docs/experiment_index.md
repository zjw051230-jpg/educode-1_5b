...
| EXP-20260516-010-d12-4-project-gutenberg-candidate-file-terms-record | N/A | D12.4 | planning | `docs/d12_4_project_gutenberg_candidate_file_terms_record.md` | pending local commit | success | three Project Gutenberg candidate landing pages reviewed for planning; no text downloaded | `docs/d12_4_project_gutenberg_candidate_file_terms_record.md` | select exactly one candidate for small text download approval after final terms review |
