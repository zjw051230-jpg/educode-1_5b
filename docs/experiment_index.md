...
| EXP-20260523-005-mvp-4-fineweb-edu-public-corpus-intake | N/A | MVP-4 | data/planning | `data/public_corpus/fineweb_edu_sample10bt_50mb/intake_summary.json` | pending local commit | success | FineWeb-Edu 50MB slice intaked and tokenizer decision recorded | `docs/mvp_4_fineweb_edu_public_corpus_intake.md` | enter MVP-5 data/model/loss smoke |
