...
| EXP-20260516-001-d11-2-50-step-domain-bpe-training-review | `20260515_034606_windows_cuda_50_step_domain_bpe_training` | D11.2 | review | `docs/d11_2_50_step_domain_bpe_training_review.md` | pending local commit | success | 50-step domain BPE training run reviewed and accepted | `docs/d11_2_50_step_domain_bpe_training_review.md` | write a bounded 100-step domain BPE plan or expand the corpus next |
