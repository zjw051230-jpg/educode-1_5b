...
| EXP-20260515-019-d11-domain-bpe-small-training-plan | N/A | D11 | planning | `docs/d11_domain_bpe_small_training_plan.md` | pending local commit | success | domain BPE small training plan created | `docs/d11_domain_bpe_small_training_plan.md` | implement a bounded 50-step domain BPE small training run next |
