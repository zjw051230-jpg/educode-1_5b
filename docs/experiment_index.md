...
| EXP-20260515-018-d10-domain-bpe-data-model-loss-smoke | N/A | D10 | smoke | `configs/windows/bpe_domain_8k_smoke.json` | pending local commit | success | domain BPE processed-data model/loss smoke completed | `docs/d10_domain_bpe_data_model_loss_smoke.md` | prepare a domain BPE small training plan next |
