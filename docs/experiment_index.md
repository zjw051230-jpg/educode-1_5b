...
| EXP-20260515-011-d6-3-100-step-expanded-bpe-training-plan | N/A | D6.3 | planning | `docs/d6_3_100_step_expanded_bpe_training_plan.md` | pending local commit | success | 100-step expanded BPE training plan created | `docs/d6_3_100_step_expanded_bpe_training_plan.md` | implement a bounded 100-step expanded BPE training run next |
