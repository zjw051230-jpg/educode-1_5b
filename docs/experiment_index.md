...
| EXP-20260517-010-d17-1-draft-corpus-generation-validation | N/A | D17.1 | validation | `scripts/validate_draft_corpus_batch_03.py` | pending local commit | success | 120 draft corpus candidates generated and validated in draft_queue | `docs/d17_1_draft_corpus_generation_validation.md` | enter D17.2 draft corpus review gate |
