...
| EXP-20260511-007-w11-4-bounded-50-step-toy-training | `20260511_044948_windows_cuda_bounded_50_step_toy` | windows_cuda | Windows RTX 4060 Ti | `configs/windows/smoke_cuda_10m.json` | pending local commit | success | bounded 50-step toy training completed | `docs/w11_4_bounded_50_step_toy_training.md` | review the 50-step toy training artifacts next |
