...
| EXP-20260519-001-d18-1-batch-04-targeted-sampling-review-pack | N/A | D18.1 | review/planning | `scripts/create_batch_04_targeted_sampling_pack.py` | pending local commit | success | targeted sampling review pack created for batch 04 draft corpus | `docs/d18_1_batch_04_targeted_sampling_review_plan.md` | run human review on the 240-file sampling pack before any promotion subset discussion |
