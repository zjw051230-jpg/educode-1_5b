...
| EXP-20260515-013-d6-5-100-step-expanded-bpe-training-review | `20260515_023640_windows_cuda_100_step_expanded_bpe_training` | D6.5 | Windows RTX 2080 Ti | `configs/windows/bpe_expanded_8k_smoke.json` | pending local commit | success | 100-step expanded BPE training run reviewed and accepted | `docs/d6_5_100_step_expanded_bpe_training_review.md` | compare the bounded 50-step and 100-step expanded-BPE runs next |
