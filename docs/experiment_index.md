...
| EXP-20260511-006-w11-3-bounded-50-step-toy-training-plan | N/A | planning | Windows RTX 4060 Ti | `configs/windows/smoke_cuda_10m.json` | pending local commit | success | bounded 50-step toy training plan created | `docs/w11_3_bounded_50_step_toy_training_plan.md` | implement only the bounded 50-step toy script next |
