...
| EXP-20260523-004-mvp-3-1-fineweb-edu-50mb-slice-fetch | N/A | MVP-3.1 | fetch/validation | `data/public_corpus/fineweb_edu_sample10bt_50mb/manifest.json` | pending local commit | success | FineWeb-Edu sample-10BT 50MB slice fetched and validated | `docs/mvp_3_1_fineweb_edu_50mb_slice_fetch.md` | enter MVP-4 public corpus intake / tokenizer decision |
