...
| EXP-20260514-007-t3-small-real-dataset-plan | N/A | T3 | Windows RTX 2080 Ti | `docs/t3_small_real_dataset_plan.md` | pending local commit | success | small real dataset plan created | `docs/t3_small_real_dataset_plan.md` | create the real corpus directory skeleton and data intake checklist next |
