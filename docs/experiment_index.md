...
| EXP-20260514-023-t7-3-100-step-small-training-plan | N/A | T7.3 | Windows RTX 2080 Ti | `docs/t7_3_100_step_small_training_plan.md` | pending local commit | success | bounded 100-step small training plan created | `docs/t7_3_100_step_small_training_plan.md` | implement the bounded 100-step small training run next |
