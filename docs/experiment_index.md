...
| EXP-20260514-027-t8-a100-100m-scaling-plan | N/A | T8 | A100 | `docs/t8_a100_100m_scaling_plan.md` | pending local commit | success | A100 100M scaling plan created | `docs/t8_a100_100m_scaling_plan.md` | create the A100 100M config draft next |
