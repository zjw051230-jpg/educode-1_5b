...
| EXP-20260514-014-t5-2-bpe-8k-tokenizer-training-plan | N/A | T5.2 | Windows RTX 2080 Ti | `docs/t5_2_bpe_8k_tokenizer_training_plan.md` | pending local commit | success | BPE 8k tokenizer training plan created | `docs/t5_2_bpe_8k_tokenizer_training_plan.md` | train a formal-path synthetic-corpus tokenizer smoke artifact next |
