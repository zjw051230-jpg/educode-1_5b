...
| EXP-20260514-010-t4-2s-synthetic-seed-source-decision | N/A | T4.2S | Windows RTX 2080 Ti | `docs/t4_2s_synthetic_seed_source_decision.md` | pending local commit | success | synthetic seed corpus source decision created | `docs/t4_2s_synthetic_seed_source_decision.md` | create the synthetic seed corpus next |
