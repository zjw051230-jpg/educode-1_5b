...
| EXP-20260516-021-d15-mixed-domain-bpe-data-model-loss-smoke | N/A | D15 | smoke | `configs/windows/bpe_mixed_domain_8k_smoke.json` | pending local commit | success | mixed/domain BPE processed-data model/loss smoke completed | `docs/d15_mixed_domain_bpe_data_model_loss_smoke.md` | prepare a bounded mixed/domain BPE small-training plan next while keeping `external_general_text` supplement only |
