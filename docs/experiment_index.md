...
| EXP-20260523-001-e1-r1-research-paper-schema-taxonomy-alignment | N/A | E1.R1 | documentation/planning | `docs/e1_research_paper_metadata_schema.md` | 728efe1 | success | research paper assistant schema, source policy, and task taxonomy aligned | `docs/e1_r1_research_paper_schema_taxonomy_alignment.md` | keep the registry template-only until a deliberate E2 paper-registration step is requested |
| EXP-20260523-002-mvp-2-fineweb-edu-source-decision | N/A | MVP-2 | documentation/planning | `configs/data/fineweb_edu_sample10bt_50mb.json` | 3dad89f | success | FineWeb-Edu sample-10BT selected as first public corpus for A100 MVP | `docs/mvp_2_fineweb_edu_source_decision.md` | run a bounded MVP-3 fetch for the 50MB FineWeb-Edu slice before any intake or training discussion |
| EXP-20260523-003-mvp-3-r-fineweb-edu-dry-run-troubleshooting | N/A | MVP-3.R | troubleshooting | `scripts/fetch_fineweb_edu_slice.py` | 8fcd1ce | success | FineWeb-Edu dry-run troubleshooting completed; 50MB fetch not attempted | `docs/mvp_3r_fineweb_edu_dry_run_troubleshooting.md` | decide whether to attempt a later bounded 50MB fetch or keep troubleshooting the environment |
| EXP-20260523-004-mvp-3-1-fineweb-edu-50mb-slice-fetch | N/A | MVP-3.1 | fetch/validation | `data/public_corpus/fineweb_edu_sample10bt_50mb/manifest.json` | d6edd41 | success | FineWeb-Edu sample-10BT 50MB slice fetched and validated | `docs/mvp_3_1_fineweb_edu_50mb_slice_fetch.md` | enter MVP-4 public corpus intake / tokenizer decision |
| EXP-20260523-005-mvp-4-fineweb-edu-public-corpus-intake | N/A | MVP-4 | data/planning | `data/public_corpus/fineweb_edu_sample10bt_50mb/intake_summary.json` | d15bcc9 | success | FineWeb-Edu 50MB slice intaked and tokenizer decision recorded | `docs/mvp_4_fineweb_edu_public_corpus_intake.md` | enter MVP-5 data/model/loss smoke |
| EXP-20260523-006-mvp-5-fineweb-edu-data-model-loss-smoke | N/A | MVP-5 | smoke | `data/public_corpus/fineweb_edu_sample10bt_50mb/fineweb_edu_data_model_loss_smoke_summary.json` | pending local commit | success | FineWeb-Edu 50MB public corpus data/model/loss smoke passed with mixed-domain tokenizer | `docs/mvp_5_fineweb_edu_data_model_loss_smoke.md` | draft MVP-6 A100 300M 10-step smoke plan next |
