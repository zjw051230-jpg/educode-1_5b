...
| EXP-20260517-003-d16-2-50-step-mixed-domain-bpe-training-review | `20260517_000844_windows_cuda_50_step_mixed_domain_bpe_training` | D16.2 | review | `docs/d16_2_50_step_mixed_domain_bpe_training_review.md` | pending local commit | success | 50-step mixed/domain BPE training run reviewed and accepted | `docs/d16_2_50_step_mixed_domain_bpe_training_review.md` | prepare a 100-step mixed/domain BPE training plan or consider A2 planning after one more local review step |
