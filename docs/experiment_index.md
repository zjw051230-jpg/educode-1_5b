...
| EXP-20260516-016-d12-10-external-general-text-intake-review | N/A | D12.10 | review | `docs/d12_10_external_general_text_intake_review.md` | pending local commit | success | external general text intake reviewed and approved for limited tokenizer/bounded mixed-corpus use | `docs/d12_10_external_general_text_intake_review.md` | use the approved supplement only in later bounded tokenizer or mixed-corpus steps while preserving project-backbone separation |
