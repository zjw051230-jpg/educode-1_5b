...
| EXP-20260515-006-d4-expanded-bpe-tokenizer | N/A | D4 | tokenizer | `scripts/train_expanded_bpe_tokenizer.py` | pending local commit | success | expanded synthetic corpus BPE tokenizer artifact trained | `docs/d4_expanded_bpe_tokenizer.md` | run an expanded BPE data/model/loss smoke next |
