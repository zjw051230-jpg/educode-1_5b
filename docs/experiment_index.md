...
| EXP-20260516-009-d12-3-project-gutenberg-file-level-review-plan | N/A | D12.3 | planning | `docs/d12_3_project_gutenberg_file_level_review_plan.md` | pending local commit | success | Project Gutenberg file-level review plan created; no data downloaded | `docs/d12_3_project_gutenberg_file_level_review_plan.md` | manually select 1-3 candidate files and record file-level terms before any download |
