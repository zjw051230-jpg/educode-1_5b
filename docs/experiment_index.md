...
| EXP-20260514-028-t8-1-a100-100m-config-draft | N/A | T8.1 | A100 | `configs/a100/educode_100m_a100_draft.json` | pending local commit | success | A100 100M draft config created and validated with a read-only inspection script | `docs/t8_1_a100_100m_config_draft.md` | prepare an A100 environment preflight checklist next |
