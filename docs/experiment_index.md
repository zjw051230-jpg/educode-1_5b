...
| EXP-20260516-007-d12-1-project-gutenberg-source-decision | N/A | D12.1 | planning | `docs/d12_1_project_gutenberg_source_decision.md` | pending local commit | success | Project Gutenberg source decision record created; no data downloaded | `docs/d12_1_project_gutenberg_source_decision.md` | create an external_general_text directory skeleton and manifest placeholder next without downloading data |
