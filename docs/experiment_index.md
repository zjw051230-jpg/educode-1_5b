...
| EXP-20260514-006-t2-5-tokenizer-config-migration | N/A | T2.5 | Windows RTX 2080 Ti | `configs/windows/byte_smoke_10m.json` | pending local commit | success | tokenizer configs split into byte smoke, toy BPE smoke, and formal BPE placeholder | `docs/t2_5_tokenizer_config_migration.md` | plan a small real dataset path next |
