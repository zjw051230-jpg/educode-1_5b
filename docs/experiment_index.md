...
| EXP-20260523-003-mvp-3-r-fineweb-edu-dry-run-troubleshooting | N/A | MVP-3.R | troubleshooting | `scripts/fetch_fineweb_edu_slice.py` | pending local commit | success | FineWeb-Edu dry-run troubleshooting completed; 50MB fetch not attempted | `docs/mvp_3r_fineweb_edu_dry_run_troubleshooting.md` | decide whether to attempt a later bounded 50MB fetch or keep troubleshooting the environment |
