...
| EXP-20260515-007-d5-expanded-bpe-data-model-loss-smoke | N/A | D5 | smoke | `scripts/inspect_expanded_bpe_data_model_loss_smoke.py` | pending local commit | success | expanded BPE processed-data model/loss smoke completed | `docs/d5_expanded_bpe_data_model_loss_smoke.md` | write an expanded corpus small-training plan next |
