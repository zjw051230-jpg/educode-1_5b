...
| EXP-20260515-017-d9-domain-bpe-tokenizer-45-file-corpus | N/A | D9 | tokenizer | `scripts/train_domain_bpe_tokenizer_45file.py` | pending local commit | success | domain BPE tokenizer trained on 45-file corpus | `docs/d9_domain_bpe_tokenizer_45file.md` | run a domain BPE data/model/loss smoke next |
