...
| EXP-20260519-002-d18-3-batch-04-sampling-review-aggregate | N/A | D18.3 | review/aggregation | `scripts/aggregate_batch_04_sampling_reviews.py` | pending local commit | success | batch 04 sampling reviews aggregated; promotion not ready due to template repetition | `docs/d18_3_batch_04_sampling_review_aggregate.md` | use D19 repair-aware regeneration planning instead of more blind generation or promotion |
