...
| EXP-20260516-003-d11-4-100-step-domain-bpe-training | `20260516_171326_windows_cuda_100_step_domain_bpe_training` | D11.4 | Windows RTX 2080 Ti | `configs/windows/bpe_domain_8k_smoke.json` | pending local commit | success | 100-step domain BPE training completed | `docs/d11_4_100_step_domain_bpe_training.md` | review the bounded 100-step domain BPE training artifacts before any longer or non-local run |
