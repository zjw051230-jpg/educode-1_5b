...
| EXP-20260516-015-d12-9-external-general-text-intake | N/A | D12.9 | data | `data/real_corpus/processed/external_general_text.processed.jsonl` | pending local commit | success | external general text intake completed for controlled Gutenberg Alice sample | `docs/d12_9_external_general_text_intake.md` | review processed external_general_text outputs and decide whether later training approval is warranted while keeping provenance separate |
