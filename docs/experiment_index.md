...
| EXP-20260517-006-d16-5-100-step-mixed-domain-bpe-training-review | `20260517_004516_windows_cuda_100_step_mixed_domain_bpe_training` | D16.5 | review | `docs/d16_5_100_step_mixed_domain_bpe_training_review.md` | pending local commit | success | 100-step mixed/domain BPE training run reviewed and accepted with overfitting signal noted | `docs/d16_5_100_step_mixed_domain_bpe_training_review.md` | compare the bounded 50-step and 100-step mixed/domain runs next, then plan A2 or more corpus expansion instead of more local step-stacking |
