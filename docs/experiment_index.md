...
| EXP-20260514-020-t7-small-real-data-training-plan | N/A | T7 | Windows RTX 2080 Ti | `docs/t7_small_real_data_training_plan.md` | pending local commit | success | small real-data training plan created | `docs/t7_small_real_data_training_plan.md` | implement a bounded small real-data training script next |
