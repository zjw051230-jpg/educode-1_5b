...
| EXP-20260511-009-r1-resume-mvp-pack | N/A | R1 | Windows RTX 4060 Ti | `scripts/run_resume_demo.py` | pending local commit | success | resume-ready project packaging created | `docs/resume_project_report.md` | polish the repository landing page and resume summary next |
