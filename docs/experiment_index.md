...
| EXP-20260517-001-d16-mixed-domain-bpe-small-training-plan | N/A | D16 | planning | `docs/d16_mixed_domain_bpe_small_training_plan.md` | pending local commit | success | mixed/domain BPE small training plan created | `docs/d16_mixed_domain_bpe_small_training_plan.md` | implement a bounded 50-step mixed/domain BPE small training run next while keeping `external_general_text` supplement only |
