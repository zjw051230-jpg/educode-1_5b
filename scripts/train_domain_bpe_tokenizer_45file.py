...
ARTIFACT_DIR = PROJECT_ROOT / "tokenizers" / "educode_bpe_domain_8k"
TOKENIZER_NAME = "educode_bpe_domain_8k"
...
def main() -> int:
    ...
    tokenizer_config = {
        ...
        "artifact_path": "tokenizers/educode_bpe_domain_8k",
        "tokenizer_json": "tokenizers/educode_bpe_domain_8k/tokenizer.json",
        ...
        "notes": "Domain BPE tokenizer artifact trained only on the processed 45-file synthetic expanded corpus train split.",
    }
    ...
    readme_text = f"""# EduCode Domain BPE 8k

This directory stores the `educode_bpe_domain_8k` tokenizer artifact trained only on the processed 45-file synthetic expanded corpus.
